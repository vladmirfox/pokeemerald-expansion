...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_LONGTIDE_CHANNEL_SOULKEEP},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_134},
    {MAPSEC_GINKO_WOODS,            MAPSEC_WHITESLATE_ROUTE},
    {MAPSEC_JAGGED_PASS,                MAPSEC_LONGTIDE_CHANNEL_SOULKEEP},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_DRYUGON,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_DRYUGON,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_BURNFOOT_PASS_BOTTOM,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_BURNFOOT_PASS_BOTTOM,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_STEEPSTONE_PASS_BOTTOM,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_STEEPSTONE_PASS_BOTTOM,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_MT_KAZAN_EXTERIOR,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_MT_KAZAN_EXTERIOR,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_SCENIC_ROUTE,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_SCENIC_ROUTE,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_OPEN_SEA_HAVEN,
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_LONGTIDE_CHANNEL_SOULKEEP] = {MAP_GROUP(LONGTIDE_CHANNEL_SOULKEEP), MAP_NUM(LONGTIDE_CHANNEL_SOULKEEP), HEAL_LOCATION_NONE},
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAPSEC_UNDERWATER_126:
        ...
        if (gSaveBlock1Ptr->pos.y > 56)
            y++;
        break;
    case MAPSEC_SCENIC_ROUTE_SABERSIDE:
        x = 0;
        if (xOnMap > 14)
            x++;
        if (xOnMap > 28)
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_COREEF_ISLE;
        break;
