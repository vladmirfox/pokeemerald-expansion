...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_SCATTERBUG_ICY_SNOW, .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_SPEWPA_ICY_SNOW, .jumpType = JUMP_TYPE_NORMAL, },
...
static void CreateJumpMonSprites(void)
{
    ...
    for (i = 0; i < playersCount; i++)
    {
        ...
        y = gBaseStats[monInfo->species].frontPicYOffset;
