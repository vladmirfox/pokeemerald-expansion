...
#define DAWN_END_HOUR       7       //06 - 07
#define DAY_END_HOUR        17      //08 - 17
#define SUNSET_END_HOUR     20      //17 - 20
...
void DnsApplyFilters()
{
    ...
    //FIXME: This light system is bugged, lights shows in the wrong objects. 
    /*
    if (!IsMapDNSException() && IsNightTime() && !gMain.inBattle)
        DoDnsLightning();
    */
}
