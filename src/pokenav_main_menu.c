...
static void LoadLeftHeaderGfxForMenu(u32 menuGfxId)
{
    ...
    DecompressDataWithHeaderWram(sMenuLeftHeaderSpriteSheets[menuGfxId].data, gDecompressionBuffer);
...
static void LoadLeftHeaderGfxForSubMenu(u32 menuGfxId)
{
    ...
    DecompressDataWithHeaderWram(sPokenavSubMenuLeftHeaderSpriteSheets[menuGfxId].data, &gDecompressionBuffer[0x1000]);
