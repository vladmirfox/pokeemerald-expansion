...
{
// currently broken due to windows/doors sharing colors within the same palette as other
// parts of the building; dummy value inserted to make compiler happy
/*  {
        .paletteNum = 6,
        .colourNum = 9,
