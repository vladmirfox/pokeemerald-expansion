...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_AssuranceHand, 0x0200, ANIM_TAG_WRING_OUT},
    ...
    {gBattleAnimSpritePal_MegaParticles, 0x0180, ANIM_TAG_PRIMAL_PARTICLES},
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_AlphaOmegaSymbol, ANIM_TAG_ALPHA_SYMBOL},
    {gBattleAnimSpritePal_AlphaOmegaSymbol, ANIM_TAG_OMEGA_SYMBOL},
    {gBattleAnimSpritePal_MegaParticles, ANIM_TAG_PRIMAL_PARTICLES},
