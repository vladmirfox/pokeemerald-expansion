...
static const struct ListMenuItem sTradingBoardTypes[NUMBER_OF_MON_TYPES] = {
    { gTypes[TYPE_NORMAL].name,   TYPE_NORMAL         },
    { gTypes[TYPE_FIRE].name,     TYPE_FIRE           },
    { gTypes[TYPE_WATER].name,    TYPE_WATER          },
    { gTypes[TYPE_ELECTRIC].name, TYPE_ELECTRIC       },
    { gTypes[TYPE_GRASS].name,    TYPE_GRASS          },
    { gTypes[TYPE_ICE].name,      TYPE_ICE            },
    { gTypes[TYPE_GROUND].name,   TYPE_GROUND         },
    { gTypes[TYPE_ROCK].name,     TYPE_ROCK           },
    { gTypes[TYPE_FLYING].name,   TYPE_FLYING         },
    { gTypes[TYPE_PSYCHIC].name,  TYPE_PSYCHIC        },
    { gTypes[TYPE_FIGHTING].name, TYPE_FIGHTING       },
    { gTypes[TYPE_POISON].name,   TYPE_POISON         },
    { gTypes[TYPE_BUG].name,      TYPE_BUG            },
    { gTypes[TYPE_GHOST].name,    TYPE_GHOST          },
    { gTypes[TYPE_DRAGON].name,   TYPE_DRAGON         },
    { gTypes[TYPE_STEEL].name,    TYPE_STEEL          },
    { gTypes[TYPE_DARK].name,     TYPE_DARK           },
    { gTypes[TYPE_FAIRY].name,    TYPE_FAIRY          },
