...
const struct Tileset gTileset_SilverTunnel =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SilverTunnel,
    .palettes = gTilesetPalettes_SilverTunnel,
    .metatiles = gMetatiles_SilverTunnel,
    .metatileAttributes = gMetatileAttributes_SilverTunnel,
    .callback = NULL,
};

const struct Tileset gTileset_Silveridge =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Silveridge,
...
const struct Tileset gTileset_Refuge =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Refuge,
    .palettes = gTilesetPalettes_Refuge,
    .metatiles = gMetatiles_Refuge,
...
const struct Tileset gTileset_Soulkeep =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Soulkeep,
    .palettes = gTilesetPalettes_Soulkeep,
    .metatiles = gMetatiles_Soulkeep,
...
const struct Tileset gTileset_Saberside =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Saberside,
    .palettes = gTilesetPalettes_Saberside,
    .metatiles = gMetatiles_Saberside,
    .metatileAttributes = gMetatileAttributes_Saberside,
    .callback = NULL,
};

const struct Tileset gTileset_UumeForest =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_UumeForest,
    .palettes = gTilesetPalettes_UumeForest,
    .metatiles = gMetatiles_UumeForest,
    .metatileAttributes = gMetatileAttributes_UumeForest,
    .callback = NULL,
};
...
const struct Tileset gTileset_Decay =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Decay,
...
const struct Tileset gTileset_HarvestShrine =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_HarvestShrine,
    .palettes = gTilesetPalettes_HarvestShrine,
    .metatiles = gMetatiles_HarvestShrine,
...
const struct Tileset gTileset_House_Marble =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_House_Marble,
