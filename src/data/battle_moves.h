const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_POUND] =
    {
        ...
        .makesContact = TRUE,
        .ignoresKingsRock = B_UPDATED_MOVE_DATA == GEN_4,
    },
    ...
    [MOVE_GUST] =
    {
        ...
        .split = SPLIT_SPECIAL,
        .zMoveEffect = Z_EFFECT_NONE,
        .ignoresKingsRock = B_UPDATED_MOVE_DATA == GEN_4, // || B_UPDATED_MOVE_DATA == GEN_2
    ...
    [MOVE_BIND] =
    {
        ...
        .zMoveEffect = Z_EFFECT_NONE,
        .makesContact = TRUE,
        //.ignoresKingsRock = B_UPDATED_MOVE_DATA == GEN_2,
    },
    ...
    [MOVE_TWINEEDLE] =
    {
        ...
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
        .ignoresKingsRock = B_UPDATED_MOVE_DATA < GEN_5, // && B_UPDATED_MOVE_DATA > GEN_2
        .twoStrikes = TRUE,
    },
    ...
    [MOVE_RAGING_BULL] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MIRROR_MOVE_AFFECTED, // TO VERIFY
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
        .makesContact = TRUE,
        .metronomeBanned = TRUE,
