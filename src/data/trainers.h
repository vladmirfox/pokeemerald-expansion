const struct Trainer gTrainers[] = {
    ...
    [TRAINER_SIMON] =
    {
        ...
        .trainerPic = TRAINER_PIC_TUBER_M,
        .trainerName = _("SIMON"),
        .items = {ITEM_SODA_POP, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE,
    ...
    [TRAINER_ROXANNE_1] =
    {
        ...
        .items = {ITEM_SUPER_POTION, ITEM_POTION, ITEM_POTION, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
    ...
    [TRAINER_BRENDAN_ROUTE_119_MUDKIP] =
    {
        ...
        .trainerPic = TRAINER_PIC_BRENDAN,
        .trainerName = _("BRENDAN"),
        .items = {ITEM_HYPER_POTION, ITEM_HYPER_POTION, ITEM_LAVA_COOKIE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
