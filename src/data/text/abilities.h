...
static const u8 sRainDishDescription[] = _("Heal 1/8 max HP per turn\nin rain.");
...
static const u8 sForecastDescription[] = _("Sets weather based on held\nitem then changes form.");
...
static const u8 sTangledFeetDescription[] = _("Doubles evasion and cannot\nhit self while confused.");
...
static const u8 sStallDescription[] = _("Normally, always move last.\nMove first in Trick Room.");
...
static const u8 sPickpocketDescription[] = _("Steals the attacker's item\nif hit with a contact move.");
...
static const u8 sHeavyMetalDescription[] = _("Doubles weight. Cannot be\nforced to switch out.");
...
static const u8 sSandRushDescription[] = _("Doubles Speed while in a\nsandstorm.");
...
static const u8 sTurboblazeDescription[] = _("50% boost to Fire. Moves\nignore target's ability.");
static const u8 sTeravoltDescription[] = _("50% boost to Electr. Moves\nignore target's ability.");
