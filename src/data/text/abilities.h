...
static const u8 sSandVeilDescription[] = _("Ups Defense in a sandstorm.");
...
static const u8 sMagmaArmorDescription[] = _("Takes less and burns.");
...
static const u8 sSnowCloakDescription[] = _("Ups Sp.Def in Hail or Snow.");
...
static const u8 sJustifiedDescription[] = _("Dark hits raise power.");
