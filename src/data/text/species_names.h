const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_SCATTERBUG_ICY_SNOW] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_POLAR] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_TUNDRA] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_CONTINENTAL] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_GARDEN] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_ELEGANT] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_MEADOW] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_MODERN] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_MARINE] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_ARCHIPELAGO] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_HIGH_PLAINS] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_SANDSTORM] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_RIVER] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_MONSOON] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_SAVANNA] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_SUN] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_OCEAN] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_JUNGLE] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_FANCY] = _("Scatterbug"),
    [SPECIES_SCATTERBUG_POKE_BALL] = _("Scatterbug"),
    [SPECIES_SPEWPA_ICY_SNOW] = _("Spewpa"),
    [SPECIES_SPEWPA_POLAR] = _("Spewpa"),
    [SPECIES_SPEWPA_TUNDRA] = _("Spewpa"),
    [SPECIES_SPEWPA_CONTINENTAL] = _("Spewpa"),
    [SPECIES_SPEWPA_GARDEN] = _("Spewpa"),
    [SPECIES_SPEWPA_ELEGANT] = _("Spewpa"),
    [SPECIES_SPEWPA_MEADOW] = _("Spewpa"),
    [SPECIES_SPEWPA_MODERN] = _("Spewpa"),
    [SPECIES_SPEWPA_MARINE] = _("Spewpa"),
    [SPECIES_SPEWPA_ARCHIPELAGO] = _("Spewpa"),
    [SPECIES_SPEWPA_HIGH_PLAINS] = _("Spewpa"),
    [SPECIES_SPEWPA_SANDSTORM] = _("Spewpa"),
    [SPECIES_SPEWPA_RIVER] = _("Spewpa"),
    [SPECIES_SPEWPA_MONSOON] = _("Spewpa"),
    [SPECIES_SPEWPA_SAVANNA] = _("Spewpa"),
    [SPECIES_SPEWPA_SUN] = _("Spewpa"),
    [SPECIES_SPEWPA_OCEAN] = _("Spewpa"),
    [SPECIES_SPEWPA_JUNGLE] = _("Spewpa"),
    [SPECIES_SPEWPA_FANCY] = _("Spewpa"),
    [SPECIES_SPEWPA_POKE_BALL] = _("Spewpa"),
