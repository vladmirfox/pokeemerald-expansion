...
static const struct LevelUpMove sMeiLevelUpLearnset[] = {
...
static const struct LevelUpMove sZukoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LICK),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
...
static const struct LevelUpMove sStinkyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LICK),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
...
static const struct LevelUpMove sSokkaLevelUpLearnset[] = {
...
static const struct LevelUpMove sIrohLevelUpLearnset[] = {
        LEVEL_UP_MOVE( 0, MOVE_EMBER),
        LEVEL_UP_MOVE( 1, MOVE_EMBER),
        LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
        LEVEL_UP_MOVE( 1, MOVE_TACKLE),
