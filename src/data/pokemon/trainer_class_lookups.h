const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ARCO_MEMBER_B] = TRAINER_PIC_ARCO_MEMBER_B,
    [FACILITY_CLASS_ARCO_MEMBER_R] = TRAINER_PIC_ARCO_MEMBER_R,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ARCO_MEMBER_B] = TRAINER_CLASS_TEAM_ARCO,
    [FACILITY_CLASS_ARCO_MEMBER_R] = TRAINER_CLASS_TEAM_ARCO,
};
