...
#define RAICHU_MISC_INFO                                                \
    ...
    [SPECIES_RAICHU_ALOLAN] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_PSYCHIC),
...
#define SANDSLASH_MISC_INFO                                         \
    ...
    [SPECIES_SANDSHREW_ALOLAN] =
    {
        ...
        .baseSpAttack  = 10,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_ICE, TYPE_STEEL),
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_POISON, TYPE_GROUND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 253,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
...
#define NINETALES_MISC_INFO                                         \
    ...
    [SPECIES_NINETALES_ALOLAN] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_ICE, TYPE_FAIRY),
        .itemRare = ITEM_SNOWBALL,
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_NONE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BLUE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_POISON, TYPE_FLYING),
        .catchRate = 255,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG, EGG_GROUP_GRASS),
...
#define ARCANINE_MISC_INFO                                          \
    ...
    [SPECIES_GROWLITHE_HISUIAN] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_FIRE, TYPE_ROCK),
...
#define MACHAMP_MISC_INFO                                                   \
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_WATER, TYPE_POISON),
        .catchRate = 190,
...
#define KANTONIAN_GEODUDE_FAMILY_INFO                                       \
        .types = MON_TYPE(TYPE_ROCK, TYPE_GROUND),                          \
...
#define FARFETCHD_MISC_INFO                                            \
        ...
        .friendship = STANDARD_FRIENDSHIP,                             \
        .growthRate = GROWTH_MEDIUM_FAST,                              \
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_FIELD), \
        .bodyColor = BODY_COLOR_BROWN,                                 \
...
#define ALOLAN_GRIMER_FAMILY_INFO                                                           \
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_GHOST, TYPE_POISON),
        .catchRate = 190,
...
#define STEELIX_MISC_INFO                                       \
        .types = MON_TYPE(TYPE_STEEL, TYPE_GROUND),             \
        .catchRate = 25,                                        \
        .evYield_Defense = 2,                                   \
        .itemRare = ITEM_METAL_COAT,                            \
        .genderRatio = PERCENT_FEMALE(50),                      \
...
#define WEEZING_MISC_INFO                                           \
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_GROUND, TYPE_ROCK),
        .catchRate = 120,
...
#define MR_MIME_MISC_INFO                                           \
    ...
    [SPECIES_MR_MIME_GALARIAN] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_ICE, TYPE_PSYCHIC),
        .evYield_Speed = 2,
...
#define TAUROS_PALDEAN_MISC_INFO                                                    \
    ...
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED] =
    {
        TAUROS_MISC_INFO,
        TAUROS_PALDEAN_MISC_INFO,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_FIRE),
        .weight = 850,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
...
#define LAPRAS_MISC_INFO                                                                \
    ...
    [SPECIES_DITTO] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_DITTO),
...
#define ARTICUNO_MISC_INFO                                                          \
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 125,
        .types = MON_TYPE(TYPE_ICE, TYPE_FLYING),
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        .expYield = 261,
