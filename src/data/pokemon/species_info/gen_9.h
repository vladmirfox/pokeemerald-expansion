...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 75,
        .types = MON_TYPE(TYPE_FIRE, TYPE_GHOST),
        .catchRate = 45,
        .expYield = 265,
        .evYield_SpAttack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_WATER_1),
    ...
    [SPECIES_QUAQUAVAL] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 75,
        .types = MON_TYPE(TYPE_WATER, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 265,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .baseSpAttack  = 52,
        .baseSpDefense = 55,
        .types = MON_TYPE(TYPE_BUG, TYPE_DARK),
        .catchRate = 30,
        .expYield = 158,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_FIGHTING),
        .catchRate = 80,
        .expYield = 123,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define MAUSHOLD_SPECIES_INFO                                                           \
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_MINERAL),
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .baseSpAttack  = 58,
        .baseSpDefense = 51,
        .types = MON_TYPE(TYPE_GRASS, TYPE_NORMAL),
        .catchRate = 255,
        .expYield = 52,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS),
...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .baseSpAttack  = 125,
        .baseSpDefense = 80,
        .types = MON_TYPE(TYPE_FIRE, TYPE_PSYCHIC),
        .catchRate = 25,
        .expYield = 263,
        .evYield_SpAttack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SHROODLE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_POISON, TYPE_NORMAL),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_GRASS, TYPE_GHOST),
        .catchRate = 190,
        .expYield = 55,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_GROUND, TYPE_GRASS),
        .catchRate = 190,
        .expYield = 67,
        .evYield_SpDefense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SCOVILLAIN] =
    {
        ...
        .baseSpAttack  = 108,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_GRASS, TYPE_FIRE),
        .catchRate = 75,
        .expYield = 170,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_BUG, TYPE_PSYCHIC),
        .catchRate = 45,
        .expYield = 165,
        .evYield_SpAttack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TINKATINK] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 64,
        .types = MON_TYPE(TYPE_FAIRY, TYPE_STEEL),
        .catchRate = 190,
        .expYield = 59,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_FLYING, TYPE_DARK),
        .catchRate = 25,
        .expYield = 243,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define PALAFIN_MISC_INFO                                              \
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 45,
        .types = MON_TYPE(TYPE_STEEL, TYPE_POISON),
        .catchRate = 190,
        .expYield = 60,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_NORMAL),
        .catchRate = 190,
        .expYield = 175,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GLIMMET] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 60,
        .types = MON_TYPE(TYPE_ROCK, TYPE_POISON),
        .catchRate = 70,
        .expYield = 70,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_FLAMIGO] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 64,
        .types = MON_TYPE(TYPE_FLYING, TYPE_FIGHTING),
        .catchRate = 100,
        .expYield = 175,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_VELUZA] =
    {
        ...
        .baseSpAttack  = 78,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_WATER, TYPE_PSYCHIC),
        .catchRate = 100,
        .expYield = 167,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define TATSUGIRI_MISC_INFO                                                     \
        ...
        .baseSpAttack  = 120,                                                   \
        .baseSpDefense = 95,                                                    \
        .types = MON_TYPE(TYPE_DRAGON, TYPE_WATER),                             \
        .catchRate = 100,                                                       \
        .expYield = 166,                                                        \
        .evYield_SpAttack = 2,                                                  \
        .genderRatio = PERCENT_FEMALE(50),                                      \
    ...
    [SPECIES_GREAT_TUSK] =
    {
        ...
        .baseSpAttack  = 53,
        .baseSpDefense = 53,
        .types = MON_TYPE(TYPE_GROUND, TYPE_FIGHTING),
        .catchRate = 30,
        .expYield = 285,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPE(TYPE_FAIRY, TYPE_PSYCHIC),
        .catchRate = 50,
        .expYield = 285,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_FLUTTER_MANE] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 135,
        .types = MON_TYPE(TYPE_GHOST, TYPE_FAIRY),
        .catchRate = 30,
        .expYield = 285,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 105,
        .types = MON_TYPE(TYPE_BUG, TYPE_FIGHTING),
        .catchRate = 30,
        .expYield = 285,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .baseSpAttack  = 121,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_GROUND),
        .catchRate = 30,
        .expYield = 285,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_TREADS] =
    {
        ...
        .baseSpAttack  = 72,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_GROUND, TYPE_STEEL),
        .catchRate = 30,
        .expYield = 285,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_HANDS] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 68,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_ELECTRIC),
        .catchRate = 50,
        .expYield = 285,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_JUGULIS] =
    {
        ...
        .baseSpAttack  = 122,
        .baseSpDefense = 80,
        .types = MON_TYPE(TYPE_DARK, TYPE_FLYING),
        .catchRate = 30,
        .expYield = 285,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .baseSpAttack  = 140,
        .baseSpDefense = 110,
        .types = MON_TYPE(TYPE_FIRE, TYPE_POISON),
        .catchRate = 30,
        .expYield = 285,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_THORNS] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 84,
        .types = MON_TYPE(TYPE_ROCK, TYPE_ELECTRIC),
        .catchRate = 30,
        .expYield = 285,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 45,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_ICE),
        .catchRate = 45,
        .expYield = 64,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_DRAGON, EGG_GROUP_MINERAL),
...
#define GIMMIGHOUL_MISC_INFO                                                            \
    ...
    [SPECIES_GHOLDENGO] =
    {
        ...
        .baseSpAttack  = 133,
        .baseSpDefense = 91,
        .types = MON_TYPE(TYPE_STEEL, TYPE_GHOST),
        .catchRate = 45,
        .expYield = 275,
        .evYield_SpAttack = 2,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_WO_CHIEN] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 135,
        .types = MON_TYPE(TYPE_DARK, TYPE_GRASS),
        .catchRate = 6,
        .expYield = 285,
        .evYield_SpDefense = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CHIEN_PAO] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_DARK, TYPE_ICE),
        .catchRate = 6,
        .expYield = 285,
        .evYield_Speed = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_TING_LU] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 80,
        .types = MON_TYPE(TYPE_DARK, TYPE_GROUND),
        .catchRate = 6,
        .expYield = 285,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CHI_YU] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 120,
        .types = MON_TYPE(TYPE_DARK, TYPE_FIRE),
        .catchRate = 6,
        .expYield = 285,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_ROARING_MOON] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 101,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_DARK),
        .catchRate = 10,
        .expYield = 295,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 60,
        .types = MON_TYPE(TYPE_FAIRY, TYPE_FIGHTING),
        .catchRate = 10,
        .expYield = 295,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_KORAIDON] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_DRAGON),
        .catchRate = 3,
        .expYield = 335,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_MIRAIDON] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 115,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_DRAGON),
        .catchRate = 3,
        .expYield = 335,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_IRON_LEAVES] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 108,
        .types = MON_TYPE(TYPE_GRASS, TYPE_PSYCHIC),
        .catchRate = 5,
        .expYield = 295,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
...
#define POLTCHAGEIST_MISC_INFO                                                  \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                      \
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),     \
...
#define SINISTCHA_MISC_INFO                                                     \
    ...
    [SPECIES_MUNKIDORI] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_POISON, TYPE_PSYCHIC),
        .catchRate = 3,
        .expYield = 278,
        .evYield_SpAttack = 3,
        .genderRatio = MON_MALE,
    ...
    [SPECIES_FEZANDIPITI] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 125,
        .types = MON_TYPE(TYPE_POISON, TYPE_FAIRY),
        .catchRate = 3,
        .expYield = 278,
        .evYield_SpDefense = 3,
        .genderRatio = MON_MALE,
...
#define OGERPON_SPECIES_INFO(Form, type, ability, color, tera)                          \
    {                                                                                   \
        ...
        .baseSpAttack  = 60,                                                            \
        .baseSpDefense = 96,                                                            \
        .types = MON_TYPE(TYPE_GRASS, type),                                            \
        .catchRate = 5,                                                                 \
        .expYield = 275,                                                                \
        .evYield_Attack = 3,                                                            \
        .genderRatio = MON_FEMALE,                                                      \
    ...
    [SPECIES_GOUGING_FIRE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 93,
        .types = MON_TYPE(TYPE_FIRE, TYPE_DRAGON),
        .catchRate = 10,
        .expYield = 295,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
...
#define TERAPAGOS_MISC_INFO                                                             \
    ...
    [SPECIES_PECHARUNT] =
    {
        ...
        .baseSpAttack  = 88,
        .baseSpDefense = 88,
        .types = MON_TYPE(TYPE_POISON, TYPE_GHOST),
        .catchRate = 3,
        .expYield = 300,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
