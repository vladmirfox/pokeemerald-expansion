...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_MAGICIAN, ABILITY_PROTEAN },
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_UNAWARE, ABILITY_OBLIVIOUS },
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_BLAZE, ABILITY_UNAWARE, ABILITY_OBLIVIOUS }, // CHANGE HA TO FLAMING VOICE
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_DANCER, ABILITY_MOXIE },
