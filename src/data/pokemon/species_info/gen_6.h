...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 77,
        .types = MON_TYPE(TYPE_NORMAL, TYPE_GROUND),
        .catchRate = 127,
        .expYield = 148,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .baseSpAttack  = 56,
        .baseSpDefense = 52,
        .types = MON_TYPE(TYPE_FIRE, TYPE_FLYING),
        .catchRate = 120,
        .expYield = 134,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = 54,
        .types = MON_TYPE(TYPE_FIRE, TYPE_NORMAL),
        .catchRate = 220,
        .expYield = 74,
        .evYield_SpAttack = 1,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_INKAY] =
    {
        ...
        .baseSpAttack  = 37,
        .baseSpDefense = 46,
        .types = MON_TYPE(TYPE_DARK, TYPE_PSYCHIC),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .baseSpAttack  = 39,
        .baseSpDefense = 56,
        .types = MON_TYPE(TYPE_ROCK, TYPE_WATER),
        .catchRate = 120,
        .expYield = 61,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPE(TYPE_POISON, TYPE_WATER),
        .catchRate = 225,
        .expYield = 64,
        .evYield_SpDefense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 43,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_NORMAL),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 45,
        .types = MON_TYPE(TYPE_ROCK, TYPE_DRAGON),
        .catchRate = 45,
        .expYield = 72,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .baseSpAttack  = 67,
        .baseSpDefense = 63,
        .types = MON_TYPE(TYPE_ROCK, TYPE_ICE),
        .catchRate = 45,
        .expYield = 72,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .baseSpAttack  = 74,
        .baseSpDefense = 63,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_FLYING),
        .catchRate = 100,
        .expYield = 175,
        .evYield_Attack = 2,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
            ...
            .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_HUMAN_LIKE),
        #else
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 67,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_FAIRY),
        .catchRate = 180,
        .expYield = 151,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 150,
        .types = MON_TYPE(TYPE_ROCK, TYPE_FAIRY),
        .catchRate = 60,
        .expYield = 100,
        .evYield_Defense = 1,
        .evYield_SpDefense = 1,
...
#define GOODRA_MISC_INFO                                        \
    ...
    [SPECIES_SLIGGOO_HISUIAN] =
    {
        ...
        .baseSpAttack  = 83,
        .baseSpDefense = 113,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_STEEL),
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 87,
        .types = MON_TYPE(TYPE_STEEL, TYPE_FAIRY),
        .catchRate = 75,
        .expYield = 165,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 60,
        .types = MON_TYPE(TYPE_GHOST, TYPE_GRASS),
        .catchRate = 120,
        .expYield = 62,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
...
#if P_UPDATED_EGG_GROUPS >= GEN_8
    #define BERGMITE_EGG_GROUPS MON_EGG_GROUP(EGG_GROUP_MONSTER, EGG_GROUP_MINERAL)
#else
    #define BERGMITE_EGG_GROUPS MON_EGG_GROUP(EGG_GROUP_MONSTER)
#endif
...
,
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .baseSpAttack  = 34,
        .baseSpDefense = 36,
        .types = MON_TYPE(TYPE_ICE, TYPE_ROCK),
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_FLYING, TYPE_DRAGON),
        .catchRate = 190,
        .expYield = 49,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define HOOPA_MISC_INFO                                                                 \
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .baseSpAttack  = 170,
        .baseSpDefense = 130,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_DARK),
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_FIRE, TYPE_WATER),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
