...
#define CORVIKNIGHT_MISC_INFO                                                       \
        ...
        .baseSpAttack  = 53,                                                        \
        .baseSpDefense = 85,                                                        \
        .types = MON_TYPE(TYPE_FLYING, TYPE_STEEL),                                 \
        .catchRate = 45,                                                            \
        .expYield = 248,                                                            \
        .evYield_Defense = 3,                                                       \
        .genderRatio = PERCENT_FEMALE(50),                                          \
...
#define DREDNAW_MISC_INFO                                                               \
    ...
    [SPECIES_CARKOL] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_ROCK, TYPE_FIRE),
        .catchRate = 120,
        .expYield = 144,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define COALOSSAL_MISC_INFO                                                             \
    ...
    [SPECIES_APPLIN] =
    {
        ...
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
...
#define CRAMORANT_MISC_INFO                                             \
        ...
        .baseSpAttack  = 85,                                            \
        .baseSpDefense = 95,                                            \
        .types = MON_TYPE(TYPE_FLYING, TYPE_WATER),                     \
        .catchRate = 45,                                                \
        .expYield = 166,                                                \
        .evYield_SpDefense = 2,                                         \
        .genderRatio = PERCENT_FEMALE(50),                              \
    ...
    [SPECIES_TOXEL] =
    {
        ...
        .baseSpAttack  = 54,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_POISON),
        .catchRate = 75,
        .expYield = 48,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define TOXTRICITY_MISC_INFO                                            \
    ...
    [SPECIES_SIZZLIPEDE] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_FIRE, TYPE_BUG),
        .catchRate = 190,
        .expYield = 61,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define CENTISKORCH_MISC_INFO                                                           \
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_HUMAN_LIKE),
...
#define HATTERENE_MISC_INFO                                                             \
        ...
        .baseSpAttack  = 136,                                                           \
        .baseSpDefense = 103,                                                           \
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_FAIRY),                                    \
        .catchRate = 45,                                                                \
        .expYield = 255,                                                                \
        .evYield_SpAttack = 3,                                                          \
        .genderRatio = MON_FEMALE,                                                      \
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_DARK, TYPE_FAIRY),
        .catchRate = 255,
        .expYield = 53,
        .evYield_SpAttack = 1,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FAIRY, EGG_GROUP_HUMAN_LIKE),
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)  \
    ...
    [SPECIES_PINCURCHIN] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
    ...
    [SPECIES_SNOM] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_ICE, TYPE_BUG),
        .catchRate = 190,
        .expYield = 37,
        .evYield_SpAttack = 1,
...
#define INDEEDEE_MISC_INFO                                  \
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_NORMAL),       \
        .catchRate = 30,                                    \
        .expYield = 166,                                    \
        .eggCycles = 40,                                    \
        .friendship = 140,                                  \
...
#define MORPEKO_MISC_INFO                                            \
        ...
        .baseSpAttack  = 70,                                         \
        .baseSpDefense = 58,                                         \
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_DARK),                 \
        .catchRate = 180,                                            \
        .expYield = 153,                                             \
        .evYield_Speed = 2,                                          \
        .genderRatio = PERCENT_FEMALE(50),                           \
...
#define COPPERAJAH_MISC_INFO                                                        \
    ...
    [SPECIES_ARCTOVISH] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_WATER, TYPE_ICE),
        .catchRate = 45,
        .expYield = 177,
        .evYield_Defense = 2,
        .genderRatio = MON_GENDERLESS,
...
#define DURALUDON_MISC_INFO                                                             \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                              \
        .growthRate = GROWTH_MEDIUM_FAST,                                               \
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MINERAL, EGG_GROUP_DRAGON),                \
    ...
    [SPECIES_DREEPY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_GHOST),
        .catchRate = 45,
        .expYield = 54,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_AMORPHOUS, EGG_GROUP_DRAGON),
...
#define ETERNATUS_MISC_INFO                                                             \
        .types = MON_TYPE(TYPE_POISON, TYPE_DRAGON),                                    \
        .catchRate = 255,                                                               \
        .evYield_HP = 3,                                                                \
        .genderRatio = MON_GENDERLESS,                                                  \
        .eggCycles = 120,                                                               \
...
#define URSHIFU_SINGLE_STRIKE_STYLE_MISC_INFO       \
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_DARK),\
...
#define URSHIFU_RAPID_STRIKE_STYLE_MISC_INFO            \
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_WATER),   \
...
#define CALYREX_MISC_INFO                                   \
    ...
    [SPECIES_CALYREX] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 80,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_GRASS),
        .catchRate = 3,
        .expYield = 250,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CALYREX_ICE_RIDER] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 130,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_ICE),
        .catchRate = 3,
        .expYield = 340,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_CALYREX_SHADOW_RIDER] =
    {
        ...
        .baseSpAttack  = 165,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_GHOST),
        .catchRate = 3,
        .expYield = 340,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
...
#define ENAMORUS_MISC_INFO                                                              \
        .types = MON_TYPE(TYPE_FAIRY, TYPE_FLYING),                                     \
        .catchRate = 3,                                                                 \
        .expYield = 116,                                                                \
        .evYield_SpAttack = 3,                                                          \
        .genderRatio = MON_FEMALE,                                                      \
