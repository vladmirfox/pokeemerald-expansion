...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 0, SPECIES_ROSELIA, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 0, SPECIES_CHIMECHO, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
#endif //P_GEN_4_CROSS_EVOS
