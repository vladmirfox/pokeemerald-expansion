...
#define DECIDUEYE_MISC_INFO                                     \
    ...
    [SPECIES_INCINEROAR] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_FIRE, TYPE_DARK),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 265 : 239,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_PRIMARINA] =
    {
        ...
        .baseSpAttack  = 126,
        .baseSpDefense = 116,
        .types = MON_TYPE(TYPE_WATER, TYPE_FAIRY),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 265 : 239,
        .evYield_SpAttack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 75,
        .types = MON_TYPE(TYPE_BUG, TYPE_ELECTRIC),
        .catchRate = 120,
        .expYield = 140,
        .evYield_Defense = 2,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .baseSpAttack  = 62,
        .baseSpDefense = 67,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_ICE),
        .catchRate = 60,
        .expYield = 167,
        .evYield_Attack = 2,
...
#define ORICORIO_MISC_INFO                                      \
    ...
    {
        ORICORIO_MISC_INFO,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_FLYING),
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_BUG, TYPE_FAIRY),
        .catchRate = 190,
        .expYield = 61,
        .evYield_Speed = 1,
        .itemRare = ITEM_HONEY,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG, EGG_GROUP_FAIRY),
...
#define WISHIWASHI_MISC_INFO                                    \
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 72,
        .types = MON_TYPE(TYPE_WATER, TYPE_BUG),
        .catchRate = 200,
        .expYield = 54,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 75,
        .types = MON_TYPE(TYPE_GRASS, TYPE_FAIRY),
        .catchRate = 190,
        .expYield = 57,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .baseSpAttack  = 71,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_POISON, TYPE_FIRE),
        .catchRate = 120,
        .expYield = 64,
        .evYield_Speed = 1,
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 110,
        .types = MON_TYPE(TYPE_NORMAL, TYPE_PSYCHIC),
        .catchRate = 45,
        .expYield = 172,
        .evYield_SpDefense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 45,
        .types = MON_TYPE(TYPE_GHOST, TYPE_GROUND),
        .catchRate = 140,
        .expYield = 64,
        .evYield_Defense = 1,
...
#define MINIOR_MISC_INFO(color)                                 \
        .types = MON_TYPE(TYPE_ROCK, TYPE_FLYING),              \
        .catchRate = 30,                                        \
        .expYield = 154,                                        \
        .evYield_Defense = 1,                                   \
        .evYield_SpDefense = 1,                                 \
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 73,
        .types = MON_TYPE(TYPE_ELECTRIC, TYPE_STEEL),
        .catchRate = 180,
        .expYield = 152,
        .evYield_Attack = 2,
...
#define MIMIKYU_MISC_INFO                                           \
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 91,
        .types = MON_TYPE(TYPE_NORMAL, TYPE_DRAGON),
        .catchRate = 70,
        .expYield = 170,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_HAKAMO_O] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 147,
        .evYield_Defense = 2,
        .itemRare = ITEM_RAZOR_CLAW,
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .baseSpAttack  = 113,
        .baseSpDefense = 89,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        .baseSpAttack  = 107,
        .baseSpDefense = 101,
        .types = MON_TYPE(TYPE_STEEL, TYPE_FLYING),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .baseSpAttack  = 59,
        .baseSpDefense = 31,
        .types = MON_TYPE(TYPE_GRASS, TYPE_STEEL),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        .baseSpAttack  = 97,
        .baseSpDefense = 53,
        .types = MON_TYPE(TYPE_DARK, TYPE_DRAGON),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
...
#define NECROZMA_MISC_INFO                                                              \
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .baseSpAttack  = 167,
        .baseSpDefense = 97,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_DRAGON),
        .catchRate = 255,
...
#define MAGEARNA_MISC_INFO(Form)                                                        \
    ...
    [SPECIES_MARSHADOW] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_GHOST),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_Attack = 2,
        .evYield_Speed = 1,
