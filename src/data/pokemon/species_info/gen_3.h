...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
...
#define SCEPTILE_MISC_INFO                                              \
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .baseSpAttack  = 145,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_GRASS, TYPE_DRAGON),
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD),
...
#define BLAZIKEN_MISC_INFO                                  \
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
...
#define LINOONE_MISC_INFO                                                       \
    ...
    {
        ZIGZAGOON_MISC_INFO,
        .types = MON_TYPE(TYPE_DARK, TYPE_NORMAL),
        .bodyColor = BODY_COLOR_WHITE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG),
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_BUG, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 193,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_WATER, TYPE_GRASS),
        .catchRate = 255,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_GRASS),
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_GRASS, TYPE_DARK),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 119 : 141,
        .evYield_Attack = 2,
        .itemRare = ITEM_POWER_HERB,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING),
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_WATER, TYPE_FLYING),
        .catchRate = 190,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #define RALTS_FAMILY_EGG_GROUPS MON_EGG_GROUP(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_AMORPHOUS)
#else
    #define RALTS_FAMILY_EGG_GROUPS MON_EGG_GROUP(EGG_GROUP_AMORPHOUS)
#endif
    ...
    [SPECIES_RALTS] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_PSYCHIC, RALTS_FAMILY_TYPE2),
        .catchRate = 235,
...
#define GALLADE_MISC_INFO                                   \
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_FIGHTING),     \
        .catchRate = 45,                                    \
        .evYield_Attack = 3,                                \
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 52,
        .types = MON_TYPE(TYPE_BUG, TYPE_WATER),
        .catchRate = 200,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPE(TYPE_GRASS, TYPE_FIGHTING),
        .catchRate = 90,
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_BUG, TYPE_GHOST),
        .catchRate = 45,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MINERAL),
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_HUMAN_LIKE),
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
...
#define SABLEYE_MISC_INFO                                           \
        .types = MON_TYPE(TYPE_DARK, TYPE_GHOST),                   \
        .catchRate = 45,                                            \
        .evYield_Attack = 1,                                        \
        .evYield_Defense = 1,                                       \
        .genderRatio = PERCENT_FEMALE(50),                          \
...
#define MAWILE_MISC_INFO                                             \
    ...
    [SPECIES_ARON] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_STEEL, TYPE_ROCK),
        .catchRate = 180,
        ...
        .friendship = 35,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MONSTER),
...
#define AGGRON_MISC_INFO                                        \
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_PSYCHIC),
        .catchRate = 180,
...
#define MANECTRIC_MISC_INFO                                 \
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FAIRY),
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_GRASS, TYPE_POISON),
        .catchRate = 255,
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_AMORPHOUS),
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 20,
        .types = MON_TYPE(TYPE_WATER, TYPE_DARK),
        .catchRate = 225,
        ...
        .friendship = 35,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_2),
...
#define SHARPEDO_MISC_INFO                                      \
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_WATER_2),
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 45,
        .types = MON_TYPE(TYPE_FIRE, TYPE_GROUND),
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 88,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        #if P_UPDATED_EGG_GROUPS >= GEN_8
            .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG, EGG_GROUP_DRAGON),
        #else
            .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG),
        #endif
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_GROUND, TYPE_DRAGON),
        .catchRate = 120,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .friendship = 35,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS, EGG_GROUP_HUMAN_LIKE),
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_DRAGON),
...
#define ALTARIA_MISC_INFO                                              \
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_FLYING),
    ...
    [SPECIES_ALTARIA_MEGA] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 105,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_FAIRY),
        .expYield = 207,
        .abilities = { ABILITY_PIXILATE, ABILITY_PIXILATE, ABILITY_PIXILATE },
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_DRAGON),
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPE(TYPE_ROCK, TYPE_PSYCHIC),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_GROUND, TYPE_PSYCHIC),
        .catchRate = 255,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 87,
        .types = MON_TYPE(TYPE_ROCK, TYPE_GRASS),
        .catchRate = 45,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_3),
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_ROCK, TYPE_BUG),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_5
        .expYield = 71,
    #elif P_UPDATED_EXP_YIELDS >= GEN_4
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
...
#define CASTFORM_MISC_INFO                                               \
        ...
        .friendship = STANDARD_FRIENDSHIP,                               \
        .growthRate = GROWTH_MEDIUM_FAST,                                \
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FAIRY, EGG_GROUP_AMORPHOUS),\
...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
...
#define ABSOL_MISC_INFO                                     \
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
...
#define GLALIE_MISC_INFO                                               \
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_ICE, TYPE_GHOST),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 187,
        .evYield_Speed = 2,
        .genderRatio = MON_FEMALE,
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 50,
        .types = MON_TYPE(TYPE_ICE, TYPE_WATER),
        .catchRate = 255,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1),
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_WATER, TYPE_ROCK),
        .catchRate = 25,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    ...
    [SPECIES_BAGON] =
    {
        ...
        .friendship = 35,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_DRAGON),
...
#define LATIAS_MISC_INFO                                                \
        .types = MON_TYPE(TYPE_DRAGON, TYPE_PSYCHIC),                   \
        .catchRate = 3,                                                 \
        .evYield_SpDefense = 3,                                         \
        .genderRatio = MON_FEMALE,                                      \
        .eggCycles = 120,                                               \
...
#define GROUDON_MISC_INFO                                                           \
    ...
    [SPECIES_GROUDON_PRIMAL] =
    {
        ...
        .baseSpDefense = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 385 : 347,
        .types = MON_TYPE(TYPE_GROUND, TYPE_FIRE),
