...
#define SCEPTILE_MISC_INFO                                  \
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .types = { TYPE_GRASS, TYPE_DRAGON },
        .expYield = 284,
        .abilities = { ABILITY_TECHNICIAN, ABILITY_TECHNICIAN, ABILITY_LIGHTNING_ROD },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_EARLY_BIRD, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_SPEED_BOOST }, // CHANGE A2 TO IRON SOLE
        .bodyColor = BODY_COLOR_RED,
