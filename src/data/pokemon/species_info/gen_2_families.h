...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_HYPER_DRILL, SPECIES_DUDUNSPARCE_TWO_SEGMENT, CONDITIONS({IF_PID_MODULO_100_GT, 0})},
                                {EVO_MOVE, MOVE_HYPER_DRILL, SPECIES_DUDUNSPARCE_THREE_SEGMENT, CONDITIONS({IF_PID_MODULO_100_EQ, 0})}),
    },
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_ITEM_HOLD, ITEM_RAZOR_FANG, SPECIES_GLISCOR, CONDITIONS({IF_TIME, TIME_NIGHT})},
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_ITEM_HOLD, ITEM_RAZOR_CLAW, SPECIES_WEAVILE, CONDITIONS({IF_TIME, TIME_NIGHT})},
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL_ITEM_HOLD, ITEM_RAZOR_CLAW, SPECIES_SNEASLER, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
