...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_RECKLESS }, // CHANGE A2 TO MAX GIRTH
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
...
#define BASCULIN_MISC_INFO                                      \
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 36, SPECIES_BASCULEGION_MALE},
                                {EVO_LEVEL_FEMALE, 36, SPECIES_BASCULEGION_FEMALE}),
    },
