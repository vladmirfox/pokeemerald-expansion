...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_PSYCHIC, TYPE_FIRE),
        .catchRate = 3,
...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD, EGG_GROUP_FLYING),
...
#define AUDINO_MISC_INFO                                    \
    ...
    [SPECIES_AUDINO_MEGA] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 126,
        .types = MON_TYPE(TYPE_NORMAL, TYPE_FAIRY),
        .expYield = 425,
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS, EGG_GROUP_FAIRY),
...
#define BASCULEGION_MISC_INFO                                                               \
        .types = MON_TYPE(TYPE_WATER, TYPE_GHOST),                                          \
        .catchRate = 45,                                                                    \
        .expYield = 265,                                                                    \
        .evYield_HP = 3,                                                                    \
        .eggCycles = 20,                                                                    \
    ...
    [SPECIES_SANDILE] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_GROUND, TYPE_DARK),
        .catchRate = 180,
        .expYield = 58,
        .evYield_Attack = 1,
...
#define DARMANITAN_GALARIAN_MISC_INFO                                           \
    ...
    [SPECIES_DARMANITAN_GALARIAN_ZEN_MODE] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 55,
        .types = MON_TYPE(TYPE_ICE, TYPE_FIRE),
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 35,
        .types = MON_TYPE(TYPE_BUG, TYPE_ROCK),
        .catchRate = 190,
        .expYield = 65,
        .evYield_Defense = 1,
        .itemRare = ITEM_HARD_STONE,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_BUG, EGG_GROUP_MINERAL),
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 70,
        .types = MON_TYPE(TYPE_DARK, TYPE_FIGHTING),
        .catchRate = 180,
        .expYield = 70,
        .evYield_Attack = 1,
...
#define YAMASK_MISC_INFO                                                   \
    ...
    [SPECIES_YAMASK_GALARIAN] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 65,
        .types = MON_TYPE(TYPE_GROUND, TYPE_GHOST),
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_WATER_3),
...
#define ZOROARK_MISC_INFO                                   \
    ...
    [SPECIES_ZORUA_HISUIAN] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_NORMAL, TYPE_GHOST),
...
#define DEERLING_MISC_INFO                                                              \
        ...
        .baseSpAttack  = 40,                                                            \
        .baseSpDefense = 50,                                                            \
        .types = MON_TYPE(TYPE_NORMAL, TYPE_GRASS),                                     \
        .catchRate = 190,                                                               \
        .expYield = 67,                                                                 \
        .evYield_Speed = 1,                                                             \
        .genderRatio = PERCENT_FEMALE(50),                                              \
...
#define SAWSBUCK_MISC_INFO                                                              \
    ...
    [SPECIES_FERROSEED] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_GRASS, EGG_GROUP_MINERAL),
    ...
    [SPECIES_LITWICK] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 55,
        .types = MON_TYPE(TYPE_GHOST, TYPE_FIRE),
        .catchRate = 190,
        .expYield = 55,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define STUNFISK_MISC_INFO                                                 \
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 99,
        .types = MON_TYPE(TYPE_GROUND, TYPE_ELECTRIC),
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_DRAGON, EGG_GROUP_MONSTER),
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        .types = MON_TYPE(TYPE_DARK, TYPE_STEEL),
        .catchRate = 120,
        .expYield = 68,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define BRAVIARY_MISC_INFO                                      \
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 55,
        .types = MON_TYPE(TYPE_BUG, TYPE_FIRE),
        .catchRate = 45,
        .expYield = 72,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_COBALION] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 72,
        .types = MON_TYPE(TYPE_STEEL, TYPE_FIGHTING),
        .catchRate = 3,
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        .baseSpAttack  = 72,
        .baseSpDefense = 90,
        .types = MON_TYPE(TYPE_ROCK, TYPE_FIGHTING),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 290 : 261,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
...
#define THUNDURUS_MISC_INFO                                                             \
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 120,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_FIRE),
        .catchRate = 3,
    ...
    [SPECIES_ZEKROM] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 100,
        .types = MON_TYPE(TYPE_DRAGON, TYPE_ELECTRIC),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
...
#define LANDORUS_MISC_INFO                                                              \
        .types = MON_TYPE(TYPE_GROUND, TYPE_FLYING),                                    \
        .catchRate = 3,                                                                 \
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,                        \
        .genderRatio = MON_MALE,                                                        \
        .eggCycles = 120,                                                               \
