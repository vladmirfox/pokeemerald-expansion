...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .baseSpAttack  = 56,
        .baseSpDefense = 56,
        .types = MON_TYPE(TYPE_WATER, TYPE_ELECTRIC),
        .catchRate = 190,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 65,
        .types = MON_TYPE(TOGEPI_FAMILY_TYPE),
        .catchRate = 190,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 105,
        .types = MON_TYPE(TOGEPI_FAMILY_TYPE, TYPE_FLYING),
        .catchRate = 75,
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FLYING, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HUSTLE, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_WHITE,
...
#define QWILFISH_MISC_INFO                                                              \
    ...
    {
        QWILFISH_MISC_INFO,
        .types = MON_TYPE(TYPE_DARK, TYPE_POISON),
        .bodyColor = BODY_COLOR_BLACK,
        .description = COMPOUND_STRING(
...
#define SNEASEL_MISC_INFO                                       \
    ...
    {
        SNEASEL_MISC_INFO,
        .types = MON_TYPE(TYPE_FIGHTING, TYPE_POISON),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_KEEN_EYE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_GRAY,
        .weight = 270,
        .description = COMPOUND_STRING(
...
#define URSALUNA_MISC_INFO                                  \
        .expYield = 275,                                    \
        .types = MON_TYPE(TYPE_GROUND, TYPE_NORMAL),        \
        .eggCycles = 20,                                    \
        .friendship = STANDARD_FRIENDSHIP,                  \
        .growthRate = GROWTH_MEDIUM_FAST,                   \
        .eggGroups = MON_EGG_GROUP(EGG_GROUP_FIELD),        \
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPE(TYPE_ICE, TYPE_GROUND),
        .catchRate = 225,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 50 : 78,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define TYRANITAR_MISC_INFO                                     \
        .types = MON_TYPE(TYPE_ROCK, TYPE_DARK),                \
        .catchRate = 45,                                        \
        .evYield_Attack = 3,                                    \
        .genderRatio = PERCENT_FEMALE(50),                      \
        .eggCycles = 40,                                        \
