const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]                = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                                        ...
                                        {EVO_ITEM, ITEM_NONE/*ITEM_BLACK_AUGURITE*/, SPECIES_KLEAVOR}
                                    #endif
                                        },
    ...
    [SPECIES_SCATTERBUG_ICY_SNOW]    = {{EVO_LEVEL, 9, SPECIES_SPEWPA_ICY_SNOW}},
    [SPECIES_SCATTERBUG_POLAR]       = {{EVO_LEVEL, 9, SPECIES_SPEWPA_POLAR}},
    [SPECIES_SCATTERBUG_TUNDRA]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_TUNDRA}},
    [SPECIES_SCATTERBUG_CONTINENTAL] = {{EVO_LEVEL, 9, SPECIES_SPEWPA_CONTINENTAL}},
    [SPECIES_SCATTERBUG_GARDEN]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_GARDEN}},
    [SPECIES_SCATTERBUG_ELEGANT]     = {{EVO_LEVEL, 9, SPECIES_SPEWPA_ELEGANT}},
    [SPECIES_SCATTERBUG_MEADOW]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_MEADOW}},
    [SPECIES_SCATTERBUG_MODERN]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_MODERN}},
    [SPECIES_SCATTERBUG_MARINE]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_MARINE}},
    [SPECIES_SCATTERBUG_ARCHIPELAGO] = {{EVO_LEVEL, 9, SPECIES_SPEWPA_ARCHIPELAGO}},
    [SPECIES_SCATTERBUG_HIGH_PLAINS] = {{EVO_LEVEL, 9, SPECIES_SPEWPA_HIGH_PLAINS}},
    [SPECIES_SCATTERBUG_SANDSTORM]   = {{EVO_LEVEL, 9, SPECIES_SPEWPA_SANDSTORM}},
    [SPECIES_SCATTERBUG_RIVER]       = {{EVO_LEVEL, 9, SPECIES_SPEWPA_RIVER}},
    [SPECIES_SCATTERBUG_MONSOON]     = {{EVO_LEVEL, 9, SPECIES_SPEWPA_MONSOON}},
    [SPECIES_SCATTERBUG_SAVANNA]     = {{EVO_LEVEL, 9, SPECIES_SPEWPA_SAVANNA}},
    [SPECIES_SCATTERBUG_SUN]         = {{EVO_LEVEL, 9, SPECIES_SPEWPA_SUN}},
    [SPECIES_SCATTERBUG_OCEAN]       = {{EVO_LEVEL, 9, SPECIES_SPEWPA_OCEAN}},
    [SPECIES_SCATTERBUG_JUNGLE]      = {{EVO_LEVEL, 9, SPECIES_SPEWPA_JUNGLE}},
    [SPECIES_SCATTERBUG_FANCY]       = {{EVO_LEVEL, 9, SPECIES_SPEWPA_FANCY}},
    [SPECIES_SCATTERBUG_POKE_BALL]   = {{EVO_LEVEL, 9, SPECIES_SPEWPA_POKE_BALL}},
    [SPECIES_SPEWPA_ICY_SNOW]        = {{EVO_LEVEL, 12, SPECIES_VIVILLON_ICY_SNOW}},
    [SPECIES_SPEWPA_POLAR]           = {{EVO_LEVEL, 12, SPECIES_VIVILLON_POLAR}},
    [SPECIES_SPEWPA_TUNDRA]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_TUNDRA}},
    [SPECIES_SPEWPA_CONTINENTAL]     = {{EVO_LEVEL, 12, SPECIES_VIVILLON_CONTINENTAL}},
    [SPECIES_SPEWPA_GARDEN]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_GARDEN}},
    [SPECIES_SPEWPA_ELEGANT]         = {{EVO_LEVEL, 12, SPECIES_VIVILLON_ELEGANT}},
    [SPECIES_SPEWPA_MEADOW]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_MEADOW}},
    [SPECIES_SPEWPA_MODERN]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_MODERN}},
    [SPECIES_SPEWPA_MARINE]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_MARINE}},
    [SPECIES_SPEWPA_ARCHIPELAGO]     = {{EVO_LEVEL, 12, SPECIES_VIVILLON_ARCHIPELAGO}},
    [SPECIES_SPEWPA_HIGH_PLAINS]     = {{EVO_LEVEL, 12, SPECIES_VIVILLON_HIGH_PLAINS}},
    [SPECIES_SPEWPA_SANDSTORM]       = {{EVO_LEVEL, 12, SPECIES_VIVILLON_SANDSTORM}},
    [SPECIES_SPEWPA_RIVER]           = {{EVO_LEVEL, 12, SPECIES_VIVILLON_RIVER}},
    [SPECIES_SPEWPA_MONSOON]         = {{EVO_LEVEL, 12, SPECIES_VIVILLON_MONSOON}},
    [SPECIES_SPEWPA_SAVANNA]         = {{EVO_LEVEL, 12, SPECIES_VIVILLON_SAVANNA}},
    [SPECIES_SPEWPA_SUN]             = {{EVO_LEVEL, 12, SPECIES_VIVILLON_SUN}},
    [SPECIES_SPEWPA_OCEAN]           = {{EVO_LEVEL, 12, SPECIES_VIVILLON_OCEAN}},
    [SPECIES_SPEWPA_JUNGLE]          = {{EVO_LEVEL, 12, SPECIES_VIVILLON_JUNGLE}},
    [SPECIES_SPEWPA_FANCY]           = {{EVO_LEVEL, 12, SPECIES_VIVILLON_FANCY}},
    [SPECIES_SPEWPA_POKE_BALL]       = {{EVO_LEVEL, 12, SPECIES_VIVILLON_POKE_BALL}},
    ...
    [SPECIES_URSARING]               = {{EVO_ITEM_NIGHT, ITEM_NONE/*ITEM_PEAT_BLOCK*/, SPECIES_URSALUNA}},
