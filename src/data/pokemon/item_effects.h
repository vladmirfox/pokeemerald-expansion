...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_WONDER_LAUNCHER_X_ATTACK_1 - ITEM_POTION]         = gItemEffect_XAttack,
    [ITEM_WONDER_LAUNCHER_X_ATTACK_2 - ITEM_POTION]         = gItemEffect_XAttack,
    [ITEM_WONDER_LAUNCHER_X_ATTACK_3 - ITEM_POTION]         = gItemEffect_XAttack,
    [ITEM_WONDER_LAUNCHER_X_ATTACK_6 - ITEM_POTION]         = gItemEffect_XAttack,
    [ITEM_WONDER_LAUNCHER_X_DEFENSE_1 - ITEM_POTION]        = gItemEffect_XDefense,
    [ITEM_WONDER_LAUNCHER_X_DEFENSE_2 - ITEM_POTION]        = gItemEffect_XDefense,
    [ITEM_WONDER_LAUNCHER_X_DEFENSE_3 - ITEM_POTION]        = gItemEffect_XDefense,
    [ITEM_WONDER_LAUNCHER_X_DEFENSE_6 - ITEM_POTION]        = gItemEffect_XDefense,
    [ITEM_WONDER_LAUNCHER_X_SPEED_1 - ITEM_POTION]          = gItemEffect_XSpeed,
    [ITEM_WONDER_LAUNCHER_X_SPEED_2 - ITEM_POTION]          = gItemEffect_XSpeed,
    [ITEM_WONDER_LAUNCHER_X_SPEED_3 - ITEM_POTION]          = gItemEffect_XSpeed,
    [ITEM_WONDER_LAUNCHER_X_SPEED_6 - ITEM_POTION]          = gItemEffect_XSpeed,
    [ITEM_WONDER_LAUNCHER_X_ACCURACY_1 - ITEM_POTION]       = gItemEffect_XAccuracy,
    [ITEM_WONDER_LAUNCHER_X_ACCURACY_2 - ITEM_POTION]       = gItemEffect_XAccuracy,
    [ITEM_WONDER_LAUNCHER_X_ACCURACY_3 - ITEM_POTION]       = gItemEffect_XAccuracy,
    [ITEM_WONDER_LAUNCHER_X_ACCURACY_6 - ITEM_POTION]       = gItemEffect_XAccuracy,
    [ITEM_WONDER_LAUNCHER_X_SP_ATK_1 - ITEM_POTION]         = gItemEffect_XSpecialAttack,
    [ITEM_WONDER_LAUNCHER_X_SP_ATK_2 - ITEM_POTION]         = gItemEffect_XSpecialAttack,
    [ITEM_WONDER_LAUNCHER_X_SP_ATK_3 - ITEM_POTION]         = gItemEffect_XSpecialAttack,
    [ITEM_WONDER_LAUNCHER_X_SP_ATK_6 - ITEM_POTION]         = gItemEffect_XSpecialAttack,
    [ITEM_WONDER_LAUNCHER_X_SP_DEF_1 - ITEM_POTION]         = gItemEffect_XSpecialDefense,
    [ITEM_WONDER_LAUNCHER_X_SP_DEF_2 - ITEM_POTION]         = gItemEffect_XSpecialDefense,
    [ITEM_WONDER_LAUNCHER_X_SP_DEF_3 - ITEM_POTION]         = gItemEffect_XSpecialDefense,
    [ITEM_WONDER_LAUNCHER_X_SP_DEF_6 - ITEM_POTION]         = gItemEffect_XSpecialDefense,
