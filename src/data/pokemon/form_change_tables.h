...
static const struct Fusion sNecrozmaFusionTable[] = {
    {SPECIES_NECROZMA, SPECIES_SOLGALEO, SPECIES_NECROZMA_DUSK_MANE, ITEM_N_SOLARIZER, MOVE_SUNSTEEL_STRIKE},
    {SPECIES_NECROZMA, SPECIES_LUNALA, SPECIES_NECROZMA_DAWN_WINGS, ITEM_N_LUNARIZER, MOVE_MOONGEIST_BEAM},
    {SPECIES_NECROZMA_DAWN_WINGS, SPECIES_LUNALA, SPECIES_NECROZMA, ITEM_N_LUNARIZER, MOVE_CONFUSION, TRUE},
    {SPECIES_NECROZMA_DUSK_MANE, SPECIES_SOLGALEO, SPECIES_NECROZMA, ITEM_N_SOLARIZER, MOVE_CONFUSION, TRUE},
    {FORM_CHANGE_END},
};

static const struct Fusion sCalyrexFusionTable[] = {
    {SPECIES_CALYREX, SPECIES_GLASTRIER, SPECIES_CALYREX_ICE_RIDER, ITEM_REINS_OF_UNITY, MOVE_GLACIAL_LANCE},
    {SPECIES_CALYREX, SPECIES_SPECTRIER, SPECIES_CALYREX_SHADOW_RIDER, ITEM_REINS_OF_UNITY, MOVE_ASTRAL_BARRAGE},
    {SPECIES_CALYREX_ICE_RIDER, SPECIES_GLASTRIER, SPECIES_CALYREX, ITEM_REINS_OF_UNITY, MOVE_CONFUSION, TRUE},
    {SPECIES_CALYREX_SHADOW_RIDER, SPECIES_SPECTRIER, SPECIES_CALYREX, ITEM_REINS_OF_UNITY, MOVE_CONFUSION, TRUE},
    {FORM_CHANGE_END},
};
