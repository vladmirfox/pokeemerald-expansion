...
static const struct FormChange sDarmanitanGalarianFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALAR_STANDARD_MODE, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALAR_ZEN_MODE,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_FAINT,             SPECIES_DARMANITAN_GALAR_STANDARD_MODE},
    {FORM_CHANGE_END_BATTLE,        SPECIES_DARMANITAN_GALAR_STANDARD_MODE},
    {FORM_CHANGE_TERMINATOR},
};
