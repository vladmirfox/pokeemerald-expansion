...
static const struct Fusion sKyuremFusionTable[] = {
    {SPECIES_KYUREM, SPECIES_RESHIRAM, SPECIES_KYUREM_WHITE, ITEM_DNA_SPLICERS},
    {SPECIES_KYUREM, SPECIES_ZEKROM, SPECIES_KYUREM_BLACK, ITEM_DNA_SPLICERS},
    {SPECIES_KYUREM_BLACK, SPECIES_ZEKROM, SPECIES_KYUREM, ITEM_DNA_SPLICERS},
    {SPECIES_KYUREM_WHITE, SPECIES_RESHIRAM, SPECIES_KYUREM, ITEM_DNA_SPLICERS},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct Fusion sNecrozmaFusionTable[] = {
    {SPECIES_NECROZMA, SPECIES_SOLGALEO, SPECIES_NECROZMA_DUSK_MANE, ITEM_N_SOLARIZER, MOVE_SUNSTEEL_STRIKE, FALSE},
    {SPECIES_NECROZMA, SPECIES_LUNALA, SPECIES_NECROZMA_DAWN_WINGS, ITEM_N_LUNARIZER, MOVE_MOONGEIST_BEAM, FALSE},
    {SPECIES_NECROZMA_DAWN_WINGS, SPECIES_LUNALA, SPECIES_NECROZMA, ITEM_N_LUNARIZER, MOVE_CONFUSION, MOVE_MOONGEIST_BEAM},
    {SPECIES_NECROZMA_DUSK_MANE, SPECIES_SOLGALEO, SPECIES_NECROZMA, ITEM_N_SOLARIZER, MOVE_CONFUSION, MOVE_SUNSTEEL_STRIKE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct Fusion sCalyrexFusionTable[] = {
    {SPECIES_CALYREX, SPECIES_GLASTRIER, SPECIES_CALYREX_ICE_RIDER, ITEM_REINS_OF_UNITY, MOVE_GLACIAL_LANCE, FALSE},
    {SPECIES_CALYREX, SPECIES_SPECTRIER, SPECIES_CALYREX_SHADOW_RIDER, ITEM_REINS_OF_UNITY, MOVE_ASTRAL_BARRAGE, FALSE},
    {SPECIES_CALYREX_ICE_RIDER, SPECIES_GLASTRIER, SPECIES_CALYREX, ITEM_REINS_OF_UNITY, MOVE_CONFUSION, MOVE_GLACIAL_LANCE},
    {SPECIES_CALYREX_SHADOW_RIDER, SPECIES_SPECTRIER, SPECIES_CALYREX, ITEM_REINS_OF_UNITY, MOVE_CONFUSION, MOVE_ASTRAL_BARRAGE},
    {FORM_CHANGE_TERMINATOR},
};
