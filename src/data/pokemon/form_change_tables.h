...
static const struct FormChange sAegislashFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MOVE_CATEGORY, SPECIES_AEGISLASH_BLADE,  DAMAGE_CATEGORY_PHYSICAL, ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_MOVE_CATEGORY, SPECIES_AEGISLASH_BLADE,  DAMAGE_CATEGORY_SPECIAL,  ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_MOVE,          SPECIES_AEGISLASH_SHIELD, MOVE_KINGS_SHIELD,        ABILITY_STANCE_CHANGE},
