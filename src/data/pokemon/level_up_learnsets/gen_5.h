...
static const struct LevelUpMove sAudinoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE( 1, MOVE_BABY_DOLL_EYES), // New move for early-game utility
    LEVEL_UP_MOVE( 5, MOVE_REFRESH),
    LEVEL_UP_MOVE(10, MOVE_DOUBLE_SLAP),
    LEVEL_UP_MOVE(15, MOVE_ATTRACT),
    LEVEL_UP_MOVE(20, MOVE_SECRET_POWER),
    LEVEL_UP_MOVE(25, MOVE_ENTRAINMENT),
    LEVEL_UP_MOVE(30, MOVE_WISH), // New move for team healing
    LEVEL_UP_MOVE(35, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(40, MOVE_AFTER_YOU),
    LEVEL_UP_MOVE(45, MOVE_SIMPLE_BEAM),
    LEVEL_UP_MOVE(50, MOVE_LIGHT_SCREEN), // New move for support utility
    LEVEL_UP_MOVE(55, MOVE_REFLECT), // New move for support utility
    LEVEL_UP_MOVE(60, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE(65, MOVE_MOONBLAST), // New move for offensive coverage
    LEVEL_UP_END
};
