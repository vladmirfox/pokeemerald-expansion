const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_BASCULIN] =
    {
        ...
        .height = 10,
        .weight = 180,
        //.description = gBasculinRedStripedPokedexText,
        .pokemonScale = 316,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DEERLING] =
    {
        ...
        .height = 6,
        .weight = 195,
        //.description = gDeerlingSpringPokedexText,
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SAWSBUCK] =
    {
        ...
        .height = 19,
        .weight = 925,
        //.description = gSawsbuckSpringPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [NATIONAL_DEX_TORNADUS] =
    {
        ...
        .height = 15,
        .weight = 630,
        //.description = gTornadusIncarnatePokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_THUNDURUS] =
    {
        ...
        .height = 15,
        .weight = 610,
        //.description = gThundurusIncarnatePokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LANDORUS] =
    {
        ...
        .height = 15,
        .weight = 680,
        //.description = gLandorusIncarnatePokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VIVILLON] =
    {
        ...
        .height = 12,
        .weight = 170,
        //.description = gVivillonIcySnowPokedexText,
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FLABEBE] =
    {
        ...
        .height = 1,
        .weight = 1,
        //.description = gFlabebeRedFlowerPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FLOETTE] =
    {
        ...
        .height = 2,
        .weight = 9,
        //.description = gFloetteRedFlowerPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FLORGES] =
    {
        ...
        .height = 11,
        .weight = 100,
        //.description = gFlorgesRedFlowerPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWSTIC] =
    {
        ...
        .height = 6,
        .weight = 85,
        //.description = gMeowsticMalePokedexText,
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HOOPA] =
    {
        ...
        .height = 5,
        .weight = 90,
        //.description = gHoopaConfinedPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LYCANROC] =
    {
        ...
        .height = 8,
        .weight = 250,
        //.description = gLycanrocMiddayPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WISHIWASHI] =
    {
        ...
        .height = 2,
        .weight = 3,
        //.description = gWishiwashiSoloPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TOXTRICITY] =
    {
        ...
        .height = 16,
        .weight = 400,
        //.description = gToxtricityAmpedPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_POLTEAGEIST] =
    {
        ...
        .height = 2,
        .weight = 4,
        //.description = gPolteageistPhonyPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EISCUE] =
    {
        ...
        .height = 14,
        .weight = 890,
        //.description = gEiscueIceFacePokedexText,
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_INDEEDEE] =
    {
        ...
        .height = 9,
        .weight = 280,
        //.description = gIndeedeeMalePokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MORPEKO] =
    {
        ...
        .height = 3,
        .weight = 30,
        //.description = gMorpekoFullBellyPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZACIAN] =
    {
        ...
        .height = 28,
        .weight = 1100,
        //.description = gZacianHeroOfManyBattlesPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZAMAZENTA] =
    {
        ...
        .height = 29,
        .weight = 2100,
        //.description = gZamazentaHeroOfManyBattlesPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_URSHIFU] =
    {
        ...
        .height = 19,
        .weight = 1050,
        //.description = gUrshifuSingleStrikeStylePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
