const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    // Gigantamax Forms
    [SPECIES_VENUSAUR_GIGANTAMAX] = sVenusaurLevelUpLearnset,
    [SPECIES_CHARIZARD_GIGANTAMAX] = sCharizardLevelUpLearnset,
    [SPECIES_BLASTOISE_GIGANTAMAX] = sBlastoiseLevelUpLearnset,
    [SPECIES_BUTTERFREE_GIGANTAMAX] = sButterfreeLevelUpLearnset,
    [SPECIES_PIKACHU_GIGANTAMAX] = sPikachuLevelUpLearnset,
    [SPECIES_MEOWTH_GIGANTAMAX] = sMeowthLevelUpLearnset,
    [SPECIES_MACHAMP_GIGANTAMAX] = sMachampLevelUpLearnset,
    [SPECIES_GENGAR_GIGANTAMAX] = sGengarLevelUpLearnset,
    [SPECIES_KINGLER_GIGANTAMAX] = sKinglerLevelUpLearnset,
    ...
    [SPECIES_TOXTRICITY_GIGANTAMAX] = sToxtricityAmpedLevelUpLearnset,
