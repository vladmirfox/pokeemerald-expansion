const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CHERRIM_OVERCAST, gMonFrontPic_Cherrim),
    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonFrontPic_CherrimSunshine),
    SPECIES_SPRITE(SHELLOS_WEST_SEA, gMonFrontPic_Shellos),
    ...
    SPECIES_SPRITE(SCATTERBUG_ICY_SNOW, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_POLAR, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_TUNDRA, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_CONTINENTAL, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_GARDEN, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_ELEGANT, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MEADOW, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MODERN, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MARINE, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_ARCHIPELAGO, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_HIGH_PLAINS, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SANDSTORM, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_RIVER, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MONSOON, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SAVANNA, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SUN, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_OCEAN, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_JUNGLE, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_FANCY, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_POKE_BALL, gMonFrontPic_Scatterbug),
    SPECIES_SPRITE(SPEWPA_ICY_SNOW, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_POLAR, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_TUNDRA, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_CONTINENTAL, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_GARDEN, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_ELEGANT, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MEADOW, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MODERN, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MARINE, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_ARCHIPELAGO, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_HIGH_PLAINS, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SANDSTORM, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_RIVER, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MONSOON, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SAVANNA, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SUN, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_OCEAN, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_JUNGLE, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_FANCY, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_POKE_BALL, gMonFrontPic_Spewpa),
    SPECIES_SPRITE(VIVILLON_ICY_SNOW, gMonFrontPic_Vivillon),
