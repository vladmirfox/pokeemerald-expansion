...
{
    SPECIES_SPRITE(NONE, gMonBackPic_QuestionMark),
    ...
    SPECIES_SPRITE(CHERRIM_OVERCAST, gMonBackPic_Cherrim),
    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonBackPic_CherrimSunshine),
    SPECIES_SPRITE(SHELLOS_WEST_SEA, gMonBackPic_Shellos),
    ...
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonBackPic_QuestionMark), //gMonBackPic_SamurottHisuian),
    ...
    SPECIES_SPRITE(SCATTERBUG_ICY_SNOW, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_POLAR, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_TUNDRA, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_CONTINENTAL, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_GARDEN, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_ELEGANT, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MEADOW, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MODERN, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MARINE, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_ARCHIPELAGO, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_HIGH_PLAINS, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SANDSTORM, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_RIVER, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_MONSOON, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SAVANNA, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_SUN, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_OCEAN, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_JUNGLE, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_FANCY, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SCATTERBUG_POKE_BALL, gMonBackPic_Scatterbug),
    SPECIES_SPRITE(SPEWPA_ICY_SNOW, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_POLAR, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_TUNDRA, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_CONTINENTAL, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_GARDEN, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_ELEGANT, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MEADOW, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MODERN, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MARINE, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_ARCHIPELAGO, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_HIGH_PLAINS, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SANDSTORM, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_RIVER, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_MONSOON, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SAVANNA, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_SUN, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_OCEAN, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_JUNGLE, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_FANCY, gMonBackPic_Spewpa),
    SPECIES_SPRITE(SPEWPA_POKE_BALL, gMonBackPic_Spewpa),
    SPECIES_SPRITE(VIVILLON_ICY_SNOW, gMonBackPic_Vivillon),
    ...
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonBackPic_QuestionMark), //gMonBackPic_DecidueyeHisuian),
    ...
    SPECIES_SPRITE(WYRDEER, gMonBackPic_QuestionMark), //gMonBackPic_Wyrdeer),
    SPECIES_SPRITE(KLEAVOR, gMonBackPic_Kleavor),
    SPECIES_SPRITE(URSALUNA, gMonBackPic_Ursaluna),
    SPECIES_SPRITE(BASCULEGION, gMonBackPic_QuestionMark), //gMonBackPic_Basculegion),
    SPECIES_SPRITE(SNEASLER, gMonBackPic_QuestionMark), //gMonBackPic_Sneasler),
    SPECIES_SPRITE(OVERQWIL, gMonBackPic_Overqwil),
    SPECIES_SPRITE(ENAMORUS, gMonBackPic_QuestionMark), //gMonBackPic_Enamorus),
    SPECIES_SPRITE(ENAMORUS_THERIAN, gMonBackPic_QuestionMark), //gMonBackPic_EnamorusTherian),
#endif
