const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MEI, gMonShinyPalette_Mei),
    SPECIES_SHINY_PAL(ZUKO, gMonPalette_Zuko),
    SPECIES_SHINY_PAL(STINKY, gMonPalette_Stinky),
    SPECIES_SHINY_PAL(SOKKA, gMonPalette_Sokka),
    SPECIES_SHINY_PAL(IROH, gMonPalette_Iroh),
