...
{
    SPECIES_SHINY_PAL(NONE, gMonShinyPalette_QuestionMark),
    ...
    SPECIES_SHINY_PAL(CHERRIM_OVERCAST, gMonShinyPalette_Cherrim),
    SPECIES_SHINY_PAL(CHERRIM_SUNSHINE, gMonShinyPalette_CherrimSunshine),
    SPECIES_SHINY_PAL(SHELLOS_WEST_SEA, gMonShinyPalette_Shellos),
    ...
    SPECIES_SHINY_PAL(SAMUROTT_HISUIAN, gMonShinyPalette_QuestionMark), //gMonShinyPalette_SamurottHisuian),
    ...
    SPECIES_SHINY_PAL(SCATTERBUG_ICY_SNOW, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_POLAR, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_TUNDRA, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_CONTINENTAL, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_GARDEN, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_ELEGANT, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_MEADOW, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_MODERN, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_MARINE, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_ARCHIPELAGO, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_HIGH_PLAINS, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_SANDSTORM, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_RIVER, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_MONSOON, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_SAVANNA, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_SUN, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_OCEAN, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_JUNGLE, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_FANCY, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SCATTERBUG_POKE_BALL, gMonShinyPalette_Scatterbug),
    SPECIES_SHINY_PAL(SPEWPA_ICY_SNOW, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_POLAR, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_TUNDRA, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_CONTINENTAL, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_GARDEN, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_ELEGANT, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_MEADOW, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_MODERN, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_MARINE, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_ARCHIPELAGO, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_HIGH_PLAINS, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_SANDSTORM, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_RIVER, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_MONSOON, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_SAVANNA, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_SUN, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_OCEAN, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_JUNGLE, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_FANCY, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(SPEWPA_POKE_BALL, gMonShinyPalette_Spewpa),
    SPECIES_SHINY_PAL(VIVILLON_ICY_SNOW, gMonShinyPalette_Vivillon),
    ...
    SPECIES_SHINY_PAL(DECIDUEYE_HISUIAN, gMonShinyPalette_QuestionMark), //gMonShinyPalette_DecidueyeHisuian),
    ...
    SPECIES_SHINY_PAL(WYRDEER, gMonShinyPalette_QuestionMark), //gMonShinyPalette_Wyrdeer),
    SPECIES_SHINY_PAL(KLEAVOR, gMonShinyPalette_Kleavor),
    SPECIES_SHINY_PAL(URSALUNA, gMonShinyPalette_Ursaluna),
    SPECIES_SHINY_PAL(BASCULEGION, gMonShinyPalette_QuestionMark), //gMonShinyPalette_Basculegion),
    SPECIES_SHINY_PAL(SNEASLER, gMonShinyPalette_QuestionMark), //gMonShinyPalette_Sneasler),
    SPECIES_SHINY_PAL(OVERQWIL, gMonShinyPalette_Overqwil),
    SPECIES_SHINY_PAL(ENAMORUS, gMonShinyPalette_QuestionMark), //gMonShinyPalette_Enamorus),
    SPECIES_SHINY_PAL(ENAMORUS_THERIAN, gMonShinyPalette_QuestionMark), //gMonShinyPalette_EnamorusTherian),
#endif
...
#endif
#if P_GEN_8_POKEMON == TRUE
    SPECIES_SHINY_PAL(BASCULEGION, gMonShinyPalette_QuestionMark), // gMonShinyPalette_BasculegionF),
#endif
};
