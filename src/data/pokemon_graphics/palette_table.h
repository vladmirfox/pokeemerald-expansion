const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MEI, gMonPalette_Mei),
    SPECIES_PAL(ZUKO, gMonPalette_Zuko),
    SPECIES_PAL(STINKY, gMonPalette_Stinky),
    SPECIES_PAL(SOKKA, gMonPalette_Sokka),
    SPECIES_PAL(IROH, gMonPalette_Iroh),
