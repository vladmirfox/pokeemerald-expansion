...
{
    SPECIES_PAL(NONE, gMonPalette_QuestionMark),
    ...
    SPECIES_PAL(CHERRIM_OVERCAST, gMonPalette_Cherrim),
    SPECIES_PAL(CHERRIM_SUNSHINE, gMonPalette_CherrimSunshine),
    SPECIES_PAL(SHELLOS_WEST_SEA, gMonPalette_Shellos),
    ...
    SPECIES_PAL(SAMUROTT_HISUIAN, gMonPalette_QuestionMark), //gMonPalette_SamurottHisuian),
    ...
    SPECIES_PAL(SCATTERBUG_ICY_SNOW, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_POLAR, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_TUNDRA, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_CONTINENTAL, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_GARDEN, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_ELEGANT, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_MEADOW, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_MODERN, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_MARINE, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_ARCHIPELAGO, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_HIGH_PLAINS, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_SANDSTORM, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_RIVER, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_MONSOON, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_SAVANNA, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_SUN, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_OCEAN, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_JUNGLE, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_FANCY, gMonPalette_Scatterbug),
    SPECIES_PAL(SCATTERBUG_POKE_BALL, gMonPalette_Scatterbug),
    SPECIES_PAL(SPEWPA_ICY_SNOW, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_POLAR, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_TUNDRA, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_CONTINENTAL, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_GARDEN, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_ELEGANT, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_MEADOW, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_MODERN, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_MARINE, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_ARCHIPELAGO, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_HIGH_PLAINS, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_SANDSTORM, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_RIVER, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_MONSOON, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_SAVANNA, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_SUN, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_OCEAN, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_JUNGLE, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_FANCY, gMonPalette_Spewpa),
    SPECIES_PAL(SPEWPA_POKE_BALL, gMonPalette_Spewpa),
    SPECIES_PAL(VIVILLON_ICY_SNOW, gMonPalette_Vivillon),
    ...
    SPECIES_PAL(DECIDUEYE_HISUIAN, gMonPalette_QuestionMark), //gMonPalette_DecidueyeHisuian),
    ...
    SPECIES_PAL(WYRDEER, gMonPalette_QuestionMark), //gMonPalette_Wyrdeer),
    SPECIES_PAL(KLEAVOR, gMonPalette_Kleavor),
    SPECIES_PAL(URSALUNA, gMonPalette_Ursaluna),
    SPECIES_PAL(BASCULEGION, gMonPalette_QuestionMark), //gMonPalette_Basculegion),
    SPECIES_PAL(SNEASLER, gMonPalette_QuestionMark), //gMonPalette_Sneasler),
    SPECIES_PAL(OVERQWIL, gMonPalette_Overqwil),
    SPECIES_PAL(ENAMORUS, gMonPalette_QuestionMark), //gMonPalette_Enamorus),
    SPECIES_PAL(ENAMORUS_THERIAN, gMonPalette_QuestionMark), //gMonPalette_EnamorusTherian),
#endif
