...
static const union AnimCmd sAnim_DARMANITAN_GALARIAN_ZEN_MODE_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
#if P_GEN_5_POKEMON == TRUE
static const union AnimCmd *const sAnims_DARMANITAN_GALARIAN_ZEN_MODE[] =
{
    sAnim_GeneralFrame0,
    sAnim_DARMANITAN_GALARIAN_ZEN_MODE_1,
};
#endif
...
// Diamond and Pearl
    ...
    ANIM_CMD(FLOATZEL),
    ANIM_CMD(CHERUBI),
    ANIM_CMD_FULL(CHERRIM_OVERCAST, sAnims_CHERRIM),
    ANIM_CMD_FULL(CHERRIM_SUNSHINE, sAnims_CHERRIM),
    ANIM_CMD_FULL(SHELLOS_WEST_SEA, sAnims_SHELLOS),
...
// Black 2 and White 2
    ...
    ANIM_CMD(TALONFLAME),
    ANIM_CMD_FULL(SCATTERBUG_ICY_SNOW, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_POLAR, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_TUNDRA, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_CONTINENTAL, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_GARDEN, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_ELEGANT, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_MEADOW, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_MODERN, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_MARINE, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_ARCHIPELAGO, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_HIGH_PLAINS, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_SANDSTORM, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_RIVER, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_MONSOON, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_SAVANNA, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_SUN, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_OCEAN, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_JUNGLE, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_FANCY, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SCATTERBUG_POKE_BALL, sAnims_SCATTERBUG),
    ANIM_CMD_FULL(SPEWPA_ICY_SNOW, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_POLAR, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_TUNDRA, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_CONTINENTAL, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_GARDEN, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_ELEGANT, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_MEADOW, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_MODERN, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_MARINE, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_ARCHIPELAGO, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_HIGH_PLAINS, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_SANDSTORM, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_RIVER, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_MONSOON, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_SAVANNA, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_SUN, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_OCEAN, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_JUNGLE, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_FANCY, sAnims_SPEWPA),
    ANIM_CMD_FULL(SPEWPA_POKE_BALL, sAnims_SPEWPA),
    ANIM_CMD_FULL(VIVILLON_ICY_SNOW, sAnims_VIVILLON),
    ...
    ANIM_CMD(DARMANITAN_GALARIAN_ZEN_MODE),
#endif
#if P_GEN_6_POKEMON == TRUE
    ...
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_RUBY_CREAM, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_MATCHA_CREAM, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_MINT_CREAM, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_LEMON_CREAM, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_SALTED_CREAM, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_RUBY_SWIRL, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_CARAMEL_SWIRL, sAnims_ALCREMIE),
    ANIM_CMD_FULL(ALCREMIE_STRAWBERRY_RAINBOW_SWIRL, sAnims_ALCREMIE),
