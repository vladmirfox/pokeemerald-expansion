...
PLACEHOLDER_TWO_FRAME_ANIMATION(Stufful);
PLACEHOLDER_TWO_FRAME_ANIMATION(Bewear);
...
PLACEHOLDER_TWO_FRAME_ANIMATION(Rookidee);
PLACEHOLDER_TWO_FRAME_ANIMATION(Corvisquire);
PLACEHOLDER_TWO_FRAME_ANIMATION(Corviknight);
...
PLACEHOLDER_TWO_FRAME_ANIMATION(Chewtle);
PLACEHOLDER_TWO_FRAME_ANIMATION(Drednaw);
