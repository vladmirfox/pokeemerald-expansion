...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_MEI]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_SOKKA]                        = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_IROH]                         = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_ZUKO]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
