...
// EV Feathers
    ...
    [ITEM_HEALTH_FEATHER] =
    {
        ...
        .price = 300,
        .description = COMPOUND_STRING("An item that raises\n"
                                       "the base HP of\n"
                                       "a Pokémon."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
...
// X Items
    ...
    [ITEM_POKE_DOLL] =
    {
        .name = _("Poké Doll"),
        .price = 100,
        .description = COMPOUND_STRING("Use to flee from\n"
                                       "any battle with\n"
                                       "a wild Pokémon."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
...
// Treasures
    ...
    [ITEM_RED_SHARD] =
    {
        .name = _("Red Shard"),
        .price = 1000,
        .description = COMPOUND_STRING("A shard from an\n"
                                       "ancient item. Can\n"
                                       "be sold cheaply."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
...
// Evolution Items
    ...
    [ITEM_FIRE_STONE] =
    {
        .name = _("Fire Stone"),
        .price = 3000,
        .description = COMPOUND_STRING("Makes certain\n"
                                       "species of Pokémon\n"
                                       "evolve."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
...
// Nectars
    ...
    [ITEM_RED_NECTAR] =
    {
        ...
        .price = 300,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING("Flower nectar that\n"
                                       "changes the form\n"
                                       "of certain Pokémon."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
...
// Story Key Items
    ...
    [ITEM_KEY_TO_ROOM_1] =
    {
        ...
        .price = 0,
        .description = COMPOUND_STRING("A key that opens a\n"
                                       "door inside the\n"
                                       "Abandoned Ship."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
    ...
    [ITEM_BUG_TERA_SHARD] =
    {
        ...
        .price = 0,
        .description = COMPOUND_STRING("These shards may\n"
                                       "form when a Tera\n"
                                       "Pokémon faints."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
