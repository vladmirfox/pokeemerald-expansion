static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_KURA_TOWN - 1] = {MAP_GROUP(KURA_TOWN), MAP_NUM(KURA_TOWN), 33, 26},
    [HEAL_LOCATION_MAGURO_HARBOR - 1] = {MAP_GROUP(MAGURO_HARBOR), MAP_NUM(MAGURO_HARBOR), 9, 9},
    [HEAL_LOCATION_SILVERIDGE - 1] = {MAP_GROUP(SILVERIDGE), MAP_NUM(SILVERIDGE), 29, 20},
    [HEAL_LOCATION_WINDY_CAPE - 1] = {MAP_GROUP(WINDY_CAPE), MAP_NUM(WINDY_CAPE), 51, 36},
