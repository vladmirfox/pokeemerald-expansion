static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EVERTON_ISLAND - 1] = {MAP_GROUP(EVERTON_ISLAND), MAP_NUM(EVERTON_ISLAND), 21, 14},
    [HEAL_LOCATION_PLAYER_HOUSE2F - 1] = {MAP_GROUP(PLAYER_HOUSE2F), MAP_NUM(PLAYER_HOUSE2F), 3, 6},
};
