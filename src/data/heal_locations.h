static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MAGURO_HARBOR - 1] = {MAP_GROUP(MAGURO_HARBOR), MAP_NUM(MAGURO_HARBOR), 17, 9},
    ...
    [HEAL_LOCATION_HAVEN_ISLE - 1] = {MAP_GROUP(HAVEN_ISLE), MAP_NUM(HAVEN_ISLE), 39, 14},
