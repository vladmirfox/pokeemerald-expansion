static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CHECKPOINT2 - 1] = {MAP_GROUP(CHECKPOINT2), MAP_NUM(CHECKPOINT2), 5, 17},
    [HEAL_LOCATION_CHECKPOINT3 - 1] = {MAP_GROUP(CHECKPOINT3), MAP_NUM(CHECKPOINT3), 10, 9},
    [HEAL_LOCATION_CHECKPOINT4 - 1] = {MAP_GROUP(CHECKPOINT4), MAP_NUM(CHECKPOINT4), 12, 24},
    [HEAL_LOCATION_CHECKPOINT5 - 1] = {MAP_GROUP(CHECKPOINT5), MAP_NUM(CHECKPOINT5), 9, 10},
    [HEAL_LOCATION_CHECKPOINT6 - 1] = {MAP_GROUP(CHECKPOINT6), MAP_NUM(CHECKPOINT6), 18, 19},
};
