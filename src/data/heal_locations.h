static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MAGURO_HARBOR - 1] = {MAP_GROUP(MAGURO_HARBOR), MAP_NUM(MAGURO_HARBOR), 24, 9},
    ...
    [HEAL_LOCATION_YIFU_CITY2 - 1] = {MAP_GROUP(YIFU_CITY2), MAP_NUM(YIFU_CITY2), 36, 33},
};
