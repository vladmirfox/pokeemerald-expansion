static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SAKU_TOWN - 1] = {MAP_GROUP(SAKU_TOWN), MAP_NUM(SAKU_TOWN), 37, 19},
    [HEAL_LOCATION_KURA_TOWN - 1] = {MAP_GROUP(KURA_TOWN), MAP_NUM(KURA_TOWN), 33, 26},
    [HEAL_LOCATION_MAGURO_HARBOR - 1] = {MAP_GROUP(MAGURO_HARBOR), MAP_NUM(MAGURO_HARBOR), 10, 15},
