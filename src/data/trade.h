...
static const struct InGameTrade sIngameTrades[] =
{
    [INGAME_TRADE_SEEDOT] =
    {
        ...
        .ivs = {20, 12, 12, 31, 20, 20},
        .abilityNum = 1,
        .otId = 38726,
        .conditions = {5, 30, 5, 5, 5}, // Beauty
        .personality = 0x84,
    ...
    [INGAME_TRADE_PLUSLE] =
    {
        ...
        .ivs = {12, 12, 20, 31, 12, 31},
        .abilityNum = 0,
        .otId = 73996,
        .conditions = {5, 5, 30, 5, 5}, // Cute
        .personality = 0x6F,
    ...
    [INGAME_TRADE_HORSEA] =
    {
        ...
        .ivs = {20, 31, 12, 31, 12, 20},
        .abilityNum = 0,
        .otId = 46285,
        .conditions = {5, 5, 5, 5, 30}, // Tough
        .personality = 0x7F,
    ...
    [INGAME_TRADE_MEOWTH] =
    {
        ...
        .ivs = {20, 31, 20, 12, 12, 20},
        .abilityNum = 0,
        .otId = 91481,
        .conditions = {5, 5, 5, 30, 5}, // Smart
        .personality = 0x8B,
    ...
    [INGAME_TRADE_BELLSPROUT] =
    {
        ...
        .ivs = {31, 12, 20, 31, 20, 12},
        .abilityNum = 0,
        .otId = 91673,
        .conditions = {5, 5, 5, 30, 5}, // Smart
        .personality = 0x8B,
        .heldItem = ITEM_YELLOW_APRICORN,
        .mailNum = -1,
        .otName = _("Chow"),
        .otGender = MALE,
        .sheen = 10,
        ...
        [INGAME_TRADE_APPLIN] =
    {
        ...
        .ivs = {20, 31, 31, 12, 12, 20},
        .abilityNum = 2,
        .otId = 31643,
        .conditions = {30, 5, 5, 5, 5}, // Cool
        .personality = 0x7F,
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_MUNCHLAX
    }
};
