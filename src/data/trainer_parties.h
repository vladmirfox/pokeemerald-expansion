...
static const struct TrainerMon sParty_Archie[] = {
    ...
    .species = SPECIES_SHARPEDO,
    .moves = {MOVE_EARTHQUAKE, MOVE_FRUSTRATION, MOVE_BITE, MOVE_ENDURE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 50,
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_STONE_EDGE, MOVE_AQUA_JET, MOVE_SHELL_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 48,
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_ICE_BEAM, MOVE_THUNDERBOLT}
    },
};
...
static const struct TrainerMon sParty_GabbyAndTy6[] = {
    ...
    .moves = {MOVE_FIRE_BLAST, MOVE_ASTONISH, MOVE_SUPERSONIC, MOVE_HYPER_VOICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_WISH, MOVE_PROTECT, MOVE_DOUBLE_EDGE}
    }
};
...
static const struct TrainerMon sParty_Randall[] = {
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_AGILITY, MOVE_AIR_SLASH, MOVE_PURSUIT}
    }
};
...
static const struct TrainerMon sParty_Mary[] = {
    ...
    .moves = {MOVE_FEINT_ATTACK, MOVE_SHOCK_WAVE, MOVE_MUD_SLAP, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Alexia[] = {
    ...
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_PLAY_ROUGH}
    }
};
...
static const struct TrainerMon sParty_Jody[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_QUICK_ATTACK, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_BLACK_GLASSES,
    .moves = {MOVE_ROAR, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    ...
    .moves = {MOVE_TORMENT, MOVE_DOUBLE_TEAM, MOVE_SWAGGER, MOVE_DARK_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 150, 0, 150, 0, 0),
    ...
    .moves = {MOVE_WATERFALL, MOVE_SUPERPOWER, MOVE_CRUNCH, MOVE_CRABHAMMER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .ev = TRAINER_PARTY_EVS(0, 150, 0, 150, 0, 0),
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT}
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHADOW_CLAW, MOVE_TRICK_ROOM, MOVE_DESTINY_BOND, MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(150, 0, 75, 75, 0, 0),
    .lvl = 55,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_DOUBLE_TEAM, MOVE_NIGHT_SHADE, MOVE_HEX}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 150, 150, 0),
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_NIGHT_SHADE, MOVE_FEINT_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PROTECT, MOVE_WOOD_HAMMER, MOVE_LEECH_SEED, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 150, 150, 0),
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SPIKES, MOVE_ICY_WIND, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(150, 0, 0, 150, 0, 0),
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SURF, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_PERISH_SONG, MOVE_AERIAL_ACE, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 150, 0, 150, 0, 0),
    ...
    .moves = {MOVE_OUTRAGE, MOVE_DRAGON_DANCE, MOVE_FIRE_PUNCH, MOVE_EXTREME_SPEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 150, 150, 0),
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_SURF, MOVE_ICE_BEAM, MOVE_BODY_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 150, 0, 150, 0, 0),
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TACKLE, MOVE_PROTECT, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_PROTECT, MOVE_BITE, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 16,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_KARATE_CHOP, MOVE_ROLLING_KICK, MOVE_DYNAMIC_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_LIGHT_SCREEN, MOVE_REVERSAL, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BULLET_PUNCH, MOVE_REVERSAL, MOVE_FEINT, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 20,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SUPERSONIC, MOVE_SHOCK_WAVE, MOVE_THUNDER_SHOCK, MOVE_SONIC_BOOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_STORM, MOVE_ASTONISH, MOVE_SHOCK_WAVE, MOVE_THUNDER_SHOCK}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_WILD_CHARGE, MOVE_QUICK_ATTACK, MOVE_FLAME_CHARGE, MOVE_MORNING_SUN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 34,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 36,
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .moves = {MOVE_DOUBLE_EDGE, MOVE_U_TURN, MOVE_FACADE, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 36,
    ...
    .moves = {MOVE_SLASH, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_SEED_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 38,
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROOST, MOVE_PLUCK, MOVE_TOXIC, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_SURF, MOVE_REST, MOVE_SLEEP_TALK, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 39,
    ...
    .moves = {MOVE_SPIKES, MOVE_WHIRLWIND, MOVE_TAUNT, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    ...
    .moves = {MOVE_FIRE_BLAST, MOVE_DRAGON_BREATH, MOVE_REST, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 38,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_STEALTH_ROCK, MOVE_PROTECT, MOVE_AERIAL_ACE}
    },
};
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_XATU,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_PSYCHIC, MOVE_SUNNY_DAY, MOVE_WISH, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_POWER_GEM, MOVE_PSYCHIC, MOVE_EARTH_POWER, MOVE_ROCK_POLISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_MORNING_SUN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    ...
    .moves = {MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_FUTURE_SIGHT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 49,
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_DRAGON_DANCE, MOVE_OUTRAGE, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 48,
    ...
    .moves = {MOVE_REST, MOVE_BODY_SLAM, MOVE_AURORA_BEAM, MOVE_WATER_PULSE}
    },
};
...
static const struct TrainerMon sParty_Victor[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_NONE, MOVE_NONE, MOVE_NONE} //reference to anime
    }
};
...
static const struct TrainerMon sParty_Isabel1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SPARK, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_HELPING_HAND}
    },
    {
    .lvl = 16,
...
static const struct TrainerMon sParty_Quincy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_WAILORD,
    .moves = {MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_HYDRO_PUMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 43,
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_ICE_BEAM, MOVE_SURF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .ev = TRAINER_PARTY_EVS(150, 0, 0, 150, 0, 0),
...
//switch to use self destruct sometime
...
static const struct TrainerMon sParty_AmyAndLiv1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_ELECTRO_BALL, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_HELPING_HAND}
    },
    {
    .lvl = 17,
    .species = SPECIES_MINUN,
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_GIGA_DRAIN}
    },
};
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_PURSUIT, MOVE_FURY_CUTTER, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 19,
    .species = SPECIES_DUSTOX,
    .moves = {MOVE_STRUGGLE_BUG, MOVE_VENOSHOCK, MOVE_STRING_SHOT, MOVE_MOONLIGHT}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Treecko[] = {
    ...
    .lvl = 19,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_AERIAL_ACE, MOVE_BUG_BUZZ, MOVE_AGILITY, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Torchic[] = {
    ...
    .lvl = 19,
    .species = SPECIES_VIGOROTH,
    .moves = {MOVE_UPROAR, MOVE_REVERSAL, MOVE_FURY_SWIPES, MOVE_ENDURE}
    }
};
...
static const struct TrainerMon sParty_MayRoute110Mudkip[] = {
    ...
    .lvl = 19,
    .species = SPECIES_SKITTY,
    .moves = {MOVE_FAKE_OUT, MOVE_SUCKER_PUNCH, MOVE_HEAL_BELL, MOVE_THUNDER_WAVE},
    }
};
...
static const struct TrainerMon sParty_LeaAndJed[] = {
    ...
    .lvl = 52,
    .species = SPECIES_LUVDISC,
    .moves = {MOVE_CHARM, MOVE_SURF, MOVE_ICE_BEAM, MOVE_TOXIC},
    .heldItem = ITEM_MYSTIC_WATER
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .lvl = 29,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_BULLDOZE, MOVE_ATTRACT}
    },
};
