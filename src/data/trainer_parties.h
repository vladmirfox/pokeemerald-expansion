...
static const struct TrainerMon sParty_Felix[] = {
    ...
    .moves = {MOVE_PROTECT, MOVE_THUNDERBOLT, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 43,
...
static const struct TrainerMon sParty_Ricky1[] = {
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_BITE, MOVE_TAIL_WHIP, MOVE_PLAY_NICE}
    }
};
...
static const struct TrainerMon sParty_Ricky2[] = {
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_BITE, MOVE_TAIL_WHIP, MOVE_FAIRY_WIND}
    }
};
...
static const struct TrainerMon sParty_Ricky3[] = {
    ...
    .lvl = 30,
    .species = SPECIES_DACHSBUN,
    .moves = {MOVE_SAND_ATTACK, MOVE_CRUNCH, MOVE_TAIL_WHIP, MOVE_DAZZLING_GLEAM}
    }
};
...
static const struct TrainerMon sParty_Ricky5[] = {
    ...
    .lvl = 36,
    .species = SPECIES_DACHSBUN,
    .moves = {MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_THUNDER_FANG, MOVE_PLAY_ROUGH}
    }
};
...
static const struct TrainerMon sParty_George[] = {
    ...
    .moves = {MOVE_SLACK_OFF, MOVE_TEETER_DANCE, MOVE_SHADOW_BALL, MOVE_DIZZY_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SEADRA,
    .moves = {MOVE_BRINE, MOVE_DRAGON_PULSE, MOVE_DOUBLE_TEAM, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMon sParty_Wendy[] = {
    ...
    .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_BRICK_BREAK, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 29,
    ...
    .moves = {MOVE_BLIZZARD, MOVE_HAIL, MOVE_PSYSHOCK, MOVE_DRAINING_KISS}
    }
};
...
static const struct TrainerMon sParty_Jessica1[] = {
    ...
    .moves = {MOVE_SILVER_WIND, MOVE_GIGA_DRAIN, MOVE_PROTECT, MOVE_TOXIC}
    }
};
...
static const struct TrainerMon sParty_Olivia[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_WATERFALL, MOVE_AQUA_RING, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 39,
    .species = SPECIES_GOREBYSS,
    .moves = {MOVE_BRINE, MOVE_DAZZLING_GLEAM, MOVE_AQUA_RING, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Jessica2[] = {
    ...
    .lvl = 35,
    .species = SPECIES_VIVILLON_POKE_BALL,
    .moves = {MOVE_SILVER_WIND, MOVE_GIGA_DRAIN, MOVE_AIR_SLASH, MOVE_TOXIC}
    }
};
...
static const struct TrainerMon sParty_Winston5[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_POISON_FANG, MOVE_DIG, MOVE_CRUNCH, MOVE_ROAR}
    }
};
...
static const struct TrainerMon sParty_Drew[] = {
    ...
    .moves = {MOVE_PIN_MISSILE, MOVE_SAND_ATTACK, MOVE_MEGA_DRAIN, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_BITE, MOVE_MUD_SLAP, MOVE_FIRE_FANG, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OBSTRUCT, MOVE_DOUBLE_EDGE, MOVE_SUCKER_PUNCH, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TORMENT, MOVE_NIGHT_DAZE, MOVE_FLAMETHROWER, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 46,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DARK_PULSE, MOVE_HEAT_WAVE, MOVE_NASTY_PLOT, MOVE_AIR_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIQUIDATION, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_FACADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITTER_MALICE, MOVE_HYPER_VOICE, MOVE_PROTECT, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_SLUDGE_WAVE, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_SUCKER_PUNCH, MOVE_DOUBLE_TEAM, MOVE_FEINT_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_SWORDS_DANCE, MOVE_PLAY_ROUGH, MOVE_FACADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_DUSKNOIR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .species = SPECIES_SANDSLASH_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GYRO_BALL, MOVE_ICE_PUNCH, MOVE_SLASH, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .moves = {MOVE_ICE_BEAM, MOVE_REST, MOVE_SURF, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHED_TAIL, MOVE_EXTREME_SPEED, MOVE_DRAGON_CLAW, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_DRAGON_CLAW, MOVE_BRICK_BREAK, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMOKESCREEN, MOVE_ICE_BEAM, MOVE_SURF, MOVE_DRAGON_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .species = SPECIES_SNEASEL_HISUIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_PUNCH, MOVE_LOW_KICK, MOVE_SEISMIC_TOSS, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ARM_THRUST, MOVE_FIRE_PUNCH, MOVE_REVERSAL, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_SPARK, MOVE_DEFENSE_CURL, MOVE_SHOCK_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 20,
    .species = SPECIES_CHINCHOU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_FLASH, MOVE_WATER_GUN, MOVE_THUNDER_WAVE}
    },
    {
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_TAKE_DOWN, MOVE_ROCK_THROW, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 24,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_BULLDOZE, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 29,
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_DAZZLING_GLEAM, MOVE_FACADE, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 27,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_FACADE, MOVE_PROTECT, MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 29,
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEEL_WING, MOVE_MIRROR_MOVE, MOVE_SAFEGUARD, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_AERIAL_ACE, MOVE_FLAME_CHARGE, MOVE_DEFOG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLY, MOVE_FOUL_PLAY, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYSHOCK, MOVE_POWER_GEM, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 41,
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_LIQUIDATION, MOVE_SLASH, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 41,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_AMNESIA, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_WATER_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 43,
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_DOUBLE_TEAM, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMon sParty_KateAndJoy[] = {
    ...
    .lvl = 30,
    .species = SPECIES_VIGOROTH,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_SHADOW_CLAW, MOVE_SLACK_OFF, MOVE_FEINT_ATTACK}
    },
    {
    .lvl = 32,
    .species = SPECIES_BLISSEY,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_TOXIC, MOVE_PROTECT, MOVE_SOFT_BOILED}
    }
};
...
static const struct TrainerMon sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ZIGZAGOON_GALARIAN,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_AnnaAndMeg3[] = {
    ...
    .lvl = 33,
    .species = SPECIES_LINOONE_GALARIAN,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_AnnaAndMeg5[] = {
    ...
    .lvl = 38,
    .species = SPECIES_OBSTAGOON,
    .moves = {MOVE_OBSTRUCT, MOVE_HEADBUTT, MOVE_CRUNCH, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Vicky[] = {
    ...
    .lvl = 18,
    .species = SPECIES_SNEASEL_HISUIAN,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_POISON_JAB, MOVE_HONE_CLAWS, MOVE_DETECT}
    }
};
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ZIGZAGOON_GALARIAN,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_GROWL, MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 17,
    .species = SPECIES_MAGNEMITE,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGNET_BOMB, MOVE_MAGNET_RISE, MOVE_SCREECH}
    }
};
...
static const struct TrainerMon sParty_Katelynn[] = {
    ...
    .moves = {MOVE_SKILL_SWAP, MOVE_SPIKY_SHIELD, MOVE_NEEDLE_ARM, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 43,
    .species = SPECIES_NOIVERN,
    .moves = {MOVE_BOOMBURST, MOVE_DRAGON_PULSE, MOVE_SHADOW_BALL, MOVE_AIR_SLASH}
    }
};
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AQUA_RING, MOVE_LEECH_LIFE, MOVE_LIQUIDATION, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_BANEFUL_BUNKER, MOVE_VENOSHOCK, MOVE_SURF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTH_POWER, MOVE_SURF, MOVE_AMNESIA, MOVE_HYPER_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_OUTRAGE, MOVE_LIQUIDATION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .moves = {MOVE_RECOVER, MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_AQUA_RING}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
...
static const struct TrainerMon sParty_Dianne[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_PROTECT, MOVE_LEECH_LIFE}
    },
    {
    .lvl = 17,
    .species = SPECIES_SHEDINJA,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_BUG_BITE, MOVE_PROTECT, MOVE_TOXIC}
    },
    {
    .lvl = 17,
    .species = SPECIES_KOFFING,
...
static const struct TrainerMon sParty_Lao3[] = {
    ...
    .lvl = 27,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_SLASH, MOVE_LEECH_LIFE}
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 27,
...
static const struct TrainerMon sParty_Lao4[] = {
    ...
    .lvl = 30,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_SLASH, MOVE_BUG_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 30,
    ...
    .moves = {MOVE_POISON_GAS, MOVE_SLUDGE, MOVE_TACKLE, MOVE_FAIRY_WIND}
    }
};
...
static const struct TrainerMon sParty_Lao5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_GAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_DOUBLE_HIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 33,
    ...
    .moves = {MOVE_TACKLE, MOVE_SLUDGE, MOVE_FAIRY_WIND, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .lvl = 45,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_BRICK_BREAK, MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_SLASH}
    }
};
...
static const struct TrainerMon sParty_Athena[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FALSE_SURRENDER, MOVE_SUCKER_PUNCH, MOVE_PLAY_ROUGH, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_VIBRAVA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH, MOVE_DRAGON_CLAW, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .lvl = 17,
    .species = SPECIES_MAGNEMITE,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGNET_BOMB, MOVE_MAGNET_RISE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    .species = SPECIES_KLINK,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_SHIFT_GEAR, MOVE_MAGNET_RISE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Hideo[] = {
    ...
    .moves = {MOVE_MUD_SLAP, MOVE_POISON_GAS, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMon sParty_WallyVR2[] = {
    ...
    .moves = {MOVE_DOUBLE_SHOCK, MOVE_NUZZLE, MOVE_PROTECT, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 46,
    .species = SPECIES_MIMIKYU,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 47,
    .species = SPECIES_PURUGLY,
    .moves = {MOVE_FAKE_OUT, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_FEINT_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 44,
    .species = SPECIES_BELLOSSOM,
    .moves = {MOVE_TOXIC, MOVE_TEETER_DANCE, MOVE_PETAL_DANCE, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_PSYCHO_CUT, MOVE_NIGHT_SLASH, MOVE_LEAF_BLADE}
    }
};
...
static const struct TrainerMon sParty_WallyVR3[] = {
    ...
    .lvl = 49,
    .species = SPECIES_PURUGLY,
    .moves = {MOVE_FAKE_OUT, MOVE_SLASH, MOVE_SCREECH, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 50,
    .species = SPECIES_PAWMOT,
    .moves = {MOVE_REVIVAL_BLESSING, MOVE_NUZZLE, MOVE_ICE_PUNCH, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 47,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_SPIKES, MOVE_STEEL_WING, MOVE_WING_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_PSYCHO_CUT, MOVE_DRAIN_PUNCH, MOVE_LEAF_BLADE, MOVE_SHADOW_SNEAK}
    }
};
...
static const struct TrainerMon sParty_WallyVR4[] = {
    ...
    .lvl = 53,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_STEEL_WING, MOVE_FLY}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 52,
    .species = SPECIES_MIMIKYU,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SHADOW_SNEAK, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 53,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_EARTHQUAKE, MOVE_ICE_FANG, MOVE_ROLLOUT, MOVE_DEFENSE_CURL}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 50,
    ...
    .lvl = 54,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_PSYCHO_CUT, MOVE_SWORDS_DANCE, MOVE_DRAIN_PUNCH, MOVE_LEAF_BLADE}
    }
};
...
static const struct TrainerMon sParty_WallyVR5[] = {
    ...
    .lvl = 56,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_TOXIC_SPIKES, MOVE_STEEL_WING}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 55,
    .species = SPECIES_PAWMOT,
    .moves = {MOVE_REVIVAL_BLESSING, MOVE_DRAIN_PUNCH, MOVE_NUZZLE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 56,
    .species = SPECIES_MIMIKYU,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SHADOW_SNEAK, MOVE_PLAY_ROUGH, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 53,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_EARTHQUAKE, MOVE_ICE_FANG, MOVE_GYRO_BALL, MOVE_ROLLOUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 53,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_BELLY_DRUM, MOVE_LIQUIDATION, MOVE_PLAY_ROUGH, MOVE_AQUA_RING}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 57,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_DRAIN_PUNCH, MOVE_PSYCHO_CUT, MOVE_LEAF_BLADE}
    }
};
...
static const struct TrainerMon sParty_MelAndPaul[] = {
    ...
    .lvl = 27,
    .species = SPECIES_CORSOLA,
    .moves = {MOVE_ROCK_THROW, MOVE_WATER_PULSE, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .lvl = 27,
    .species = SPECIES_CORSOLA_GALARIAN,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_WATER_PULSE, MOVE_TOXIC, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ROLLOUT, MOVE_THUNDER_PUNCH, MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH, MOVE_ACCELEROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    .species = SPECIES_MINIOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_STEALTH_ROCK, MOVE_DAZZLING_GLEAM, MOVE_IRON_HEAD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MAGNET_RISE, MOVE_MAGNET_BOMB, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Roxanne3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLY, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ROLLOUT, MOVE_MAGNITUDE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .species = SPECIES_LYCANROC_MIDDAY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ACCELEROCK, MOVE_SUCKER_PUNCH, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .species = SPECIES_MINIOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_IRON_HEAD, MOVE_DAZZLING_GLEAM, MOVE_STEALTH_ROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MAGNET_RISE, MOVE_MAGNET_BOMB, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    }
};
...
static const struct TrainerMon sParty_Roxanne4[] = {
    ...
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_THUNDER_PUNCH, MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    ...
    .species = SPECIES_MINIOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_HEAD, MOVE_SHELL_SMASH, MOVE_DAZZLING_GLEAM, MOVE_STONE_EDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MAGNET_RISE, MOVE_IRON_HEAD, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Roxanne5[] = {
    ...
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_PROTECT, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .species = SPECIES_LYCANROC_MIDDAY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ACCELEROCK, MOVE_ICE_FANG, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    .species = SPECIES_MINIOR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SHELL_SMASH, MOVE_EXPLOSION, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIAMOND_STORM, MOVE_PROTECT, MOVE_EARTH_POWER, MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PROTECT, MOVE_IRON_HEAD, MOVE_STONE_EDGE, MOVE_ICE_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Brawly2[] = {
    ...
    .species = SPECIES_SNEASLER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POISON_JAB, MOVE_DRAIN_PUNCH, MOVE_NIGHT_SLASH, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NUZZLE, MOVE_BRICK_BREAK, MOVE_PROTECT, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_DRAIN_PUNCH, MOVE_BELLY_DRUM, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_THRASH, MOVE_PAIN_SPLIT, MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_SNEASLER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DIRE_CLAW, MOVE_DRAIN_PUNCH, MOVE_NIGHT_SLASH, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_PAWMOT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NUZZLE, MOVE_COUNTER, MOVE_PROTECT, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
...
static const struct TrainerMon sParty_Brawly5[] = {
    ...
    .species = SPECIES_BEWEAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_THRASH, MOVE_SHADOW_CLAW, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_SNEASLER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIRE_CLAW, MOVE_DRAIN_PUNCH, MOVE_NIGHT_SLASH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .species = SPECIES_PAWMOT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_SHOCK, MOVE_DRAIN_PUNCH, MOVE_PROTECT, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPECTRAL_THIEF, MOVE_FIRE_PUNCH, MOVE_SHADOW_SNEAK, MOVE_SKY_UPPERCUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
...
static const struct TrainerMon sParty_Wattson2[] = {
    ...
    .species = SPECIES_TOGEDEMARU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_THUNDER_WAVE, MOVE_SPIKY_SHIELD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_WATER_PULSE, MOVE_AQUA_RING}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLASH_CANNON, MOVE_MAGNET_RISE, MOVE_THUNDERBOLT, MOVE_METAL_SOUND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_ROAR, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Wattson3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTROWEB, MOVE_BUG_BUZZ, MOVE_NUZZLE, MOVE_GASTRO_ACID}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .species = SPECIES_TOGEDEMARU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MAGNET_RISE, MOVE_GRASS_KNOT, MOVE_SPIKY_SHIELD, MOVE_CHARGE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_HYDRO_PUMP, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLASH_CANNON, MOVE_PROTECT, MOVE_THUNDER, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_THUNDER_WAVE, MOVE_CHARGE_BEAM, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Wattson4[] = {
    ...
    .species = SPECIES_GALVANTULA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CHARGE_BEAM, MOVE_BUG_BUZZ, MOVE_PROTECT, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_TOGEDEMARU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GRASS_KNOT, MOVE_SPIKY_SHIELD, MOVE_FLASH_CANNON, MOVE_CHARGE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_HYDRO_PUMP, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SNARL, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Wattson5[] = {
    ...
    .species = SPECIES_TOGEDEMARU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GRASS_KNOT, MOVE_SPIKY_SHIELD, MOVE_CHARGE_BEAM, MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_GALVANTULA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_BUG_BUZZ, MOVE_RAIN_DANCE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_PROTECT, MOVE_SIGNAL_BEAM, MOVE_HYDRO_PUMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_MAGNEZONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLASH_CANNON, MOVE_THUNDER, MOVE_PROTECT, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_VOLT_SWITCH, MOVE_HURRICANE, MOVE_THUNDER, MOVE_FOCUS_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SNARL, MOVE_FLAMETHROWER, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_THUNDER_FANG, MOVE_ROCK_SLIDE, MOVE_HOWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .species = SPECIES_ARMAROUGE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ARMOR_CANNON, MOVE_PSYSHOCK, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLARE_BLITZ, MOVE_EARTHQUAKE, MOVE_ATTRACT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_PROTECT, MOVE_RAPID_SPIN}
    }
};
...
static const struct TrainerMon sParty_Flannery3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GASTRO_ACID, MOVE_FLAMETHROWER, MOVE_TOXIC, MOVE_VENOSHOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_ARCANINE_HISUIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_WILD_CHARGE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_YAWN, MOVE_EARTHQUAKE, MOVE_BLOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_RAPID_SPIN, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Flannery4[] = {
    ...
    .species = SPECIES_SALAZZLE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_FLAMETHROWER, MOVE_VENOSHOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_ARCANINE_HISUIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_HEAD_SMASH, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .species = SPECIES_ARMAROUGE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ARMOR_CANNON, MOVE_SOLAR_BEAM, MOVE_PSYSHOCK, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_FLARE_BLITZ, MOVE_BLOCK, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_HAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_PROTECT, MOVE_SHELL_SMASH}
    }
};
...
static const struct TrainerMon sParty_Flannery5[] = {
    ...
    .species = SPECIES_SALAZZLE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_FIRE_BLAST, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_ARCANINE_HISUIAN,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_HEAD_SMASH, MOVE_EXTREME_SPEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_ARMAROUGE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ARMOR_CANNON, MOVE_SOLAR_BEAM, MOVE_PSYSHOCK, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_EARTH_POWER, MOVE_SOLAR_BEAM, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_VOLCANION,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEAM_ERUPTION, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_HAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_SHELL_SMASH}
    }
};
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_SING, MOVE_HYPER_VOICE, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .species = SPECIES_RUFFLET,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WING_ATTACK, MOVE_STEEL_WING, MOVE_DOUBLE_EDGE, MOVE_WHIRLWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_LINOONE_GALARIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAUNT, MOVE_OBSTRUCT, MOVE_FACADE, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_IMPACT, MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_SHADOW_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Norman3[] = {
    ...
    .species = SPECIES_OBSTAGOON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TAUNT, MOVE_OBSTRUCT, MOVE_DOUBLE_EDGE, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_SING, MOVE_FLAMETHROWER, MOVE_MOONBLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .species = SPECIES_RUFFLET,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_STEEL_WING, MOVE_FACADE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SKILL_SWAP, MOVE_DAZZLING_GLEAM, MOVE_HYPNOSIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_IMPACT, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Norman4[] = {
    ...
    .species = SPECIES_INDEEDEE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SKILL_SWAP, MOVE_HYPNOSIS, MOVE_DAZZLING_GLEAM, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
    .species = SPECIES_OBSTAGOON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAUNT, MOVE_OBSTRUCT, MOVE_GIGA_IMPACT, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_FLY, MOVE_CLOSE_COMBAT, MOVE_STEEL_WING}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_HYPER_VOICE, MOVE_MOONBLAST, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Norman5[] = {
    ...
    .species = SPECIES_BRAVIARY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLY, MOVE_DOUBLE_EDGE, MOVE_STEEL_WING, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_MOONBLAST, MOVE_FLAMETHROWER, MOVE_HYPER_VOICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    .species = SPECIES_INDEEDEE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEAL_PULSE, MOVE_SKILL_SWAP, MOVE_DAZZLING_GLEAM, MOVE_FOLLOW_ME}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUSH_GRIP, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE, MOVE_IRON_HEAD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Winona2[] = {
    ...
    .species = SPECIES_FLETCHINDER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAME_CHARGE, MOVE_WING_ATTACK, MOVE_PROTECT, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    .species = SPECIES_CORVIKNIGHT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_HEAD, MOVE_U_TURN, MOVE_DRILL_PECK, MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    ...
    .species = SPECIES_BOMBIRDIER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_WING_ATTACK, MOVE_TAILWIND, MOVE_STEALTH_ROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
...
static const struct TrainerMon sParty_Winona3[] = {
    ...
    .species = SPECIES_TALONFLAME,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAILWIND, MOVE_FLAME_CHARGE, MOVE_FLY, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_CORVIKNIGHT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_HEAD, MOVE_FLY, MOVE_U_TURN, MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_BOMBIRDIER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLY, MOVE_KNOCK_OFF, MOVE_STEALTH_ROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_AIR_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HURRICANE, MOVE_FOCUS_BLAST, MOVE_SLUDGE_BOMB, MOVE_ICY_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
...
static const struct TrainerMon sParty_Winona4[] = {
    ...
    .species = SPECIES_TALONFLAME,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAILWIND, MOVE_AERIAL_ACE, MOVE_FLARE_BLITZ, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    ...
    .species = SPECIES_BOMBIRDIER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STONE_EDGE, MOVE_KNOCK_OFF, MOVE_STEALTH_ROCK, MOVE_WING_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    ...
    .species = SPECIES_TORNADUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLEAKWIND_STORM, MOVE_HEAT_WAVE, MOVE_FOCUS_BLAST, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Winona5[] = {
    ...
    .species = SPECIES_TALONFLAME,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_ROOST, MOVE_WING_ATTACK, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 54,
    .species = SPECIES_CORVIKNIGHT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_HEAD, MOVE_DRILL_PECK, MOVE_U_TURN, MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    ...
    .species = SPECIES_BOMBIRDIER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STONE_EDGE, MOVE_KNOCK_OFF, MOVE_WING_ATTACK, MOVE_DRILL_RUN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .moves = {MOVE_SKY_ATTACK, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_SHADOW_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYSHOCK, MOVE_SLACK_OFF, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_IRON_HEAD, MOVE_REST, MOVE_SHADOW_CLAW, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
...
static const struct TrainerMon sParty_TateAndLiza3[] = {
    ...
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYSHOCK, MOVE_CALM_MIND, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_SLOWBRO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_SLACK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 54,
    .species = SPECIES_SOLGALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_HEAD, MOVE_ZEN_HEADBUTT, MOVE_SHADOW_CLAW, MOVE_ROAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_CALM_MIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTH_POWER, MOVE_PSYCHIC, MOVE_REST, MOVE_CALM_MIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_PSYSHOCK, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza4[] = {
    ...
    .species = SPECIES_SLOWBRO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SLACK_OFF, MOVE_PSYCHIC, MOVE_SHELL_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    .species = SPECIES_SOLGALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNSTEEL_STRIKE, MOVE_ZEN_HEADBUTT, MOVE_SHADOW_CLAW, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .species = SPECIES_LUNALA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_MOONBLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
...
static const struct TrainerMon sParty_TateAndLiza5[] = {
    ...
    .species = SPECIES_SLOWBRO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SLACK_OFF, MOVE_PSYCHIC, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 63,
...
static const struct TrainerMon sParty_Juan2[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .species = SPECIES_SAMUROTT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AQUA_JET, MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_CRABHAMMER, MOVE_TAUNT, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMon sParty_Juan3[] = {
    ...
    .species = SPECIES_GOLISOPOD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_LIQUIDATION, MOVE_BRICK_BREAK, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_REST, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_SAMUROTT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_AQUA_JET, MOVE_NIGHT_SLASH, MOVE_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRABHAMMER, MOVE_GUILLOTINE, MOVE_TAUNT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OCTAZOOKA, MOVE_SMOKESCREEN, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMon sParty_Juan4[] = {
    ...
    .species = SPECIES_GOLISOPOD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_AQUA_JET, MOVE_KNOCK_OFF, MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_HYDRO_PUMP, MOVE_PROTECT, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    .species = SPECIES_SAMUROTT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_RAZOR_SHELL, MOVE_NIGHT_SLASH, MOVE_MEGAHORN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SACRED_SWORD, MOVE_AQUA_JET, MOVE_TRAILBLAZE, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_DOUBLE_TEAM, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMon sParty_Juan5[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SECRET_SWORD, MOVE_AQUA_JET, MOVE_BRICK_BREAK, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
...
static const struct TrainerMon sParty_Steven[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKY_SHIELD, MOVE_SPIKES, MOVE_IRON_DEFENSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYSHOCK, MOVE_TOXIC, MOVE_PROTECT, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .moves = {MOVE_LIQUIDATION, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_STONE_EDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .moves = {MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_MAGNET_RISE, MOVE_HYPER_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 78,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_SHADOW_CLAW}
    }
};
