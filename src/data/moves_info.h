...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_MAX_FLUTTERBY] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LOWER_SP_ATK_FOES,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
    },
    ...
    [MOVE_MAX_STRIKE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LOWER_SPEED_FOES,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
    },
    ...
    [MOVE_MAX_PHANTASM] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LOWER_DEFENSE_FOES,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
    },
    ...
    [MOVE_MAX_WYRMWIND] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LOWER_ATTACK_FOES,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
    },
    ...
    [MOVE_MAX_DARKNESS] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LOWER_SP_DEF_FOES,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
    },
    ...
    [MOVE_G_MAX_VOLT_CRASH] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .argMoveEffect = MOVE_EFFECT_PARALYZE_FOES },
