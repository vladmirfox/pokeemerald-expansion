...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_WIDE_GUARD] =
    {
        ...
        .priority = 3,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_WIDE_GUARD },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .snatchAffected = TRUE,
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_QUICK_GUARD] =
    {
        ...
        .priority = 3,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_QUICK_GUARD, },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .snatchAffected = TRUE,
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_MAT_BLOCK] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_MAT_BLOCK, },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .snatchAffected = TRUE,
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_CRAFTY_SHIELD] =
    {
        ...
        .priority = 3,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_CRAFTY_SHIELD },
        .zMove = { .effect = Z_EFFECT_SPDEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_MAX_GUARD] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_MAX_GUARD },
