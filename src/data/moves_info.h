...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_KINGS_SHIELD] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_KINGS_SHIELD },
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_BANEFUL_BUNKER },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_OBSTRUCT] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_OBSTRUCT },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
        .instructBanned = TRUE,
    ...
    [MOVE_SILK_TRAP] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_SILK_TRAP },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_BURNING_BULWARK] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protect.method = PROTECT_BURNING_BULWARK },
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
