...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH] = {gBattleMoves[MOVE_ROCK_SMASH].name, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_STRENGTH] = {gBattleMoves[MOVE_STRENGTH].name, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SURF] = {gBattleMoves[MOVE_SURF].name, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_FLY] = {gBattleMoves[MOVE_FLY].name, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_DIVE] = {gBattleMoves[MOVE_DIVE].name, CursorCb_FieldMove},
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_SECRET_POWER] = {gBattleMoves[MOVE_SECRET_POWER].name, CursorCb_FieldMove},
