...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_CUT] = {gBattleMoves[MOVE_CUT].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_FLASH] = {gBattleMoves[MOVE_FLASH].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH] = {gBattleMoves[MOVE_ROCK_SMASH].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_STRENGTH] = {gBattleMoves[MOVE_STRENGTH].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SURF] = {gBattleMoves[MOVE_SURF].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_FLY] = {gBattleMoves[MOVE_FLY].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_DIVE] = {gBattleMoves[MOVE_DIVE].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_WATERFALL] = {gBattleMoves[MOVE_WATERFALL].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_TELEPORT] = {gBattleMoves[MOVE_TELEPORT].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_DIG] = {gBattleMoves[MOVE_DIG].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SECRET_POWER] = {gBattleMoves[MOVE_SECRET_POWER].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_MILK_DRINK] = {gBattleMoves[MOVE_MILK_DRINK].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SOFT_BOILED] = {gBattleMoves[MOVE_SOFT_BOILED].name.moveName, CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT] = {gBattleMoves[MOVE_SWEET_SCENT].name.moveName, CursorCb_FieldMove},
};
