const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Tera Shard Items
    [ITEM_BUG_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_BugTeraShard},
    [ITEM_DARK_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_DarkTeraShard},
    [ITEM_DRAGON_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_DragonTeraShard},
    [ITEM_ELECTRIC_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_ElectricTeraShard},
    [ITEM_FAIRY_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_FairyTeraShard},
    [ITEM_FIGHTING_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_FightingTeraShard},
    [ITEM_FIRE_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_FireTeraShard},
    [ITEM_FLYING_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_FlyingTeraShard},
    [ITEM_GHOST_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_GhostTeraShard},
    [ITEM_GRASS_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_GrassTeraShard},
    [ITEM_GROUND_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_GroundTeraShard},
    [ITEM_ICE_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_IceTeraShard},
    [ITEM_NORMAL_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_NormalTeraShard},
    [ITEM_POISON_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_PoisonTeraShard},
    [ITEM_PSYCHIC_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_PsychicTeraShard},
    [ITEM_ROCK_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_RockTeraShard},
    [ITEM_STEEL_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_SteelTeraShard},
    [ITEM_WATER_TERA_SHARD] = {gItemIcon_NormalTeraShard, gItemIconPalette_WaterTeraShard},
    // Misc. Items
