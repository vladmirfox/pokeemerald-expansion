...
static const struct SpriteFrameImage sPicTable_Unown[] = {
    overworld_frame(gObjectEventPic_Unown, 2, 4, 0),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 0),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 1),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 1),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 2),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 2),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 1),
    overworld_frame(gObjectEventPic_Unown, 2, 4, 1),
};
