...
static const union AnimCmd sAnim_UnownStayStill[] =
{
    ANIMCMD_FRAME(1,12),
    ANIMCMD_FRAME(2,12),
    ANIMCMD_FRAME(3,12),
...
static const union AnimCmd *const sAnimTable_Unown[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_UnownStayStill,
    [ANIM_STD_FACE_NORTH] = sAnim_UnownStayStill,
    [ANIM_STD_FACE_WEST] = sAnim_UnownStayStill,
    [ANIM_STD_FACE_EAST] = sAnim_UnownStayStill,
    [ANIM_STD_GO_SOUTH] = sAnim_UnownStayStill,
    [ANIM_STD_GO_NORTH] = sAnim_UnownStayStill,
    [ANIM_STD_GO_WEST] = sAnim_GoWest,
    [ANIM_STD_GO_EAST] = sAnim_GoEast,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouth,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorth,
