...
const u32 gObjectEventPic_MeiEvent[] = INCBIN_U32("graphics/object_events/pics/pokemon/mei.4bpp");
const u16 gObjectEventPal_MeiEvent[] = INCBIN_U16("graphics/object_events/pics/pokemon/mei.gbapal");
