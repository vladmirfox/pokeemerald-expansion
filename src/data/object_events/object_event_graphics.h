...
const u32 gObjectEventPic_Unown[] = INCBIN_U32("graphics/object_events/pics/pokemon/unown.4bpp");
const u16 gObjectEventPal_Unown[] = INCBIN_U16("graphics/object_events/palettes/unown.gbapal");
