...
const u32 gObjectEventPic_PTBall[] = INCBIN_U32("graphics/object_events/pics/misc/ball_safari.4bpp");
...
const u16 gObjectEventPal_PTBall[] = INCBIN_U16("graphics/object_events/pics/misc/ball_safari.gbapal");
