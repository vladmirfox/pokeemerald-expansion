...
#define TRAINER_SPRITE(trainerPic, file, x, y)                                            \
...
{
    TRAINER_SPRITE(HIKER, Hiker, 0, 0),
    TRAINER_SPRITE(AQUA_GRUNT_M, AquaGruntM, 0, 0),
    TRAINER_SPRITE(POKEMON_BREEDER_F, PokemonBreederF, 0, 0),
    TRAINER_SPRITE(COOLTRAINER_M, CoolTrainerM, 0, 0),
    TRAINER_SPRITE(BIRD_KEEPER, BirdKeeper, 0, 0),
    TRAINER_SPRITE(COLLECTOR, Collector, 0, 0),
    TRAINER_SPRITE(AQUA_GRUNT_F, AquaGruntF, 0, 0),
    TRAINER_SPRITE(SWIMMER_M, SwimmerM, 0, 0),
    TRAINER_SPRITE(MAGMA_GRUNT_M, MagmaGruntM, 0, 0),
    TRAINER_SPRITE(EXPERT_M, ExpertM, 0, 0),
    TRAINER_SPRITE(AQUA_ADMIN_M, AquaAdminM, 0, 0),
    TRAINER_SPRITE(BLACK_BELT, BlackBelt, 0, 0),
    TRAINER_SPRITE(AQUA_ADMIN_F, AquaAdminF, 0, 0),
    TRAINER_SPRITE(AQUA_LEADER_ARCHIE, AquaLeaderArchie, 0, 0),
    TRAINER_SPRITE(HEX_MANIAC, HexManiac, 0, 0),
    TRAINER_SPRITE(AROMA_LADY, AromaLady, 0, 0),
    TRAINER_SPRITE(RUIN_MANIAC, RuinManiac, 0, 0),
    TRAINER_SPRITE(INTERVIEWER, Interviewer, 0, 0),
    TRAINER_SPRITE(TUBER_F, TuberF, 0, 0),
    TRAINER_SPRITE(TUBER_M, TuberM, 0, 0),
    TRAINER_SPRITE(COOLTRAINER_F, CoolTrainerF, 0, 0),
    TRAINER_SPRITE(LADY, Lady, 0, 0),
    TRAINER_SPRITE(BEAUTY, Beauty, 0, 0),
    TRAINER_SPRITE(RICH_BOY, RichBoy, 0, 0),
    TRAINER_SPRITE(EXPERT_F, ExpertF, 0, 0),
    TRAINER_SPRITE(POKEMANIAC, Pokemaniac, 0, 0),
    TRAINER_SPRITE(MAGMA_GRUNT_F, MagmaGruntF, 0, 0),
    TRAINER_SPRITE(GUITARIST, Guitarist, 0, 0),
    TRAINER_SPRITE(KINDLER, Kindler, 0, 0),
    TRAINER_SPRITE(CAMPER, Camper, 0, 0),
    TRAINER_SPRITE(PICNICKER, Picnicker, 0, 0),
    TRAINER_SPRITE(BUG_MANIAC, BugManiac, 0, 0),
    TRAINER_SPRITE(POKEMON_BREEDER_M, PokemonBreederM, 0, 0),
    TRAINER_SPRITE(PSYCHIC_M, PsychicM, 0, 0),
    TRAINER_SPRITE(PSYCHIC_F, PsychicF, 0, 0),
    TRAINER_SPRITE(GENTLEMAN, Gentleman, 0, 0),
    TRAINER_SPRITE(ELITE_FOUR_SIDNEY, EliteFourSidney, 0, 0),
    TRAINER_SPRITE(ELITE_FOUR_PHOEBE, EliteFourPhoebe, 0, 0),
    TRAINER_SPRITE(ELITE_FOUR_GLACIA, EliteFourGlacia, -4, 4),
    TRAINER_SPRITE(ELITE_FOUR_DRAKE, EliteFourDrake, 0, 5),
    TRAINER_SPRITE(LEADER_ROXANNE, LeaderRoxanne, 0, 0),
    TRAINER_SPRITE(LEADER_BRAWLY, LeaderBrawly, 0, 0),
    TRAINER_SPRITE(LEADER_WATTSON, LeaderWattson, 0, 0),
    TRAINER_SPRITE(LEADER_FLANNERY, LeaderFlannery, 0, 0),
    TRAINER_SPRITE(LEADER_NORMAN, LeaderNorman, 0, 0),
    TRAINER_SPRITE(LEADER_WINONA, LeaderWinona, 0, 0),
    TRAINER_SPRITE(LEADER_TATE_AND_LIZA, LeaderTateAndLiza, 0, 0),
    TRAINER_SPRITE(LEADER_JUAN, LeaderJuan, 0, 0),
    TRAINER_SPRITE(SCHOOL_KID_M, SchoolKidM, 0, 0),
    TRAINER_SPRITE(SCHOOL_KID_F, SchoolKidF, 0, 0),
    TRAINER_SPRITE(SR_AND_JR, SrAndJr, 0, 0),
    TRAINER_SPRITE(POKEFAN_M, PokefanM, 0, 0),
    TRAINER_SPRITE(POKEFAN_F, PokefanF, 0, 0),
    TRAINER_SPRITE(YOUNGSTER, Youngster, 0, 0),
    TRAINER_SPRITE(CHAMPION_WALLACE, ChampionWallace, -8, 7),
    TRAINER_SPRITE(FISHERMAN, Fisherman, 0, 0),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_M, CyclingTriathleteM, 0, 0),
    TRAINER_SPRITE(CYCLING_TRIATHLETE_F, CyclingTriathleteF, 0, 0),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_M, RunningTriathleteM, 0, 0),
    TRAINER_SPRITE(RUNNING_TRIATHLETE_F, RunningTriathleteF, 0, 0),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_M, SwimmingTriathleteM, 0, 0),
    TRAINER_SPRITE(SWIMMING_TRIATHLETE_F, SwimmingTriathleteF, 0, 0),
    TRAINER_SPRITE(DRAGON_TAMER, DragonTamer, 0, 0),
    TRAINER_SPRITE(NINJA_BOY, NinjaBoy, 0, 0),
    TRAINER_SPRITE(BATTLE_GIRL, BattleGirl, 0, 0),
    TRAINER_SPRITE(PARASOL_LADY, ParasolLady, 0, 0),
    TRAINER_SPRITE(SWIMMER_F, SwimmerF, 0, 0),
    TRAINER_SPRITE(TWINS, Twins, 0, 0),
    TRAINER_SPRITE(SAILOR, Sailor, 0, 0),
    TRAINER_SPRITE(MAGMA_ADMIN, MagmaAdmin, 0, 0),
    TRAINER_SPRITE(WALLY, Wally, 0, 0),
    TRAINER_SPRITE(BRENDAN, Brendan, 0, 0),
    TRAINER_SPRITE(MAY, May, 0, 0),
    TRAINER_SPRITE(BUG_CATCHER, BugCatcher, 0, 0),
    TRAINER_SPRITE(POKEMON_RANGER_M, PokemonRangerM, 0, 0),
    TRAINER_SPRITE(POKEMON_RANGER_F, PokemonRangerF, 0, 0),
    TRAINER_SPRITE(MAGMA_LEADER_MAXIE, MagmaLeaderMaxie, 0, 0),
    TRAINER_SPRITE(LASS, Lass, 0, 0),
    TRAINER_SPRITE(YOUNG_COUPLE, YoungCouple, 0, 0),
    TRAINER_SPRITE(OLD_COUPLE, OldCouple, 0, 0),
    TRAINER_SPRITE(SIS_AND_BRO, SisAndBro, 0, 0),
    TRAINER_SPRITE(STEVEN, Steven, 0, 7),
    TRAINER_SPRITE(SALON_MAIDEN_ANABEL, SalonMaidenAnabel, 0, 0),
    TRAINER_SPRITE(DOME_ACE_TUCKER, DomeAceTucker, 0, 0),
    TRAINER_SPRITE(PALACE_MAVEN_SPENSER, PalaceMavenSpenser, 0, 0),
    TRAINER_SPRITE(ARENA_TYCOON_GRETA, ArenaTycoonGreta, 0, 0),
    TRAINER_SPRITE(FACTORY_HEAD_NOLAND, FactoryHeadNoland, 0, 0),
    TRAINER_SPRITE(PIKE_QUEEN_LUCY, PikeQueenLucy, 0, 0),
    TRAINER_SPRITE(PYRAMID_KING_BRANDON, PyramidKingBrandon, 0, 0),
    TRAINER_SPRITE(RED, Red, 0, 0),
    TRAINER_SPRITE(LEAF, Leaf, 0, 0),
    TRAINER_SPRITE(RS_BRENDAN, RubySapphireBrendan, 0, 0),
    TRAINER_SPRITE(RS_MAY, RubySapphireMay, 0, 0),
};
