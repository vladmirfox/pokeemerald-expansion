...
#define TRAINER_SPRITE(trainerPic, file, ...)                                  \
    [trainerPic] =                                                             \
    {                                                                          \
        .frontPic = {gTrainerFrontPic_##file, TRAINER_PIC_SIZE, trainerPic},   \
        .palette = {gTrainerPalette_##file, trainerPic},                       \
...
{
    TRAINER_SPRITE(TRAINER_PIC_HIKER, Hiker),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_GRUNT_M, AquaGruntM),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_BREEDER_F, PokemonBreederF),
    TRAINER_SPRITE(TRAINER_PIC_COOLTRAINER_M, CoolTrainerM),
    TRAINER_SPRITE(TRAINER_PIC_BIRD_KEEPER, BirdKeeper),
    TRAINER_SPRITE(TRAINER_PIC_COLLECTOR, Collector),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_GRUNT_F, AquaGruntF),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMER_M, SwimmerM),
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_GRUNT_M, MagmaGruntM),
    TRAINER_SPRITE(TRAINER_PIC_EXPERT_M, ExpertM),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_ADMIN_M, AquaAdminM),
    TRAINER_SPRITE(TRAINER_PIC_BLACK_BELT, BlackBelt),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_ADMIN_F, AquaAdminF),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_LEADER_ARCHIE, AquaLeaderArchie),
    TRAINER_SPRITE(TRAINER_PIC_HEX_MANIAC, HexManiac),
    TRAINER_SPRITE(TRAINER_PIC_AROMA_LADY, AromaLady),
    TRAINER_SPRITE(TRAINER_PIC_RUIN_MANIAC, RuinManiac),
    TRAINER_SPRITE(TRAINER_PIC_INTERVIEWER, Interviewer),
    TRAINER_SPRITE(TRAINER_PIC_TUBER_F, TuberF),
    TRAINER_SPRITE(TRAINER_PIC_TUBER_M, TuberM),
    TRAINER_SPRITE(TRAINER_PIC_COOLTRAINER_F, CoolTrainerF),
    TRAINER_SPRITE(TRAINER_PIC_LADY, Lady),
    TRAINER_SPRITE(TRAINER_PIC_BEAUTY, Beauty),
    TRAINER_SPRITE(TRAINER_PIC_RICH_BOY, RichBoy),
    TRAINER_SPRITE(TRAINER_PIC_EXPERT_F, ExpertF),
    TRAINER_SPRITE(TRAINER_PIC_POKEMANIAC, Pokemaniac),
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_GRUNT_F, MagmaGruntF),
    TRAINER_SPRITE(TRAINER_PIC_GUITARIST, Guitarist),
    TRAINER_SPRITE(TRAINER_PIC_KINDLER, Kindler),
    TRAINER_SPRITE(TRAINER_PIC_CAMPER, Camper),
    TRAINER_SPRITE(TRAINER_PIC_PICNICKER, Picnicker),
    TRAINER_SPRITE(TRAINER_PIC_BUG_MANIAC, BugManiac),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_BREEDER_M, PokemonBreederM),
    TRAINER_SPRITE(TRAINER_PIC_PSYCHIC_M, PsychicM),
    TRAINER_SPRITE(TRAINER_PIC_PSYCHIC_F, PsychicF),
    TRAINER_SPRITE(TRAINER_PIC_GENTLEMAN, Gentleman),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_SIDNEY, EliteFourSidney),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_PHOEBE, EliteFourPhoebe),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_GLACIA, EliteFourGlacia, -4, 4, 0x1B0),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_DRAKE, EliteFourDrake, 0, 5, 0x1A0),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_ROXANNE, LeaderRoxanne),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BRAWLY, LeaderBrawly),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_WATTSON, LeaderWattson),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_FLANNERY, LeaderFlannery),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_NORMAN, LeaderNorman),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_WINONA, LeaderWinona),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_TATE_AND_LIZA, LeaderTateAndLiza),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_JUAN, LeaderJuan),
    TRAINER_SPRITE(TRAINER_PIC_SCHOOL_KID_M, SchoolKidM),
    TRAINER_SPRITE(TRAINER_PIC_SCHOOL_KID_F, SchoolKidF),
    TRAINER_SPRITE(TRAINER_PIC_SR_AND_JR, SrAndJr),
    TRAINER_SPRITE(TRAINER_PIC_POKEFAN_M, PokefanM),
    TRAINER_SPRITE(TRAINER_PIC_POKEFAN_F, PokefanF),
    TRAINER_SPRITE(TRAINER_PIC_YOUNGSTER, Youngster),
    TRAINER_SPRITE(TRAINER_PIC_CHAMPION_WALLACE, ChampionWallace, -8, 7, 0x188),
    TRAINER_SPRITE(TRAINER_PIC_FISHERMAN, Fisherman),
    TRAINER_SPRITE(TRAINER_PIC_CYCLING_TRIATHLETE_M, CyclingTriathleteM),
    TRAINER_SPRITE(TRAINER_PIC_CYCLING_TRIATHLETE_F, CyclingTriathleteF),
    TRAINER_SPRITE(TRAINER_PIC_RUNNING_TRIATHLETE_M, RunningTriathleteM),
    TRAINER_SPRITE(TRAINER_PIC_RUNNING_TRIATHLETE_F, RunningTriathleteF),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMING_TRIATHLETE_M, SwimmingTriathleteM),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMING_TRIATHLETE_F, SwimmingTriathleteF),
    TRAINER_SPRITE(TRAINER_PIC_DRAGON_TAMER, DragonTamer),
    TRAINER_SPRITE(TRAINER_PIC_NINJA_BOY, NinjaBoy),
    TRAINER_SPRITE(TRAINER_PIC_BATTLE_GIRL, BattleGirl),
    TRAINER_SPRITE(TRAINER_PIC_PARASOL_LADY, ParasolLady),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMER_F, SwimmerF),
    TRAINER_SPRITE(TRAINER_PIC_TWINS, Twins),
    TRAINER_SPRITE(TRAINER_PIC_SAILOR, Sailor),
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_ADMIN, MagmaAdmin),
    TRAINER_SPRITE(TRAINER_PIC_WALLY, Wally),
    TRAINER_SPRITE(TRAINER_PIC_BRENDAN, Brendan),
    TRAINER_SPRITE(TRAINER_PIC_MAY, May),
    TRAINER_SPRITE(TRAINER_PIC_BUG_CATCHER, BugCatcher),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_RANGER_M, PokemonRangerM),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_RANGER_F, PokemonRangerF),
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_LEADER_MAXIE, MagmaLeaderMaxie),
    TRAINER_SPRITE(TRAINER_PIC_LASS, Lass),
    TRAINER_SPRITE(TRAINER_PIC_YOUNG_COUPLE, YoungCouple),
    TRAINER_SPRITE(TRAINER_PIC_OLD_COUPLE, OldCouple),
    TRAINER_SPRITE(TRAINER_PIC_SIS_AND_BRO, SisAndBro),
    TRAINER_SPRITE(TRAINER_PIC_STEVEN, Steven, 0, 7, 0x188),
    TRAINER_SPRITE(TRAINER_PIC_SALON_MAIDEN_ANABEL, SalonMaidenAnabel),
    TRAINER_SPRITE(TRAINER_PIC_DOME_ACE_TUCKER, DomeAceTucker),
    TRAINER_SPRITE(TRAINER_PIC_PALACE_MAVEN_SPENSER, PalaceMavenSpenser),
    TRAINER_SPRITE(TRAINER_PIC_ARENA_TYCOON_GRETA, ArenaTycoonGreta),
    TRAINER_SPRITE(TRAINER_PIC_FACTORY_HEAD_NOLAND, FactoryHeadNoland),
    TRAINER_SPRITE(TRAINER_PIC_PIKE_QUEEN_LUCY, PikeQueenLucy),
    TRAINER_SPRITE(TRAINER_PIC_PYRAMID_KING_BRANDON, PyramidKingBrandon),
    TRAINER_SPRITE(TRAINER_PIC_RED, Red),
    TRAINER_SPRITE(TRAINER_PIC_LEAF, Leaf),
    TRAINER_SPRITE(TRAINER_PIC_RS_BRENDAN, RubySapphireBrendan),
    TRAINER_SPRITE(TRAINER_PIC_RS_MAY, RubySapphireMay),
};
