...
static const u8 sDebugText_FlagsVars[] =        _("{RIGHT_ARROW}Flags & Vars");
...
// Flags/Vars Menu
static const u8 sDebugText_FlagsVars_Flags[] =                  _("{RIGHT_ARROW}Set Flag XYZ");
static const u8 sDebugText_FlagsVars_Flag[] =                   _("Flag: {STR_VAR_1}   \n{STR_VAR_2}                   \n{STR_VAR_3}");
static const u8 sDebugText_FlagsVars_FlagHex[] =                _("{STR_VAR_1}           \n0x{STR_VAR_2}             ");
static const u8 sDebugText_FlagsVars_Vars[] =                   _("{RIGHT_ARROW}Set Var XYZ");
static const u8 sDebugText_FlagsVars_VariableHex[] =            _("{STR_VAR_1}           \n0x{STR_VAR_2}             ");
static const u8 sDebugText_FlagsVars_Variable[] =               _("Var: {STR_VAR_1}             \nVal: {STR_VAR_3}             \n{STR_VAR_2}");
static const u8 sDebugText_FlagsVars_VariableValueSet[] =       _("Var: {STR_VAR_1}             \nVal: {STR_VAR_3}             \n{STR_VAR_2}");
static const u8 sDebugText_FlagsVars_SetPokedexFlags[] =        _("All Pokédex Flags");
static const u8 sDebugText_FlagsVars_SwitchDex[] =              _("Pokédex ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchNationalDex[] =      _("NatDex ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchPokeNav[] =          _("PokéNav ON/OFF");
static const u8 sDebugText_FlagsVars_ToggleFlyFlags[] =         _("Fly Flags ON/OFF");
static const u8 sDebugText_FlagsVars_ToggleAllBadges[] =        _("All badges ON/OFF");
static const u8 sDebugText_FlagsVars_ToggleFrontierPass[] =     _("Frontier Pass ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchCollision[] =        _("Collision ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchEncounter[] =        _("Encounter ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchTrainerSee[] =       _("TrainerSee ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchBagUse[] =           _("BagUse ON/OFF");
static const u8 sDebugText_FlagsVars_SwitchCatching[] =         _("Catching ON/OFF");
// Give Menu
static const u8 sDebugText_Give_GiveItem[] =            _("{RIGHT_ARROW}Give item XYZ");
