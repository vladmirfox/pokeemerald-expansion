...
static const u8 sDebugText_FlagsVars[] =        _("Flags & Vars …");
...
// Give Menu
static const u8 sDebugText_Give_GiveItem[] =            _("Give item XYZ …");
