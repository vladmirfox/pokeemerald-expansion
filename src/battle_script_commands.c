...
static const u8 sForbiddenMoves[MOVES_COUNT] =
{
    ...
    [MOVE_ASSIST] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BANEFUL_BUNKER] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BEAK_BLAST] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BEHEMOTH_BASH] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BEHEMOTH_BLADE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BELCH] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BESTOW] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BLAZING_TORQUE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_BOUNCE] = FORBIDDEN_ASSIST,
    [MOVE_CELEBRATE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_CHATTER] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_CIRCLE_THROW] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_COMBAT_TORQUE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_COPYCAT] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    ...
    [MOVE_DYNAMAX_CANNON] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_ENDURE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_FEINT] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_FLY] = FORBIDDEN_ASSIST,
    [MOVE_FOCUS_PUNCH] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_FOLLOW_ME] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_HELPING_HAND] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_HOLD_HANDS] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_KINGS_SHIELD] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_MAGICAL_TORQUE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_MAT_BLOCK] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_ME_FIRST] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_METRONOME] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_MIMIC] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_MIRROR_COAT] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_MIRROR_MOVE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_NATURE_POWER] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_NOXIOUS_TORQUE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    ...
    [MOVE_SHELL_TRAP] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_SKETCH] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    [MOVE_SKY_DROP] = FORBIDDEN_ASSIST,
    [MOVE_SLEEP_TALK] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
    ...
    [MOVE_WICKED_TORQUE] = FORBIDDEN_ASSIST | FORBIDDEN_COPYCAT,
};
