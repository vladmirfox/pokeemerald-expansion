...
static const u8 sForbiddenMoves[MOVES_COUNT] =
{
    ...
    [MOVE_BLAZING_TORQUE] = FORBIDDEN_METRONOME,
    ...
    [MOVE_COMBAT_TORQUE] = FORBIDDEN_METRONOME,
    ...
    [MOVE_MAGICAL_TORQUE] = FORBIDDEN_METRONOME,
    ...
    [MOVE_NOXIOUS_TORQUE] = FORBIDDEN_METRONOME,
    ...
    [MOVE_WICKED_TORQUE] = FORBIDDEN_METRONOME,
