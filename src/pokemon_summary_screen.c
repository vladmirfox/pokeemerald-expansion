...
static void BufferAlternateStat(u8 mode);
...
static const u8 sStatsLeftColumnLayoutAlternate[] = _("{DYNAMIC 0}\n{DYNAMIC 1}\n{DYNAMIC 2}");
...
{
    u8 *txtPtr;
    static const u8 sNatureTextColorNeutral[] = _("{COLOR WHITE}{SHADOW DARK_GRAY}");
    static const u8 sNatureTextColorPositive[] = _("{COLOR LIGHT_RED}{SHADOW DARK_GRAY}");
    static const u8 sNatureTextColorNegative[] = _("{COLOR BLUE}{SHADOW DARK_GRAY}");

    if (natureMod == 0)
        txtPtr = StringCopy(dst, sNatureTextColorNeutral);
    else if (natureMod > 0)
        txtPtr = StringCopy(dst, sNatureTextColorPositive);
    else
        txtPtr = StringCopy(dst, sNatureTextColorNegative);
...
static void BufferAlternateStat(u8 mode)
{
    ...
    case 1:
        ...
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsLeftColumnLayoutAlternate);
        PrintLeftColumnStats();
