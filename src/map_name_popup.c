...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SILVERIDGE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_WINDYCAPE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_YIFU_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MAGURO_HARBOR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SOULKEEP] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SILVER_TUNNEL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SEASTROLL_CHANNEL] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ORCHARD_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SABERSIDE_TOWN] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_OPEN_SEA_CORAL] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_OPEN_SEA_HAVEN] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_OPEN_SEA_ICY] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_OPEN_SEA_LEAGUE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_WHITESLATE_ROUTE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SCENIC_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HARVEST_SHRINE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HAVENISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIDDLEISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TOPISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEATURF_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LONGTIDE_CHANNEL] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_LONGTIDE_CHANNEL_SOULKEEP] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DRAGONS_PASS] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DRYUGON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BURNFOOT_PASS_BOTTOM] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_STEEPSTONE_PASS_BOTTOM] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BURNFOOT_PASS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MT_KAZAN_EXTERIOR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_STEEPSTONE_PASS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHOGUNATE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SCENIC_ROUTE_SABERSIDE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UUME_FOREST] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_COREEF_ISLE] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_GINKO_WOODS] = MAPPOPUP_THEME_WOOD,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_LONGTIDE_CHANNEL_SOULKEEP] = MAPPOPUP_THEME_BW_DEFAULT,
