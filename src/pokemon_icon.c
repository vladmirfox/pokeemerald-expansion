...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CASTFORM_NORMAL] = gMonIcon_Castform,
    ...
    [SPECIES_GASTRODON_WEST_SEA] = gMonIcon_Gastrodon,
    ...
    [SPECIES_GIRATINA_ALTERED] = gMonIcon_Giratina,
    ...
    [SPECIES_SHAYMIN_LAND] = gMonIcon_Shaymin,
    ...
    [SPECIES_DARMANITAN_STANDARD_MODE] = gMonIcon_Darmanitan,
    [SPECIES_DARMANITAN_ZEN_MODE] = gMonIcon_DarmanitanZenMode,
    [SPECIES_DARMANITAN_GALARIAN_STANDARD_MODE] = gMonIcon_DarmanitanGalarian,
    ...
    [SPECIES_DEERLING_SPRING] = gMonIcon_Deerling,
    ...
    [SPECIES_SAWSBUCK_SPRING] = gMonIcon_Sawsbuck,
    ...
    [SPECIES_TORNADUS_INCARNATE] = gMonIcon_Tornadus,
    [SPECIES_THUNDURUS_INCARNATE] = gMonIcon_Thundurus,
    [SPECIES_RESHIRAM] = gMonIcon_Reshiram,
    [SPECIES_ZEKROM] = gMonIcon_Zekrom,
    [SPECIES_LANDORUS_INCARNATE] = gMonIcon_Landorus,
    [SPECIES_KYUREM] = gMonIcon_Kyurem,
    [SPECIES_KELDEO_ORDINARY] = gMonIcon_Keldeo,
    [SPECIES_MELOETTA_ARIA] = gMonIcon_Meloetta,
    ...
    [SPECIES_SCATTERBUG_ICY_SNOW] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_POLAR] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_TUNDRA] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_CONTINENTAL] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_GARDEN] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_ELEGANT] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_MEADOW] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_MODERN] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_MARINE] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_ARCHIPELAGO] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_HIGH_PLAINS] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_SANDSTORM] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_RIVER] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_MONSOON] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_SAVANNA] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_SUN] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_OCEAN] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_JUNGLE] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_FANCY] = gMonIcon_Scatterbug,
    [SPECIES_SCATTERBUG_POKE_BALL] = gMonIcon_Scatterbug,
    [SPECIES_SPEWPA_ICY_SNOW] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_POLAR] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_TUNDRA] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_CONTINENTAL] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_GARDEN] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_ELEGANT] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_MEADOW] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_MODERN] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_MARINE] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_ARCHIPELAGO] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_HIGH_PLAINS] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_SANDSTORM] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_RIVER] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_MONSOON] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_SAVANNA] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_SUN] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_OCEAN] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_JUNGLE] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_FANCY] = gMonIcon_Spewpa,
    [SPECIES_SPEWPA_POKE_BALL] = gMonIcon_Spewpa,
    [SPECIES_VIVILLON_ICY_SNOW] = gMonIcon_Vivillon,
    ...
    [SPECIES_FLABEBE_RED_FLOWER] = gMonIcon_Flabebe,
    ...
    [SPECIES_FLOETTE_RED_FLOWER] = gMonIcon_Floette,
    ...
    [SPECIES_FLORGES_RED_FLOWER] = gMonIcon_Florges,
    ...
    [SPECIES_FURFROU_NATURAL] = gMonIcon_Furfrou,
    ...
    [SPECIES_AEGISLASH_SHIELD] = gMonIcon_Aegislash,
    ...
    [SPECIES_XERNEAS_NEUTRAL] = gMonIcon_Xerneas,
    ...
    [SPECIES_HOOPA_CONFINED] = gMonIcon_Hoopa,
    ...
    [SPECIES_ORICORIO_BAILE] = gMonIcon_Oricorio,
    ...
    [SPECIES_MINIOR_METEOR_RED] = gMonIcon_Minior,
    ...
    [SPECIES_MIMIKYU_DISGUISED] = gMonIcon_Mimikyu,
    ...
    [SPECIES_TOXTRICITY_AMPED] = gMonIcon_Toxtricity,
    ...
    [SPECIES_EISCUE_ICE_FACE] = gMonIcon_Eiscue,
    ...
    [SPECIES_MORPEKO_FULL_BELLY] = gMonIcon_Morpeko,
    ...
    [SPECIES_ZACIAN_HERO_OF_MANY_BATTLES] = gMonIcon_Zacian,
    [SPECIES_ZACIAN_CROWNED_SWORD] = gMonIcon_ZacianCrownedSword,
    [SPECIES_ZAMAZENTA_HERO_OF_MANY_BATTLES] = gMonIcon_Zamazenta,
    ...
    [SPECIES_ENAMORUS_INCARNATE] = gMonIcon_Enamorus,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_UNOWN_EMARK ... SPECIES_UNOWN_QMARK] = 0,
    [SPECIES_WOBBUFFET] = 0,
    [SPECIES_GIRAFARIG] = 1,
    [SPECIES_PINECO] = 0,
...
// Gen 6
    ...
    [SPECIES_SCATTERBUG_ICY_SNOW] = 1,
    [SPECIES_SCATTERBUG_POLAR] = 1,
    [SPECIES_SCATTERBUG_TUNDRA] = 1,
    [SPECIES_SCATTERBUG_CONTINENTAL] = 1,
    [SPECIES_SCATTERBUG_GARDEN] = 1,
    [SPECIES_SCATTERBUG_ELEGANT] = 1,
    [SPECIES_SCATTERBUG_MEADOW] = 1,
    [SPECIES_SCATTERBUG_MODERN] = 1,
    [SPECIES_SCATTERBUG_MARINE] = 1,
    [SPECIES_SCATTERBUG_ARCHIPELAGO] = 1,
    [SPECIES_SCATTERBUG_HIGH_PLAINS] = 1,
    [SPECIES_SCATTERBUG_SANDSTORM] = 1,
    [SPECIES_SCATTERBUG_RIVER] = 1,
    [SPECIES_SCATTERBUG_MONSOON] = 1,
    [SPECIES_SCATTERBUG_SAVANNA] = 1,
    [SPECIES_SCATTERBUG_SUN] = 1,
    [SPECIES_SCATTERBUG_OCEAN] = 1,
    [SPECIES_SCATTERBUG_JUNGLE] = 1,
    [SPECIES_SCATTERBUG_FANCY] = 1,
    [SPECIES_SCATTERBUG_POKE_BALL] = 1,
    [SPECIES_SPEWPA_ICY_SNOW] = 1,
    [SPECIES_SPEWPA_POLAR] = 1,
    [SPECIES_SPEWPA_TUNDRA] = 1,
    [SPECIES_SPEWPA_CONTINENTAL] = 1,
    [SPECIES_SPEWPA_GARDEN] = 1,
    [SPECIES_SPEWPA_ELEGANT] = 1,
    [SPECIES_SPEWPA_MEADOW] = 1,
    [SPECIES_SPEWPA_MODERN] = 1,
    [SPECIES_SPEWPA_MARINE] = 1,
    [SPECIES_SPEWPA_ARCHIPELAGO] = 1,
    [SPECIES_SPEWPA_HIGH_PLAINS] = 1,
    [SPECIES_SPEWPA_SANDSTORM] = 1,
    [SPECIES_SPEWPA_RIVER] = 1,
    [SPECIES_SPEWPA_MONSOON] = 1,
    [SPECIES_SPEWPA_SAVANNA] = 1,
    [SPECIES_SPEWPA_SUN] = 1,
    [SPECIES_SPEWPA_OCEAN] = 1,
    [SPECIES_SPEWPA_JUNGLE] = 1,
    [SPECIES_SPEWPA_FANCY] = 1,
    [SPECIES_SPEWPA_POKE_BALL] = 1,
