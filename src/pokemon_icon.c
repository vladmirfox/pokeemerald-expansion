...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ZYGARDE_50] = gMonIcon_Zygarde50,
    ...
    [SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM] = gMonIcon_AlcremieVanillaCream,
...
{
    return GetMonIconTiles(species, personality);
}
