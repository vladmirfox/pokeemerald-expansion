...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/mewtwo.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/mewtwo.bin.lz");
