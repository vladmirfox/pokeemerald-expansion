...
static const u8 sMapsecToRegion[] = {
        ...
        [MAPSEC_ROUTE_1]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_2]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_3]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_4]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_5]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_6]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_7]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_8]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_9]                    = REGION_ASTRALIS,
        [MAPSEC_ROUTE_10]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_11]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_12]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_13]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_14]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_15]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_16]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_17]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_18]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_19]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_20]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_21]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_22]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_23]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_24]                   = REGION_ASTRALIS,
        [MAPSEC_ROUTE_25]                   = REGION_ASTRALIS,
        ...
        [MAPSEC_WYRMSHIRE]                  = REGION_ASTRALIS,
        [MAPSEC_GREENSFIELD]                = REGION_ASTRALIS,
        [MAPSEC_HANAKA_VILLAGE]             = REGION_ASTRALIS,
        [MAPSEC_MARINA_PORT]                = REGION_ASTRALIS,
        [MAPSEC_HYDROELEC_DAM]              = REGION_ASTRALIS,
        [MAPSEC_IRONFORGE_CITY]             = REGION_ASTRALIS,
        [MAPSEC_VALORITE_WOODS]             = REGION_ASTRALIS,
        [MAPSEC_FORT_VALORITE]              = REGION_ASTRALIS,
        [MAPSEC_REMNANT_OF_CONFLICT]        = REGION_ASTRALIS,
        [MAPSEC_MYSTERIA]                   = REGION_ASTRALIS,
        [MAPSEC_FORTUNA_CITY]               = REGION_ASTRALIS,
        [MAPSEC_DESERT_GATEWAY]             = REGION_ASTRALIS,
        [MAPSEC_GREAT_DESERT]               = REGION_ASTRALIS,
        [MAPSEC_AE_RUINS]                   = REGION_ASTRALIS,
        [MAPSEC_DESERT_OASIS]               = REGION_ASTRALIS,
        [MAPSEC_CYNDERHAIL_SECT]            = REGION_ASTRALIS,
        [MAPSEC_NEXIUM_CAVERNS]             = REGION_ASTRALIS,
        [MAPSEC_WYRMSPIRE_KEEP]             = REGION_ASTRALIS,
        [MAPSEC_DRAGONS_GATE]               = REGION_ASTRALIS,
        [MAPSEC_SHINRYU_PATH]               = REGION_ASTRALIS,
        [MAPSEC_SHINRYU_PAGODA]             = REGION_ASTRALIS
    };
