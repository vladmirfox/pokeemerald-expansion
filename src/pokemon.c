...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(RATTATA_ALOLA),	
    ...
    HOENN_TO_NATIONAL(DIGLETT_ALOLA),	
    HOENN_TO_NATIONAL(DUGTRIO_ALOLA),	
    ...
    HOENN_TO_NATIONAL(MEOWTH_GALAR),	
    ...
    HOENN_TO_NATIONAL(GEODUDE_ALOLA),	
    HOENN_TO_NATIONAL(GRAVELER_ALOLA),	
    HOENN_TO_NATIONAL(GOLEM_ALOLA),	
    HOENN_TO_NATIONAL(PONYTA),	
    HOENN_TO_NATIONAL(RAPIDASH),	
    HOENN_TO_NATIONAL(PONYTA_GALAR),	
    HOENN_TO_NATIONAL(RAPIDASH_GALAR),	
    HOENN_TO_NATIONAL(SLOWPOKE),	
    HOENN_TO_NATIONAL(SLOWBRO),	
    HOENN_TO_NATIONAL(SLOWKING),	
    HOENN_TO_NATIONAL(SLOWPOKE_GALAR),	
    HOENN_TO_NATIONAL(SLOWBRO_GALAR),	
    ...
    HOENN_TO_NATIONAL(GRIMER_ALOLA),	
    HOENN_TO_NATIONAL(MUK_ALOLA),	
    ...
    HOENN_TO_NATIONAL(VOLTORB_HISUI),	
    HOENN_TO_NATIONAL(ELECTRODE_HISUI),	
    ...
    HOENN_TO_NATIONAL(MAROWAK_ALOLA),	
    ...
    HOENN_TO_NATIONAL(WEEZING_GALAR),	
    ...
    HOENN_TO_NATIONAL(MR_MIME_GALAR),	
    ...
    HOENN_TO_NATIONAL(TAUROS_PALDEA_BLAZE),	
    HOENN_TO_NATIONAL(TAUROS_PALDEA_WATER),	
    ...
    HOENN_TO_NATIONAL(TYPHLOSION_HISUI),	
    ...
    HOENN_TO_NATIONAL(WOOPER_PALDEA),	
    ...
    HOENN_TO_NATIONAL(CORSOLA_GALAR),	
    ...
    HOENN_TO_NATIONAL(ZIGZAGOON_GALAR),	
    HOENN_TO_NATIONAL(LINOONE_GALAR),	
    ...
    HOENN_TO_NATIONAL(ZOROARK_HISUI),	
    ...
    HOENN_TO_NATIONAL(DECIDUEYE_HISUI),	
    HOENN_TO_NATIONAL(ROCKRUFF),	
    HOENN_TO_NATIONAL(LYCANROC_MIDDAY),	
