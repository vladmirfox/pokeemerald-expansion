...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(BEEDRILL,_MEGA),
    SPECIES_TO_NATIONAL(PIDGEY),
    SPECIES_TO_NATIONAL(PIDGEOTTO),
    SPECIES_TO_NATIONAL(PIDGEOT),
    SPECIES_TO_NATIONAL(PIDGEOT,_MEGA),
    SPECIES_TO_NATIONAL(RATTATA),
    SPECIES_TO_NATIONAL(RATTATA,_ALOLAN),
    SPECIES_TO_NATIONAL(RATICATE),
    SPECIES_TO_NATIONAL(RATICATE,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(PIKACHU,_COSPLAY),
    SPECIES_TO_NATIONAL(PIKACHU,_ROCK_STAR),
    SPECIES_TO_NATIONAL(PIKACHU,_BELLE),
    SPECIES_TO_NATIONAL(PIKACHU,_POP_STAR),
    SPECIES_TO_NATIONAL(PIKACHU,_PH_D),
    SPECIES_TO_NATIONAL(PIKACHU,_LIBRE),
    SPECIES_TO_NATIONAL(PIKACHU,_ORIGINAL_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_HOENN_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_SINNOH_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_UNOVA_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_KALOS_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_ALOLA_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_PARTNER_CAP),
    SPECIES_TO_NATIONAL(PIKACHU,_WORLD_CAP),
    SPECIES_TO_NATIONAL(RAICHU),
    SPECIES_TO_NATIONAL(RAICHU,_ALOLAN),
    SPECIES_TO_NATIONAL(SANDSHREW),
    SPECIES_TO_NATIONAL(SANDSHREW,_ALOLAN),
    SPECIES_TO_NATIONAL(SANDSLASH),
    SPECIES_TO_NATIONAL(SANDSLASH,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(VULPIX,_ALOLAN),
    SPECIES_TO_NATIONAL(NINETALES),
    SPECIES_TO_NATIONAL(NINETALES,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(DIGLETT,_ALOLAN),
    SPECIES_TO_NATIONAL(DUGTRIO),
    SPECIES_TO_NATIONAL(DUGTRIO,_ALOLAN),
    SPECIES_TO_NATIONAL(MEOWTH),
    SPECIES_TO_NATIONAL(MEOWTH,_ALOLAN),
    SPECIES_TO_NATIONAL(MEOWTH,_GALARIAN),
    SPECIES_TO_NATIONAL(PERSIAN),
    SPECIES_TO_NATIONAL(PERSIAN,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(GROWLITHE,_HISUIAN),
    SPECIES_TO_NATIONAL(ARCANINE),
    SPECIES_TO_NATIONAL(ARCANINE,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(ALAKAZAM,_MEGA),
    ...
    SPECIES_TO_NATIONAL(GEODUDE,_ALOLAN),
    SPECIES_TO_NATIONAL(GRAVELER),
    SPECIES_TO_NATIONAL(GRAVELER,_ALOLAN),
    SPECIES_TO_NATIONAL(GOLEM),
    SPECIES_TO_NATIONAL(GOLEM,_ALOLAN),
    SPECIES_TO_NATIONAL(PONYTA),
    SPECIES_TO_NATIONAL(PONYTA,_GALARIAN),
    SPECIES_TO_NATIONAL(RAPIDASH),
    SPECIES_TO_NATIONAL(RAPIDASH,_GALARIAN),
    SPECIES_TO_NATIONAL(SLOWPOKE),
    SPECIES_TO_NATIONAL(SLOWPOKE,_GALARIAN),
    SPECIES_TO_NATIONAL(SLOWBRO),
    SPECIES_TO_NATIONAL(SLOWBRO,_MEGA),
    SPECIES_TO_NATIONAL(SLOWBRO,_GALARIAN),
    SPECIES_TO_NATIONAL(MAGNEMITE),
    SPECIES_TO_NATIONAL(MAGNETON),
    SPECIES_TO_NATIONAL(FARFETCHD),
    SPECIES_TO_NATIONAL(FARFETCHD,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(GRIMER,_ALOLAN),
    SPECIES_TO_NATIONAL(MUK),
    SPECIES_TO_NATIONAL(MUK,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(GENGAR,_MEGA),
    ...
    SPECIES_TO_NATIONAL(VOLTORB,_HISUIAN),
    SPECIES_TO_NATIONAL(ELECTRODE),
    SPECIES_TO_NATIONAL(ELECTRODE,_HISUIAN),
    SPECIES_TO_NATIONAL(EXEGGCUTE),
    SPECIES_TO_NATIONAL(EXEGGUTOR),
    SPECIES_TO_NATIONAL(EXEGGUTOR,_ALOLAN),
    SPECIES_TO_NATIONAL(CUBONE),
    SPECIES_TO_NATIONAL(MAROWAK),
    SPECIES_TO_NATIONAL(MAROWAK,_ALOLAN),
    ...
    SPECIES_TO_NATIONAL(WEEZING,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(KANGASKHAN,_MEGA),
    ...
    SPECIES_TO_NATIONAL(MR_MIME,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(TYPHLOSION,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(PICHU,_SPIKY_EARED),
    ...
    SPECIES_TO_NATIONAL(AMPHAROS,_MEGA),
    ...
    SPECIES_TO_NATIONAL(SLOWKING,_GALARIAN),
    SPECIES_TO_NATIONAL(MISDREAVUS),
    SPECIES_TO_NATIONAL(UNOWN),
    SPECIES_TO_NATIONAL(UNOWN,_B),
    SPECIES_TO_NATIONAL(UNOWN,_C),
    SPECIES_TO_NATIONAL(UNOWN,_D),
    SPECIES_TO_NATIONAL(UNOWN,_E),
    SPECIES_TO_NATIONAL(UNOWN,_F),
    SPECIES_TO_NATIONAL(UNOWN,_G),
    SPECIES_TO_NATIONAL(UNOWN,_H),
    SPECIES_TO_NATIONAL(UNOWN,_I),
    SPECIES_TO_NATIONAL(UNOWN,_J),
    SPECIES_TO_NATIONAL(UNOWN,_K),
    SPECIES_TO_NATIONAL(UNOWN,_L),
    SPECIES_TO_NATIONAL(UNOWN,_M),
    SPECIES_TO_NATIONAL(UNOWN,_N),
    SPECIES_TO_NATIONAL(UNOWN,_O),
    SPECIES_TO_NATIONAL(UNOWN,_P),
    SPECIES_TO_NATIONAL(UNOWN,_Q),
    SPECIES_TO_NATIONAL(UNOWN,_R),
    SPECIES_TO_NATIONAL(UNOWN,_S),
    SPECIES_TO_NATIONAL(UNOWN,_T),
    SPECIES_TO_NATIONAL(UNOWN,_U),
    SPECIES_TO_NATIONAL(UNOWN,_V),
    SPECIES_TO_NATIONAL(UNOWN,_W),
    SPECIES_TO_NATIONAL(UNOWN,_X),
    SPECIES_TO_NATIONAL(UNOWN,_Y),
    SPECIES_TO_NATIONAL(UNOWN,_Z),
    SPECIES_TO_NATIONAL(UNOWN,_QMARK),
    SPECIES_TO_NATIONAL(UNOWN,_EMARK),
    ...
    SPECIES_TO_NATIONAL(CORSOLA,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(HOUNDOOM,_MEGA),
    ...
    SPECIES_TO_NATIONAL(TYRANITAR,_MEGA),
    ...
    SPECIES_TO_NATIONAL(GARDEVOIR,_MEGA),
    ...
    SPECIES_TO_NATIONAL(ALTARIA,_MEGA),
    ...
    SPECIES_TO_NATIONAL(SALAMENCE,_MEGA),
    SPECIES_TO_NATIONAL(BELDUM),
    SPECIES_TO_NATIONAL(METANG),
    SPECIES_TO_NATIONAL(METAGROSS),
    SPECIES_TO_NATIONAL(METAGROSS,_MEGA),
    SPECIES_TO_NATIONAL(REGIROCK),
    SPECIES_TO_NATIONAL(REGICE),
    SPECIES_TO_NATIONAL(REGISTEEL),
    SPECIES_TO_NATIONAL(LATIAS),
    SPECIES_TO_NATIONAL(LATIAS,_MEGA),
    SPECIES_TO_NATIONAL(LATIOS),
    SPECIES_TO_NATIONAL(LATIOS,_MEGA),
    SPECIES_TO_NATIONAL(KYOGRE),
    SPECIES_TO_NATIONAL(KYOGRE,_PRIMAL),
    SPECIES_TO_NATIONAL(GROUDON),
    SPECIES_TO_NATIONAL(GROUDON,_PRIMAL),
    SPECIES_TO_NATIONAL(RAYQUAZA),
    SPECIES_TO_NATIONAL(RAYQUAZA,_MEGA),
    SPECIES_TO_NATIONAL(JIRACHI),
    SPECIES_TO_NATIONAL(DEOXYS,_NORMAL),
    SPECIES_TO_NATIONAL(DEOXYS,_ATTACK),
    SPECIES_TO_NATIONAL(DEOXYS,_DEFENSE),
    SPECIES_TO_NATIONAL(DEOXYS,_SPEED),
#if P_GEN_4_POKEMON == TRUE
    ...
    SPECIES_TO_NATIONAL(BURMY,_PLANT_CLOAK),
    SPECIES_TO_NATIONAL(BURMY,_SANDY_CLOAK),
    SPECIES_TO_NATIONAL(BURMY,_TRASH_CLOAK),
    SPECIES_TO_NATIONAL(WORMADAM,_PLANT_CLOAK),
    SPECIES_TO_NATIONAL(WORMADAM,_SANDY_CLOAK),
    SPECIES_TO_NATIONAL(WORMADAM,_TRASH_CLOAK),
    ...
    SPECIES_TO_NATIONAL(CHERRIM,_OVERCAST),
    SPECIES_TO_NATIONAL(CHERRIM,_SUNSHINE),
    SPECIES_TO_NATIONAL(SHELLOS,_WEST_SEA),
    SPECIES_TO_NATIONAL(SHELLOS,_EAST_SEA),
    SPECIES_TO_NATIONAL(GASTRODON,_WEST_SEA),
    SPECIES_TO_NATIONAL(GASTRODON,_EAST_SEA),
    ...
    SPECIES_TO_NATIONAL(LOPUNNY,_MEGA),
    ...
    SPECIES_TO_NATIONAL(ABOMASNOW,_MEGA),
    ...
    SPECIES_TO_NATIONAL(GALLADE,_MEGA),
    SPECIES_TO_NATIONAL(PROBOPASS),
    SPECIES_TO_NATIONAL(DUSKNOIR),
    SPECIES_TO_NATIONAL(FROSLASS),
    SPECIES_TO_NATIONAL(ROTOM),
    SPECIES_TO_NATIONAL(ROTOM,_HEAT),
    SPECIES_TO_NATIONAL(ROTOM,_WASH),
    SPECIES_TO_NATIONAL(ROTOM,_FROST),
    SPECIES_TO_NATIONAL(ROTOM,_FAN),
    SPECIES_TO_NATIONAL(ROTOM,_MOW),
    SPECIES_TO_NATIONAL(UXIE),
    SPECIES_TO_NATIONAL(MESPRIT),
    SPECIES_TO_NATIONAL(AZELF),
    SPECIES_TO_NATIONAL(DIALGA),
    SPECIES_TO_NATIONAL(DIALGA,_ORIGIN),
    SPECIES_TO_NATIONAL(PALKIA),
    SPECIES_TO_NATIONAL(PALKIA,_ORIGIN),
    SPECIES_TO_NATIONAL(HEATRAN),
    SPECIES_TO_NATIONAL(REGIGIGAS),
    SPECIES_TO_NATIONAL(GIRATINA,_ALTERED),
    SPECIES_TO_NATIONAL(GIRATINA,_ORIGIN),
    SPECIES_TO_NATIONAL(CRESSELIA),
    SPECIES_TO_NATIONAL(PHIONE),
    SPECIES_TO_NATIONAL(MANAPHY),
    SPECIES_TO_NATIONAL(DARKRAI),
    SPECIES_TO_NATIONAL(SHAYMIN,_LAND),
    SPECIES_TO_NATIONAL(SHAYMIN,_SKY),
    SPECIES_TO_NATIONAL(ARCEUS,_NORMAL),
    SPECIES_TO_NATIONAL(ARCEUS,_FIGHTING),
    SPECIES_TO_NATIONAL(ARCEUS,_FLYING),
    SPECIES_TO_NATIONAL(ARCEUS,_POISON),
    SPECIES_TO_NATIONAL(ARCEUS,_GROUND),
    SPECIES_TO_NATIONAL(ARCEUS,_ROCK),
    SPECIES_TO_NATIONAL(ARCEUS,_BUG),
    SPECIES_TO_NATIONAL(ARCEUS,_GHOST),
    SPECIES_TO_NATIONAL(ARCEUS,_STEEL),
    SPECIES_TO_NATIONAL(ARCEUS,_FIRE),
    SPECIES_TO_NATIONAL(ARCEUS,_WATER),
    SPECIES_TO_NATIONAL(ARCEUS,_GRASS),
    SPECIES_TO_NATIONAL(ARCEUS,_ELECTRIC),
    SPECIES_TO_NATIONAL(ARCEUS,_PSYCHIC),
    SPECIES_TO_NATIONAL(ARCEUS,_ICE),
    SPECIES_TO_NATIONAL(ARCEUS,_DRAGON),
    SPECIES_TO_NATIONAL(ARCEUS,_DARK),
    SPECIES_TO_NATIONAL(ARCEUS,_FAIRY),
#endif
    ...
    SPECIES_TO_NATIONAL(SAMUROTT,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(AUDINO,_MEGA),
    ...
    SPECIES_TO_NATIONAL(LILLIGANT,_HISUIAN),
    SPECIES_TO_NATIONAL(BASCULIN,_RED_STRIPED),
    SPECIES_TO_NATIONAL(BASCULIN,_BLUE_STRIPED),
    SPECIES_TO_NATIONAL(BASCULIN,_WHITE_STRIPED),
    ...
    SPECIES_TO_NATIONAL(DARMANITAN,_STANDARD_MODE),
    SPECIES_TO_NATIONAL(DARMANITAN,_ZEN_MODE),
    SPECIES_TO_NATIONAL(DARMANITAN,_GALARIAN_STANDARD_MODE),
    SPECIES_TO_NATIONAL(DARMANITAN,_GALARIAN_ZEN_MODE),
    ...
    SPECIES_TO_NATIONAL(YAMASK,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(ZORUA,_HISUIAN),
    SPECIES_TO_NATIONAL(ZOROARK),
    SPECIES_TO_NATIONAL(ZOROARK,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(DEERLING,_SPRING),
    SPECIES_TO_NATIONAL(DEERLING,_SUMMER),
    SPECIES_TO_NATIONAL(DEERLING,_AUTUMN),
    SPECIES_TO_NATIONAL(DEERLING,_WINTER),
    SPECIES_TO_NATIONAL(SAWSBUCK,_SPRING),
    SPECIES_TO_NATIONAL(SAWSBUCK,_SUMMER),
    SPECIES_TO_NATIONAL(SAWSBUCK,_AUTUMN),
    SPECIES_TO_NATIONAL(SAWSBUCK,_WINTER),
    ...
    SPECIES_TO_NATIONAL(STUNFISK,_GALARIAN),
    ...
    SPECIES_TO_NATIONAL(BRAVIARY,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(TORNADUS,_INCARNATE),
    SPECIES_TO_NATIONAL(TORNADUS,_THERIAN),
    SPECIES_TO_NATIONAL(THUNDURUS,_INCARNATE),
    SPECIES_TO_NATIONAL(THUNDURUS,_THERIAN),
    SPECIES_TO_NATIONAL(RESHIRAM),
    SPECIES_TO_NATIONAL(ZEKROM),
    SPECIES_TO_NATIONAL(LANDORUS,_INCARNATE),
    SPECIES_TO_NATIONAL(LANDORUS,_THERIAN),
    SPECIES_TO_NATIONAL(KYUREM),
    SPECIES_TO_NATIONAL(KYUREM,_BLACK),
    SPECIES_TO_NATIONAL(KYUREM,_WHITE),
    SPECIES_TO_NATIONAL(KELDEO,_ORDINARY),
    SPECIES_TO_NATIONAL(KELDEO,_RESOLUTE),
    SPECIES_TO_NATIONAL(MELOETTA,_ARIA),
    SPECIES_TO_NATIONAL(MELOETTA,_PIROUETTE),
    SPECIES_TO_NATIONAL(GENESECT),
    SPECIES_TO_NATIONAL(GENESECT,_DOUSE_DRIVE),
    SPECIES_TO_NATIONAL(GENESECT,_SHOCK_DRIVE),
    SPECIES_TO_NATIONAL(GENESECT,_BURN_DRIVE),
    SPECIES_TO_NATIONAL(GENESECT,_CHILL_DRIVE),
#endif
    ...
    SPECIES_TO_NATIONAL(GRENINJA,_BATTLE_BOND),
    SPECIES_TO_NATIONAL(GRENINJA,_ASH),
    ...
    SPECIES_TO_NATIONAL(SCATTERBUG,_ICY_SNOW),
    SPECIES_TO_NATIONAL(SCATTERBUG,_POLAR),
    SPECIES_TO_NATIONAL(SCATTERBUG,_TUNDRA),
    SPECIES_TO_NATIONAL(SCATTERBUG,_CONTINENTAL),
    SPECIES_TO_NATIONAL(SCATTERBUG,_GARDEN),
    SPECIES_TO_NATIONAL(SCATTERBUG,_ELEGANT),
    SPECIES_TO_NATIONAL(SCATTERBUG,_MEADOW),
    SPECIES_TO_NATIONAL(SCATTERBUG,_MODERN),
    SPECIES_TO_NATIONAL(SCATTERBUG,_MARINE),
    SPECIES_TO_NATIONAL(SCATTERBUG,_ARCHIPELAGO),
    SPECIES_TO_NATIONAL(SCATTERBUG,_HIGH_PLAINS),
    SPECIES_TO_NATIONAL(SCATTERBUG,_SANDSTORM),
    SPECIES_TO_NATIONAL(SCATTERBUG,_RIVER),
    SPECIES_TO_NATIONAL(SCATTERBUG,_MONSOON),
    SPECIES_TO_NATIONAL(SCATTERBUG,_SAVANNA),
    SPECIES_TO_NATIONAL(SCATTERBUG,_SUN),
    SPECIES_TO_NATIONAL(SCATTERBUG,_OCEAN),
    SPECIES_TO_NATIONAL(SCATTERBUG,_JUNGLE),
    SPECIES_TO_NATIONAL(SCATTERBUG,_FANCY),
    SPECIES_TO_NATIONAL(SCATTERBUG,_POKE_BALL),
    SPECIES_TO_NATIONAL(SPEWPA,_ICY_SNOW),
    SPECIES_TO_NATIONAL(SPEWPA,_POLAR),
    SPECIES_TO_NATIONAL(SPEWPA,_TUNDRA),
    SPECIES_TO_NATIONAL(SPEWPA,_CONTINENTAL),
    SPECIES_TO_NATIONAL(SPEWPA,_GARDEN),
    SPECIES_TO_NATIONAL(SPEWPA,_ELEGANT),
    SPECIES_TO_NATIONAL(SPEWPA,_MEADOW),
    SPECIES_TO_NATIONAL(SPEWPA,_MODERN),
    SPECIES_TO_NATIONAL(SPEWPA,_MARINE),
    SPECIES_TO_NATIONAL(SPEWPA,_ARCHIPELAGO),
    SPECIES_TO_NATIONAL(SPEWPA,_HIGH_PLAINS),
    SPECIES_TO_NATIONAL(SPEWPA,_SANDSTORM),
    SPECIES_TO_NATIONAL(SPEWPA,_RIVER),
    SPECIES_TO_NATIONAL(SPEWPA,_MONSOON),
    SPECIES_TO_NATIONAL(SPEWPA,_SAVANNA),
    SPECIES_TO_NATIONAL(SPEWPA,_SUN),
    SPECIES_TO_NATIONAL(SPEWPA,_OCEAN),
    SPECIES_TO_NATIONAL(SPEWPA,_JUNGLE),
    SPECIES_TO_NATIONAL(SPEWPA,_FANCY),
    SPECIES_TO_NATIONAL(SPEWPA,_POKE_BALL),
    SPECIES_TO_NATIONAL(VIVILLON,_ICY_SNOW),
    SPECIES_TO_NATIONAL(VIVILLON,_POLAR),
    SPECIES_TO_NATIONAL(VIVILLON,_TUNDRA),
    SPECIES_TO_NATIONAL(VIVILLON,_CONTINENTAL),
    SPECIES_TO_NATIONAL(VIVILLON,_GARDEN),
    SPECIES_TO_NATIONAL(VIVILLON,_ELEGANT),
    SPECIES_TO_NATIONAL(VIVILLON,_MEADOW),
    SPECIES_TO_NATIONAL(VIVILLON,_MODERN),
    SPECIES_TO_NATIONAL(VIVILLON,_MARINE),
    SPECIES_TO_NATIONAL(VIVILLON,_ARCHIPELAGO),
    SPECIES_TO_NATIONAL(VIVILLON,_HIGH_PLAINS),
    SPECIES_TO_NATIONAL(VIVILLON,_SANDSTORM),
    SPECIES_TO_NATIONAL(VIVILLON,_RIVER),
    SPECIES_TO_NATIONAL(VIVILLON,_MONSOON),
    SPECIES_TO_NATIONAL(VIVILLON,_SAVANNA),
    SPECIES_TO_NATIONAL(VIVILLON,_SUN),
    SPECIES_TO_NATIONAL(VIVILLON,_OCEAN),
    SPECIES_TO_NATIONAL(VIVILLON,_JUNGLE),
    SPECIES_TO_NATIONAL(VIVILLON,_FANCY),
    SPECIES_TO_NATIONAL(VIVILLON,_POKE_BALL),
    SPECIES_TO_NATIONAL(LITLEO),
    SPECIES_TO_NATIONAL(PYROAR),
    SPECIES_TO_NATIONAL(FLABEBE,_RED_FLOWER),
    SPECIES_TO_NATIONAL(FLABEBE,_YELLOW_FLOWER),
    SPECIES_TO_NATIONAL(FLABEBE,_ORANGE_FLOWER),
    SPECIES_TO_NATIONAL(FLABEBE,_BLUE_FLOWER),
    SPECIES_TO_NATIONAL(FLABEBE,_WHITE_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_RED_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_YELLOW_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_ORANGE_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_BLUE_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_WHITE_FLOWER),
    SPECIES_TO_NATIONAL(FLOETTE,_ETERNAL_FLOWER),
    SPECIES_TO_NATIONAL(FLORGES,_RED_FLOWER),
    SPECIES_TO_NATIONAL(FLORGES,_YELLOW_FLOWER),
    SPECIES_TO_NATIONAL(FLORGES,_ORANGE_FLOWER),
    SPECIES_TO_NATIONAL(FLORGES,_BLUE_FLOWER),
    SPECIES_TO_NATIONAL(FLORGES,_WHITE_FLOWER),
    SPECIES_TO_NATIONAL(SKIDDO),
    SPECIES_TO_NATIONAL(GOGOAT),
    SPECIES_TO_NATIONAL(PANCHAM),
    SPECIES_TO_NATIONAL(PANGORO),
    SPECIES_TO_NATIONAL(FURFROU,_NATURAL),
    SPECIES_TO_NATIONAL(FURFROU,_HEART_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_STAR_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_DIAMOND_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_DEBUTANTE_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_MATRON_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_DANDY_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_LA_REINE_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_KABUKI_TRIM),
    SPECIES_TO_NATIONAL(FURFROU,_PHARAOH_TRIM),
    SPECIES_TO_NATIONAL(ESPURR),
    SPECIES_TO_NATIONAL(MEOWSTIC,_MALE),
    SPECIES_TO_NATIONAL(MEOWSTIC,_FEMALE),
    SPECIES_TO_NATIONAL(HONEDGE),
    SPECIES_TO_NATIONAL(DOUBLADE),
    SPECIES_TO_NATIONAL(AEGISLASH,_SHIELD),
    SPECIES_TO_NATIONAL(AEGISLASH,_BLADE),
    ...
    SPECIES_TO_NATIONAL(SLIGGOO,_HISUIAN),
    SPECIES_TO_NATIONAL(GOODRA),
    SPECIES_TO_NATIONAL(GOODRA,_HISUIAN),
    SPECIES_TO_NATIONAL(KLEFKI),
    SPECIES_TO_NATIONAL(PHANTUMP),
    SPECIES_TO_NATIONAL(TREVENANT),
    SPECIES_TO_NATIONAL(PUMPKABOO,_AVERAGE),
    SPECIES_TO_NATIONAL(PUMPKABOO,_SMALL),
    SPECIES_TO_NATIONAL(PUMPKABOO,_LARGE),
    SPECIES_TO_NATIONAL(PUMPKABOO,_SUPER),
    SPECIES_TO_NATIONAL(GOURGEIST,_AVERAGE),
    SPECIES_TO_NATIONAL(GOURGEIST,_SMALL),
    SPECIES_TO_NATIONAL(GOURGEIST,_LARGE),
    SPECIES_TO_NATIONAL(GOURGEIST,_SUPER),
    SPECIES_TO_NATIONAL(BERGMITE),
    SPECIES_TO_NATIONAL(AVALUGG),
    SPECIES_TO_NATIONAL(AVALUGG,_HISUIAN),
    SPECIES_TO_NATIONAL(NOIBAT),
    SPECIES_TO_NATIONAL(NOIVERN),
    SPECIES_TO_NATIONAL(XERNEAS,_NEUTRAL),
    SPECIES_TO_NATIONAL(XERNEAS,_ACTIVE),
    SPECIES_TO_NATIONAL(YVELTAL),
    SPECIES_TO_NATIONAL(ZYGARDE,_50),
    SPECIES_TO_NATIONAL(ZYGARDE,_10),
    SPECIES_TO_NATIONAL(ZYGARDE,_10_POWER_CONSTRUCT),
    SPECIES_TO_NATIONAL(ZYGARDE,_50_POWER_CONSTRUCT),
    SPECIES_TO_NATIONAL(ZYGARDE,_COMPLETE),
    SPECIES_TO_NATIONAL(DIANCIE),
    SPECIES_TO_NATIONAL(DIANCIE,_MEGA),
    SPECIES_TO_NATIONAL(HOOPA,_CONFINED),
    SPECIES_TO_NATIONAL(HOOPA,_UNBOUND),
    ...
    SPECIES_TO_NATIONAL(DECIDUEYE,_HISUIAN),
    ...
    SPECIES_TO_NATIONAL(ORICORIO,_BAILE),
    SPECIES_TO_NATIONAL(ORICORIO,_POM_POM),
    SPECIES_TO_NATIONAL(ORICORIO,_PAU),
    SPECIES_TO_NATIONAL(ORICORIO,_SENSU),
    SPECIES_TO_NATIONAL(CUTIEFLY),
    SPECIES_TO_NATIONAL(RIBOMBEE),
    SPECIES_TO_NATIONAL(ROCKRUFF),
    SPECIES_TO_NATIONAL(ROCKRUFF,_OWN_TEMPO),
    SPECIES_TO_NATIONAL(LYCANROC,_MIDDAY),
    SPECIES_TO_NATIONAL(LYCANROC,_MIDNIGHT),
    SPECIES_TO_NATIONAL(LYCANROC,_DUSK),
    SPECIES_TO_NATIONAL(WISHIWASHI,_SOLO),
    SPECIES_TO_NATIONAL(WISHIWASHI,_SCHOOL),
    ...
    SPECIES_TO_NATIONAL(SILVALLY,_NORMAL),
    SPECIES_TO_NATIONAL(SILVALLY,_FIGHTING),
    SPECIES_TO_NATIONAL(SILVALLY,_FLYING),
    SPECIES_TO_NATIONAL(SILVALLY,_POISON),
    SPECIES_TO_NATIONAL(SILVALLY,_GROUND),
    SPECIES_TO_NATIONAL(SILVALLY,_ROCK),
    SPECIES_TO_NATIONAL(SILVALLY,_BUG),
    SPECIES_TO_NATIONAL(SILVALLY,_GHOST),
    SPECIES_TO_NATIONAL(SILVALLY,_STEEL),
    SPECIES_TO_NATIONAL(SILVALLY,_FIRE),
    SPECIES_TO_NATIONAL(SILVALLY,_WATER),
    SPECIES_TO_NATIONAL(SILVALLY,_GRASS),
    SPECIES_TO_NATIONAL(SILVALLY,_ELECTRIC),
    SPECIES_TO_NATIONAL(SILVALLY,_PSYCHIC),
    SPECIES_TO_NATIONAL(SILVALLY,_ICE),
    SPECIES_TO_NATIONAL(SILVALLY,_DRAGON),
    SPECIES_TO_NATIONAL(SILVALLY,_DARK),
    SPECIES_TO_NATIONAL(SILVALLY,_FAIRY),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_RED),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_ORANGE),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_YELLOW),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_GREEN),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_BLUE),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_INDIGO),
    SPECIES_TO_NATIONAL(MINIOR,_METEOR_VIOLET),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_RED),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_ORANGE),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_YELLOW),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_GREEN),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_BLUE),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_INDIGO),
    SPECIES_TO_NATIONAL(MINIOR,_CORE_VIOLET),
    SPECIES_TO_NATIONAL(KOMALA),
    SPECIES_TO_NATIONAL(TURTONATOR),
    SPECIES_TO_NATIONAL(TOGEDEMARU),
    SPECIES_TO_NATIONAL(MIMIKYU,_DISGUISED),
    SPECIES_TO_NATIONAL(MIMIKYU,_BUSTED),
    ...
    SPECIES_TO_NATIONAL(NECROZMA,_DUSK_MANE),
    SPECIES_TO_NATIONAL(NECROZMA,_DAWN_WINGS),
    SPECIES_TO_NATIONAL(NECROZMA,_ULTRA),
    SPECIES_TO_NATIONAL(MAGEARNA),
    SPECIES_TO_NATIONAL(MAGEARNA,_ORIGINAL_COLOR),
    ...
    SPECIES_TO_NATIONAL(CRAMORANT,_GULPING),
    SPECIES_TO_NATIONAL(CRAMORANT,_GORGING),
    SPECIES_TO_NATIONAL(ARROKUDA),
    SPECIES_TO_NATIONAL(BARRASKEWDA),
    SPECIES_TO_NATIONAL(TOXEL),
    SPECIES_TO_NATIONAL(TOXTRICITY,_AMPED),
    SPECIES_TO_NATIONAL(TOXTRICITY,_LOW_KEY),
    SPECIES_TO_NATIONAL(SIZZLIPEDE),
    SPECIES_TO_NATIONAL(CENTISKORCH),
    SPECIES_TO_NATIONAL(CLOBBOPUS),
    SPECIES_TO_NATIONAL(GRAPPLOCT),
    SPECIES_TO_NATIONAL(SINISTEA,_PHONY),
    SPECIES_TO_NATIONAL(SINISTEA,_ANTIQUE),
    SPECIES_TO_NATIONAL(POLTEAGEIST,_PHONY),
    SPECIES_TO_NATIONAL(POLTEAGEIST,_ANTIQUE),
    ...
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_RUBY_CREAM),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_MATCHA_CREAM),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_MINT_CREAM),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_LEMON_CREAM),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_SALTED_CREAM),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_RUBY_SWIRL),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_CARAMEL_SWIRL),
    SPECIES_TO_NATIONAL(ALCREMIE,_STRAWBERRY_RAINBOW_SWIRL),
    ...
    SPECIES_TO_NATIONAL(EISCUE,_ICE_FACE),
    SPECIES_TO_NATIONAL(EISCUE,_NOICE_FACE),
    SPECIES_TO_NATIONAL(INDEEDEE,_MALE),
    SPECIES_TO_NATIONAL(INDEEDEE,_FEMALE),
    SPECIES_TO_NATIONAL(MORPEKO,_FULL_BELLY),
    SPECIES_TO_NATIONAL(MORPEKO,_HANGRY),
    ...
    SPECIES_TO_NATIONAL(ZACIAN,_HERO_OF_MANY_BATTLES),
    SPECIES_TO_NATIONAL(ZACIAN,_CROWNED_SWORD),
    SPECIES_TO_NATIONAL(ZAMAZENTA,_HERO_OF_MANY_BATTLES),
    SPECIES_TO_NATIONAL(ZAMAZENTA,_CROWNED_SHIELD),
    SPECIES_TO_NATIONAL(ETERNATUS),
    SPECIES_TO_NATIONAL(ETERNATUS,_ETERNAMAX),
    SPECIES_TO_NATIONAL(KUBFU),
    SPECIES_TO_NATIONAL(URSHIFU,_SINGLE_STRIKE_STYLE),
    SPECIES_TO_NATIONAL(URSHIFU,_RAPID_STRIKE_STYLE),
    SPECIES_TO_NATIONAL(ZARUDE),
    SPECIES_TO_NATIONAL(ZARUDE,_DADA),
    ...
    SPECIES_TO_NATIONAL(CALYREX,_ICE_RIDER),
    SPECIES_TO_NATIONAL(CALYREX,_SHADOW_RIDER),
    ...
    SPECIES_TO_NATIONAL(ENAMORUS,_THERIAN),
#endif
};
