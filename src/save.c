...
{
    SAVEBLOCK_CHUNK(struct SaveBlock2, 0),  // 0  // SECTOR_ID_SAVEBLOCK2

    SAVEBLOCK_CHUNK(struct SaveBlock1, 0),  // 1  // SECTOR_ID_SAVEBLOCK1_START
    SAVEBLOCK_CHUNK(struct SaveBlock1, 1),  // 2
    SAVEBLOCK_CHUNK(struct SaveBlock1, 2),  // 3
    SAVEBLOCK_CHUNK(struct SaveBlock1, 3),  // 4
    SAVEBLOCK_CHUNK(struct SaveBlock1, 4),  // 5
    SAVEBLOCK_CHUNK(struct SaveBlock1, 5),  // 6
    SAVEBLOCK_CHUNK(struct SaveBlock1, 6),  // 7
    SAVEBLOCK_CHUNK(struct SaveBlock1, 7),  // 8
    SAVEBLOCK_CHUNK(struct SaveBlock1, 8),  // 9
    SAVEBLOCK_CHUNK(struct SaveBlock1, 9),  // 10 // SECTOR_ID_SAVEBLOCK1_END

    SAVEBLOCK_CHUNK(struct PokemonStorage, 0),  // 11 // SECTOR_ID_PKMN_STORAGE_START
    SAVEBLOCK_CHUNK(struct PokemonStorage, 1),  // 12
    SAVEBLOCK_CHUNK(struct PokemonStorage, 2),  // 13
    SAVEBLOCK_CHUNK(struct PokemonStorage, 3),  // 14
    SAVEBLOCK_CHUNK(struct PokemonStorage, 4),  // 15
    SAVEBLOCK_CHUNK(struct PokemonStorage, 5),  // 16
    SAVEBLOCK_CHUNK(struct PokemonStorage, 6),  // 17
    SAVEBLOCK_CHUNK(struct PokemonStorage, 7),  // 18
    SAVEBLOCK_CHUNK(struct PokemonStorage, 8),  // 19
    SAVEBLOCK_CHUNK(struct PokemonStorage, 9),  // 20
    SAVEBLOCK_CHUNK(struct PokemonStorage, 10), // 21
    SAVEBLOCK_CHUNK(struct PokemonStorage, 11), // 22
    SAVEBLOCK_CHUNK(struct PokemonStorage, 12), // 23
    SAVEBLOCK_CHUNK(struct PokemonStorage, 13), // 24
    SAVEBLOCK_CHUNK(struct PokemonStorage, 14), // 25
    SAVEBLOCK_CHUNK(struct PokemonStorage, 15), // 26
    SAVEBLOCK_CHUNK(struct PokemonStorage, 16), // 27 SECTOR_ID_PKMN_STORAGE_END
};
