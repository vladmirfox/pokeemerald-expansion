...
static void CreateGridSprites(void)
{
    ...
    DecompressDataWithHeaderWram(sSpriteSheet_Headers.data, gDecompressionBuffer);
    s.data = gDecompressionBuffer;
    s.size = sSpriteSheet_Headers.size;
    s.tag  = sSpriteSheet_Headers.tag;
    LoadSpriteSheet(&s);
    DecompressDataWithHeaderWram(sSpriteSheet_GridIcons.data, gDecompressionBuffer);
    s.data = gDecompressionBuffer;
...
static void CreateWheelIconSprites(void)
{
    ...
    DecompressDataWithHeaderWram(sSpriteSheet_WheelIcons.data, gDecompressionBuffer);
    s.data = gDecompressionBuffer;
...
static void CreateInterfaceSprites(void)
{
    ...
    {
        struct SpriteSheet s;
        DecompressDataWithHeaderWram(sSpriteSheets_Interface[i].data, gDecompressionBuffer);
        s.data = gDecompressionBuffer;
...
static void CreateWheelCenterSprite(void)
{
    u8 spriteId;
    struct SpriteSheet s;
    DecompressDataWithHeaderWram(sSpriteSheet_WheelCenter.data, gDecompressionBuffer);
    s.data = gDecompressionBuffer;
