...
{
    u32 moveIndex;
    u32 opposingBattler = GetOppositeBattlerPosition(battler);
    u32 aiMove;
...
static bool32 FindMonThatAbsorbsOpponentsMove(u32 battler)
{
    ...
    {
        battlerIn1 = battler;
        if (gAbsentBattlerFlags & (1u << GetPartnerBattlerPosition(battler)))
            battlerIn2 = battler;
        else
            battlerIn2 = GetPartnerBattlerPosition(battler);
    }
    else
    {
        battlerIn1 = battler;
...
static bool32 ShouldSwitchIfTrapperInParty(u32 battler)
{
    ...
    s32 i;
    u16 monAbility;
    s32 opposingBattler =  GetOppositeBattlerPosition(battler);
...
u32 GetMostSuitableMonToSwitchInto(u32 battler, enum SwitchType switchType)
{
    ...
    {
        opposingBattler = GetOppositeBattlerPosition(battler);
        battlerIn1 = battler;
        battlerIn2 = battler;
    }
