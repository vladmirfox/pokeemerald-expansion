...
static void PrintStatsScreen_Moves_Top(u8 taskId)
{
    ...
    //Move name
    StringCopy(gStringVar3, GetBattleMoveName(move));
    ...
    {
        SetTypeIconPosAndPal(NUMBER_OF_MON_TYPES + gBattleMoves[move].contestCategory, moves_x + 146, moves_y + 17, 1);
        SetSpriteInvisibility(0, TRUE);
    }
...
static void PrintStatsScreen_Moves_Description(u8 taskId)
{
    ...
    if (gTasks[taskId].data[5] == 0)
    {
        StringCopy(gStringVar4, gBattleMoves[move].description);
        PrintStatsScreenTextSmall(WIN_STATS_MOVES_DESCRIPTION, gStringVar4, moves_x, moves_y);
    }
    else
    {
        StringCopy(gStringVar4, gContestEffectDescriptionPointers[gBattleMoves[move].contestEffect]);
        PrintStatsScreenTextSmall(WIN_STATS_MOVES_DESCRIPTION, gStringVar4, moves_x, moves_y);
    }
}
...
static void PrintStatsScreen_Moves_Bottom(u8 taskId)
{
    ...
    else //Appeal + Jam
    {
        ...
        //Appeal
        contest_effectValue = gContestEffects[gBattleMoves[move].contestEffect].appeal;
        ...
        //Jam
        contest_effectValue = gContestEffects[gBattleMoves[move].contestEffect].jam;
        if (contest_effectValue != 0xFF)
...
static u8 PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u8 depth_i)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        case EVO_ITEM_HOLD_NIGHT:
            ...
            break;
        case EVO_MOVE:
            StringCopy(gStringVar2, GetBattleMoveName(evolutions[i].param));
