...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_MANTYKE]                      = CONVEX_DOUBLE_ARC,
    ...
    [SPECIES_MAMOSWINE]                    = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_HEATRAN]                      = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_REGIGIGAS]                    = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_ZEBSTRIKA]                    = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_FERROSEED]                    = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_DARMANITAN_ZEN_MODE]          = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_KELDEO_RESOLUTE]              = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_DELPHOX]                      = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_CLAWITZER]                    = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_TYRANTRUM]                    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_AMAURA]                       = BACK_ANIM_H_SLIDE,
    [SPECIES_AURORUS]                      = BACK_ANIM_DIP_RIGHT_SIDE,
