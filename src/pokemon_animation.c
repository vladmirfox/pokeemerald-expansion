...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_IROH]                         = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_UMBREON]                      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_MEI]                          = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ZUKO]                         = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_SOKKA]                        = BACK_ANIM_SHRINK_GROW_VIBRATE,
