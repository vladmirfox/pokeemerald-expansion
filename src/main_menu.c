...
static const u8 gText_MainMenuNewGame[] = _("START A NEW GAME");
static const u8 gText_MainMenuContinue[] = _("CONTINUE");
static const u8 gText_MainMenuOption[] = _("OPTION MENU");
...
static const u8 gText_ContinueMenuPlayer[] = _("PLAYER NAME");
static const u8 gText_ContinueMenuTime[] = _("LIFE WASTED");
