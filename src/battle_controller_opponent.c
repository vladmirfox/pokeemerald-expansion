...
static const u16 naturalEnemies[][3] =
{
    ...
    {SPECIES_PERSIAN,        SPECIES_STARLY},
    {SPECIES_GRIMER,         SPECIES_TRUBBISH},
    {SPECIES_MUK,            SPECIES_TRUBBISH},
    ...
    {SPECIES_LANTURN,        SPECIES_STARYU},
    {SPECIES_AIPOM,          SPECIES_BOUNSWEET},
    {SPECIES_SNEASEL,        SPECIES_PIDGEY},
    {SPECIES_SNEASEL,        SPECIES_DELIBIRD},
    ...
    {SPECIES_WEAVILE,        SPECIES_SANDSHREW},
    ...
    {SPECIES_GUMSHOOS,       SPECIES_RATICATE},
    ...
    {SPECIES_APPLETUN,       SPECIES_COMBEE},
    ...
    {SPECIES_STARLY,         SPECIES_SCATTERBUG},
    {SPECIES_LUMINEON,       SPECIES_STARMIE},
    {SPECIES_WEAVILE,        SPECIES_VULPIX},
    {SPECIES_SCOLIPEDE,      SPECIES_CENTISKORCH},
    {SPECIES_DARUMAKA,       SPECIES_SNOVER},
    ...
    {SPECIES_APPLETUN,       SPECIES_CUTIEFLY},
    ...
    {SPECIES_KINGDRA,        SPECIES_DRAGONITE},
    ...
    {SPECIES_CORVIKNIGHT,    SPECIES_SKARMORY},
    {SPECIES_GABITE,         SPECIES_SABLEYE},
    {SPECIES_GARCHOMP,       SPECIES_SALAMENCE},
    {SPECIES_SIZZLIPEDE,     SPECIES_VENIPEDE},
