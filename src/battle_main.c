...
static const u16 sTrainerBallTable[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_KINDLER] = ITEM_PREMIER_BALL,
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = ITEM_REPEAT_BALL,
    ...
    [TRAINER_CLASS_PARASOL_LADY] = ITEM_LOVE_BALL,
    ...
    [TRAINER_CLASS_TWINS] = ITEM_FRIEND_BALL,
    [TRAINER_CLASS_YOUNG_COUPLE] = ITEM_LOVE_BALL,
    [TRAINER_CLASS_YOUNGSTER] = ITEM_POKE_BALL,
    [TRAINER_CLASS_WINSTRATE] = ITEM_GREAT_BALL,    // probably repurpose Winstrate trainer class
};
#endif
