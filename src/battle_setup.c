...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_LIIKA, TRAINER_LIIKA, TRAINER_LIIKA, TRAINER_LIIKA, TRAINER_LIIKA, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_BABAR, TRAINER_BABAR, TRAINER_BABAR, TRAINER_BABAR, TRAINER_BABAR, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GRUNGE, TRAINER_GRUNGE, TRAINER_GRUNGE, TRAINER_GRUNGE, TRAINER_GRUNGE, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_NEITH, TRAINER_NEITH, TRAINER_NEITH, TRAINER_NEITH, TRAINER_NEITH, EVER_GRANDE_CITY),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    {
        if (gTrainerBattleOpponent_A == TRAINER_LIIKA)
            return B_TRANSITION_SIDNEY;
        if (gTrainerBattleOpponent_A == TRAINER_BABAR)
            return B_TRANSITION_PHOEBE;
        if (gTrainerBattleOpponent_A == TRAINER_GRUNGE)
            return B_TRANSITION_GLACIA;
        if (gTrainerBattleOpponent_A == TRAINER_NEITH)
