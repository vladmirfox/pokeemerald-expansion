...
static const u8 sText_HoldEffectAssaultCoat[] = _("Assault Coat");
...
static const u8 sText_HoldEffectPocketSand[] = _("Pocket Sand");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_ASSAULT_COAT] = sText_HoldEffectAssaultCoat,
    ...
    [HOLD_EFFECT_POCKET_SAND] = sText_HoldEffectPocketSand,
