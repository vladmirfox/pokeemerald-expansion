...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar Shadow
    ...
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(0.5), ______, ______},
    ...
    [TYPE_ICE]      = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, ______, ______},
...
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), ______, ______},
#else
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), ______, ______},
#endif
    ...
    [TYPE_SHADOW]   = {X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(0.5), ______},
};
