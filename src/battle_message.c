...
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} snapped out of\nits confusion!");
...
static const u8 sText_PkmnMoveBounced[] = _("{B_DEF_NAME_WITH_PREFIX}\nbounced the {B_CURRENT_MOVE} back!");
