...
static const u8 sText_TanglingHairTraps[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ntrapped {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_HealerLefties[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nrestored {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s health!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_HEALERLEFTIES - BATTLESTRINGS_TABLE_START] = sText_HealerLefties,
    ...
    [STRINGID_TANGLINGHAIRTRAPS - BATTLESTRINGS_TABLE_START] = sText_TanglingHairTraps,
};
