...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNGOTFROSTBITEFROM]                 = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} got frostbite from {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_PKMNGREWDROWSY]                       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} grew drowsy!"),
    [STRINGID_PKMNGREWDROWSYFROM]                   = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} grew drowsy from {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_PKMNISTOODROWSY]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is too drowsy to move!"),
    [STRINGID_PKMNSITEMFOUGHTOFFDROWSINESS]         = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM} fought off its drowsiness!"),
