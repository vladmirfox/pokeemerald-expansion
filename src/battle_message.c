...
static const u8 sText_PkmnHurtByPoison[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is hurt\nby poison!");
...
static const u8 sText_PkmnHurtByBurn[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is hurt\nby its burn!");
static const u8 sText_PkmnHurtByFrostbite[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is hurt\nby its frostbite!");
...
static const u8 sText_PkmnBuffetedBySandstorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is buffeted\nby the sandstorm!");
static const u8 sText_PkmnPeltedByHail[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is pelted\nby HAIL!");
...
static const u8 sText_PkmnLockedInNightmare[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is locked\nin a NIGHTMARE!");
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} cut its own HP and\nlaid a CURSE on {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is afflicted\nby the CURSE!");
...
static const u8 sText_PoisonHealHpUp[] = _("The poisoning healed {B_SCR_ACTIVE_NAME_WITH_PREFIX}\na little bit!");
...
static const u8 sText_HurtByTheSeaOfFire[] = _("{B_ATK_TEAM1} {B_SCR_ACTIVE_NAME_WITH_PREFIX} was hurt\nby the sea of fire!");
