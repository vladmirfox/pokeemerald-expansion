...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ATTACKMISSED - BATTLESTRINGS_TABLE_START]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s attack missed!"), //this is not in SV for some reason?
    ...
    [STRINGID_GOTAWAYSAFELY - BATTLESTRINGS_TABLE_START]                        = COMPOUND_STRING("{PLAY_SE SE_FLEE}You got away safely!\p"),
    ...
    [STRINGID_PLAYERDEFEATEDTRAINER1 - BATTLESTRINGS_TABLE_START]               = COMPOUND_STRING("You defeated {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p"),
