...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_POCKETSANDACTIVATES]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s Acc was lowered by {B_DEF_NAME_WITH_PREFIX2}'s Pocket Sand!"),
    ...
    [STRINGID_ASSAULTCOATDOESNTALLOW]               = COMPOUND_STRING("The effects of the {B_LAST_ITEM} prevent status moves from being used!\p"),
