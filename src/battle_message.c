...
static const u8 sText_PkmnGotFrostbiteFrom[] = _("{B_EFF_NAME_WITH_PREFIX} got frostbite from {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}!");
...
static const u8 sText_PkmnGrewDowsyFrom[] = _("{B_EFF_NAME_WITH_PREFIX} grew drowsy from {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} couldn't move because it's paralyzed!");
static const u8 sText_PkmnIsTooDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} is too drowsy to move!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} is already paralyzed!");
static const u8 sText_PkmnIsAlreadyDrowsy[] = _("{B_DEF_NAME_WITH_PREFIX} is already drowsy.");
static const u8 sText_PkmnHealedParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} was cured of paralysis!");
static const u8 sText_PkmnFoughtOffDrowsiness[] = _("{B_DEF_NAME_WITH_PREFIX} fought off its drowsiness!");
...
static const u8 sText_PkmnsItemFoughtOffDrowsiness[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM} fought off its drowsiness!");
