...
static const u8 sText_ShortFuseEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} has a short fuse!");
...
static const u8 sText_ShowdownModeHpDrop[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ntakes its toll!");
static const u8 sText_ShockThreadsHpDrop[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ntakes its toll!");
...
static const u8 sText_ShadowWeave[] = _("{B_ATK_NAME_WITH_PREFIX} is weaving too quickly to be hit!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SHADOWWEAVE - BATTLESTRINGS_TABLE_START] = sText_ShadowWeave,
    ...
    [STRINGID_SHORTFUSEENTERS - BATTLESTRINGS_TABLE_START] = sText_ShortFuseEnters,
    ...
    [STRINGID_SHOWDOWNMODEHPDROP - BATTLESTRINGS_TABLE_START] = sText_ShowdownModeHpDrop,
    [STRINGID_SHOCKTHREADSHPDROP - BATTLESTRINGS_TABLE_START] = sText_ShockThreadsHpDrop,
