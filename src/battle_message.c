...
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\n{B_BUFF1} paralyzed\n{B_EFF_NAME_WITH_PREFIX2},\lso it may be unable to move!"); //not in gen 5+, ability popup
