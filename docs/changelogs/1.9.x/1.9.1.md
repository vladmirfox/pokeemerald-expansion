...
* Fixed Defiant/Competitive not working if the battler enters the field with a Court Changed Sticky Web on its side of the field by @PhallenTree in [#5093](https://github.com/rh-hideout/pokeemerald-expansion/pull/5093)
...
* Fixed Retaliate not working correctly if the party member fainted via passive damage by @hedara90 in [#5182](https://github.com/rh-hideout/pokeemerald-expansion/pull/5182)
