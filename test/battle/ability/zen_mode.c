...
SINGLE_BATTLE_TEST("Zen Mode switches Darmanitan's form when HP is half or less at the end of the turn")
{
    ...
    PARAMETRIZE { standardSpecies = SPECIES_DARMANITAN_STANDARD_MODE;          zenSpecies = SPECIES_DARMANITAN_ZEN; }
    PARAMETRIZE { standardSpecies = SPECIES_DARMANITAN_GALAR_STANDARD_MODE; zenSpecies = SPECIES_DARMANITAN_GALAR_ZEN_MODE; }
