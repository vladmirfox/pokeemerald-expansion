...
SINGLE_BATTLE_TEST("(DYNAMAX) Max Strike lowers single opponent's speed")
{
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_STRIKE) == MAX_EFFECT_LOWER_SPEED);
        OPPONENT(SPECIES_WOBBUFFET) { Speed(100); }
...
DOUBLE_BATTLE_TEST("(DYNAMAX) Max Knuckle raises both allies' attack")
{
    s16 damage[4];
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_KNUCKLE) == MAX_EFFECT_RAISE_TEAM_ATTACK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_FLARE) == MAX_EFFECT_SUN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_GEYSER) == MAX_EFFECT_RAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_HAILSTORM) == MAX_EFFECT_HAIL);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_ROCKFALL) == MAX_EFFECT_SANDSTORM);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
SINGLE_BATTLE_TEST("(DYNAMAX) Max Overgrowth sets up Grassy Terrain")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_OVERGROWTH) == MAX_EFFECT_GRASSY_TERRAIN);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_MINDSTORM) == MAX_EFFECT_PSYCHIC_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_LIGHTNING) == MAX_EFFECT_ELECTRIC_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_STARFALL) == MAX_EFFECT_MISTY_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STONESURGE) == MAX_EFFECT_STEALTH_ROCK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STEELSURGE) == MAX_EFFECT_STEELSURGE);
...
SINGLE_BATTLE_TEST("(DYNAMAX) G-Max Hydrosnipe has fixed power and ignores abilities", s16 damage)
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_HYDROSNIPE) == MAX_EFFECT_FIXED_POWER);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_VOLT_CRASH) == MAX_EFFECT_PARALYZE_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Stun Shock paralyzes or poisons both opponents")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STUN_SHOCK) == MAX_EFFECT_POISON_PARALYZE_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Befuddle paralyzes, poisons, or sleeps both opponents")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_BEFUDDLE) == MAX_EFFECT_EFFECT_SPORE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_GOLD_RUSH) == MAX_EFFECT_CONFUSE_FOES_PAY_DAY);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SMITE) == MAX_EFFECT_CONFUSE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CUDDLE) == MAX_EFFECT_INFATUATE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_TERROR) == MAX_EFFECT_MEAN_LOOK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_MELTDOWN) == MAX_EFFECT_TORMENT_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Wildfire sets a field effect that damages non-Fire types")
{
    s16 damage;
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_WILDFIRE) == MAX_EFFECT_WILDFIRE);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Replenish recycles allies' berries 50\% of the time")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_REPLENISH) == MAX_EFFECT_RECYCLE_BERRIES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Snooze makes only the target drowsy")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SNOOZE) == MAX_EFFECT_YAWN_FOE);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Finale heals allies by 1/6 of their health")
{
    s16 damage1, damage2;
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_FINALE) == MAX_EFFECT_HEAL_TEAM);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SWEETNESS) == MAX_EFFECT_AROMATHERAPY);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CENTIFERNO) == MAX_EFFECT_FIRE_SPIN_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Chi Strike boosts allies' crit chance")
{
    ...
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CHI_STRIKE) == MAX_EFFECT_CRIT_PLUS);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Depletion takes away 2 PP from the target's last move")
{
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_DEPLETION) == MAX_EFFECT_SPITE);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max One Blow bypasses Max Guard for full damage", s16 damage)
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_ONE_BLOW) == MAX_EFFECT_BYPASS_PROTECT);
