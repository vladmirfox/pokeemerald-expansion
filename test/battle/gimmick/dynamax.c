...
SINGLE_BATTLE_TEST("(DYNAMAX) Max Strike lowers single opponent's speed")
{
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_STRIKE) == MOVE_EFFECT_LOWER_SPEED);
        OPPONENT(SPECIES_WOBBUFFET) { Speed(100); }
...
DOUBLE_BATTLE_TEST("(DYNAMAX) Max Knuckle raises both allies' attack")
{
    s16 damage[4];
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_KNUCKLE) == MOVE_EFFECT_RAISE_TEAM_ATTACK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_FLARE) == MOVE_EFFECT_SUN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_GEYSER) == MOVE_EFFECT_RAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_HAILSTORM) == MOVE_EFFECT_HAIL);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_ROCKFALL) == MOVE_EFFECT_SANDSTORM);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
SINGLE_BATTLE_TEST("(DYNAMAX) Max Overgrowth sets up Grassy Terrain")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_OVERGROWTH) == MOVE_EFFECT_GRASSY_TERRAIN);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_MINDSTORM) == MOVE_EFFECT_PSYCHIC_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_LIGHTNING) == MOVE_EFFECT_ELECTRIC_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_MAX_STARFALL) == MOVE_EFFECT_MISTY_TERRAIN);
        OPPONENT(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
    } WHEN {
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STONESURGE) == MOVE_EFFECT_STEALTH_ROCK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STEELSURGE) == MOVE_EFFECT_STEELSURGE);
...
SINGLE_BATTLE_TEST("(DYNAMAX) G-Max Hydrosnipe has fixed power and ignores abilities", s16 damage)
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_HYDROSNIPE) == MOVE_EFFECT_FIXED_POWER);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_VOLT_CRASH) == MOVE_EFFECT_PARALYZE_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Stun Shock paralyzes or poisons both opponents")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_STUN_SHOCK) == MOVE_EFFECT_POISON_PARALYZE_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Befuddle paralyzes, poisons, or sleeps both opponents")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_BEFUDDLE) == MOVE_EFFECT_EFFECT_SPORE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_GOLD_RUSH) == MOVE_EFFECT_CONFUSE_FOES_PAY_DAY);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SMITE) == MOVE_EFFECT_CONFUSE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CUDDLE) == MOVE_EFFECT_INFATUATE_FOES);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_TERROR) == MOVE_EFFECT_MEAN_LOOK);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_MELTDOWN) == MOVE_EFFECT_TORMENT_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Wildfire sets a field effect that damages non-Fire types")
{
    s16 damage;
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_WILDFIRE) == MOVE_EFFECT_WILDFIRE);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Replenish recycles allies' berries 50\% of the time")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_REPLENISH) == MOVE_EFFECT_RECYCLE_BERRIES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Snooze makes only the target drowsy")
{
    ...
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SNOOZE) == MOVE_EFFECT_YAWN_FOE);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Finale heals allies by 1/6 of their health")
{
    s16 damage1, damage2;
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_FINALE) == MOVE_EFFECT_HEAL_TEAM);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_SWEETNESS) == MOVE_EFFECT_AROMATHERAPY);
...
{
    GIVEN {
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CENTIFERNO) == MOVE_EFFECT_FIRE_SPIN_FOES);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Chi Strike boosts allies' crit chance")
{
    ...
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_CHI_STRIKE) == MOVE_EFFECT_CRIT_PLUS);
...
DOUBLE_BATTLE_TEST("(DYNAMAX) G-Max Depletion takes away 2 PP from the target's last move")
{
    GIVEN {
        ...
        // ASSUME(GetArgumentMoveEffect(MOVE_G_MAX_DEPLETION) == MOVE_EFFECT_SPITE);
