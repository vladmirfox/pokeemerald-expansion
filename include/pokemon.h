...
struct SpeciesInfo /*0x55*/
{
 ...
 /* 0x2C */ u16 natDexNum;
 /* 0x2E */ u16 equivalentDexEntry; // To avoid duplicating dex entries like for Scatterbug
 /* 0x30 */ u16 cryId;
 /* 0x32 */ u16 height; //in decimeters
 /* 0x34 */ u16 weight; //in hectograms
 /* 0x36 */ u16 pokemonScale;
 /* 0x38 */ u16 pokemonOffset;
 /* 0x3A */ u16 trainerScale;
