...
// Multiple SaveBlock configs
#define FREE_EXTRA_SEEN_FLAGS               FALSE   // Free up unused Pokédex seen flags (SaveBlock1: 52 bytes, SaveBlock2: 108 bytes).
                                            // SaveBlock1/2 total: 160 bytes
