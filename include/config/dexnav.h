...
// Flag/var defines
#define FLAG_SYS_DEXNAV_SEARCH          FLAG_SYS_DEXNAV_SEARCH // Searching for mon
#define FLAG_SYS_DEXNAV_GET             FLAG_SYS_DEXNAV_GET // Dexnav shows in start menu
#define FLAG_SYS_DETECTOR_MODE          FLAG_SYS_DETECTOR_MODE // Allow player to find hidden mons
#define VAR_DEXNAV_SPECIES              VAR_DEXNAV_SPECIES // Registered dexnav species
#define VAR_DEXNAV_STEP_COUNTER         VAR_DEXNAV_STEP_COUNTER // Steps for finding hidden pokemon
