...
#define OW_FLAG_USE_FLY_FROM_POKENAV 0  // If this flag is set, the player will be able to use fly from the Pokenav Region Map section by pressing 'R' on a city/location they have been to.
