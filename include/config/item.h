...
#define I_PREMIER_BALL_BONUS            GEN_LATEST  // In Gen7+, starting with Pokémon LGPE, you are given a Premier Ball for every 10 Poké Balls of any type and in the same purchase. Previously, it only applied to regular Poké Balls and only 1 could be obtained per purchase.
