...
#define I_GRISEOUS_ORB_FORM_CHANGE      GEN_4       // In Gen9+, the Griseous Orb no longer changes Giratina's form when held. Do so using the Griseous Core instead.
...
#define I_EXP_SHARE_FLAG        FLAG_SYS_EXP_SHARE_ON // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
