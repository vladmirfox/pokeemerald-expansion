...
// Item config
#define I_SHINY_CHARM_ADDITIONAL_ROLLS  2           // Amount of additional shiny rolls if the player has the Shiny Charm. Set it to 0 to disable Shiny Charm's effects. MIGHT CHANGE
...
#define I_GEM_BOOST_POWER               GEN_6  // In Gen5+, the Gem boost power was reduced from 50% to 30%.
...
// Eg: Replace with FLAG_UNUSED_0x264 so you can use that flag to toggle the feature. MIGHT CHANGE
