...
#define I_KEY_ESCAPE_ROPE               FALSE       // In Gen8, Escape Rope became a Key Item. Keep in mind, this will make it free to buy in marts.
...
#define VAR_LAST_REPEL_LURE_USED    VAR_USE_LAST_REPEL // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
