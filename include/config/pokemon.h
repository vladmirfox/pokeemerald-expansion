...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_LATEST  // In Gen 8+, Pokemon evolving while at level 1 does not get the chance to learn their level 1 moves, while before they did.
