...
#define P_DEX_REGIONAL_DEX_NUMBER_0 FALSE       // If TRUE, the Regional Dex will have an entry for N°000, like in Gen 5. This is visual-only effect. Internally, the numbers still correspond to the proper value.
