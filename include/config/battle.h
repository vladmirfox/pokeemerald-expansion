...
#define B_WILD_NATURAL_ENEMIES_POKEDEX  FALSE      // If set to TRUE and B_WILD_NATURAL_ENEMIES is set to TRUE, a larger list of wild mon species will attack other species when partner in double wild battle, as referenced in the Pokédex (eg. Frigibax vs Bergmite)
