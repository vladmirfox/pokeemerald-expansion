...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_DOUBLE_WILD_BATTLE     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        0     // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           FLAG_BAG_DISABLED     // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          FLAG_CATCHING_DISABLED     // If this flag is set, the ability to catch wild Pokémon is disabled.
