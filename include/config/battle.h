...
#define B_CATCH_SWAP_INTO_PARTY     FALSE // If set to TRUE, the option to swap the caught wild mon to the party will appear, allowing you to send a different mon to the box.
