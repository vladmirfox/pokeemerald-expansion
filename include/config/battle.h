...
#define B_USE_DROWSY                    FALSE      // In PLA, Drowsy replaces Sleep. Enabling this flag does the same here. Moves can still be cherry-picked to either Sleep or Drowsy.
