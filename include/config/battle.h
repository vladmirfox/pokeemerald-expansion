...
#define B_USE_DROWSY                    FALSE      // In PLA, Drowsy replaces Sleep. Enabling this flag does the same here. Moves can still be cherry-picked to either Sleep or Drowsy.  Yawn, Dark Void, Rest, Secret Power, Dire Claw, Relic Song and most moves that just cause sleep depend on this config
