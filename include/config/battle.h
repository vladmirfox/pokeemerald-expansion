...
#define B_CONTACT_ABILITIES_CHANCE  GEN_LATEST // In Gen3, Cute Charm, Flame Body, Static and Poison Point have a 1/3 chance to trigger. In Gen 4+ it's 30%.
#define B_EFFECT_SPORE_CHANCES      GEN_LATEST // In Gen3, Effect Spore has a 10% chance to sleep, poison or paralyze, with an equal chance.
