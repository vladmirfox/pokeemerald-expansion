...
#define B_NUM_LOW_HEALTH_BEEPS          4          // will loop the "low health" beep the specified amount of times. 4 is current gen default. needs a `make && make clean` after to take effect
