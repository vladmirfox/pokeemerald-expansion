...
#define EC_POKEMON(mon) ((EC_GROUP_POKEMON << EC_MASK_BITS) | NATIONAL_DEX_##mon)
#define EC_POKEMON_NATIONAL(mon) ((EC_GROUP_POKEMON_NATIONAL << EC_MASK_BITS) | NATIONAL_DEX_##mon)
