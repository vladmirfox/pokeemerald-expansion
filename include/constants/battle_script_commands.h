...
#define VARIOUS_JUMP_IF_MOVE_HAS_CHARGE_TURN_EFFECTS 62
...
#define VARIOUS_JUMP_IF_WEATHER_MOVE_ARG             118
...
#define VARIOUS_TRY_SKIP_CHARGE_TURN_ATTACK_STRING   151
