...
#define STATUS1_DROWSY           (1 << 13)
#define STATUS1_PSN_ANY          (STATUS1_POISON | STATUS1_TOXIC_POISON)
#define STATUS1_ANY              (STATUS1_SLEEP | STATUS1_POISON | STATUS1_BURN | STATUS1_FREEZE | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_FROSTBITE | STATUS1_DROWSY)

#define STATUS1_REFRESH          (STATUS1_POISON | STATUS1_BURN | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_FROSTBITE | STATUS1_DROWSY)
...
#define MOVE_EFFECT_DROWSY              8
#define PRIMARY_STATUS_MOVE_EFFECT      MOVE_EFFECT_DROWSY // All above move effects apply primary status
...
#endif
#if B_USE_DROWSY == TRUE
#define MOVE_EFFECT_SLEEP_OR_DROWSY MOVE_EFFECT_DROWSY
#else
#define MOVE_EFFECT_SLEEP_OR_DROWSY MOVE_EFFECT_SLEEP
#endif
