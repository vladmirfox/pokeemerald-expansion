...
// Shadow Sky
#define B_WEATHER_SHADOW_SKY_TEMPORARY      (1 << 14)
#define B_WEATHER_SHADOW_SKY_PERMANENT      (1 << 15)
#define B_WEATHER_SHADOW_SKY                (B_WEATHER_SHADOW_SKY_TEMPORARY | B_WEATHER_SHADOW_SKY_PERMANENT)
// Weather Any
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_SHADOW_SKY)
...
#define ENUM_WEATHER_SHADOW_SKY           9
