...
enum MoveEffects
{
    ...
    MOVE_EFFECT_LOWER_ATTACK_FOES,
    MOVE_EFFECT_LOWER_DEFENSE_FOES,
    MOVE_EFFECT_LOWER_SPEED_FOES,
    MOVE_EFFECT_LOWER_SP_ATK_FOES,
    MOVE_EFFECT_LOWER_SP_DEF_FOES,
    MOVE_EFFECT_SUN,
    MOVE_EFFECT_RAIN,
    ...
    MOVE_EFFECT_EFFECT_SPORE_FOES,
    MOVE_EFFECT_PARALYZE_FOES,
    MOVE_EFFECT_CONFUSE_FOES_PAY_DAY,
    MOVE_EFFECT_CRIT_PLUS,
    MOVE_EFFECT_MEAN_LOOK,
    MOVE_EFFECT_AURORA_VEIL,
    MOVE_EFFECT_INFATUATE_FOES,
    MOVE_EFFECT_RECYCLE_BERRIES,
    MOVE_EFFECT_POISON_FOES,
    MOVE_EFFECT_DEFOG,
    MOVE_EFFECT_POISON_PARALYZE_FOES,
    MOVE_EFFECT_HEAL_TEAM,
    MOVE_EFFECT_SPITE,
    MOVE_EFFECT_GRAVITY,
    MOVE_EFFECT_VOLCALITH,
    MOVE_EFFECT_SANDBLAST_FOES,
    MOVE_EFFECT_YAWN_FOE,
    MOVE_EFFECT_LOWER_EVASIVENESS_FOES,
    MOVE_EFFECT_AROMATHERAPY,
    MOVE_EFFECT_CONFUSE_FOES,
    MOVE_EFFECT_STEELSURGE,
    MOVE_EFFECT_TORMENT_FOES,
    MOVE_EFFECT_LOWER_SPEED_2_FOES,
    MOVE_EFFECT_FIRE_SPIN_FOES,
    MOVE_EFFECT_FIXED_POWER,
    MOVE_EFFECT_BYPASS_PROTECT,
    NUM_MOVE_EFFECTS
};
