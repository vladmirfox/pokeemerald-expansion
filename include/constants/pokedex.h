...
enum {
    ...
    SHADOW_LIST_NUMEL,
    SHADOW_LIST_CARVANHA,
    SHADOW_LIST_SHROOMISH,
    SHADOW_LIST_HOUNDOUR,
    SHADOW_LIST_BALTOY,
    SHADOW_LIST_MAREEP,
    SHADOW_LIST_SEEDOT,
    SHADOW_LIST_SPHEAL,
    SHADOW_LIST_GULPIN,
    SHADOW_LIST_DELCATTY,
    SHADOW_LIST_MAKUHITA_1,
    SHADOW_LIST_MAKUHITA_2,
    SHADOW_LIST_VULPIX,
    SHADOW_LIST_VOLTORB,
    SHADOW_LIST_DUSKULL,
    SHADOW_LIST_REMORAID,
    SHADOW_LIST_RALTS,
    SHADOW_LIST_SNORUNT,
    SHADOW_LIST_PINECO,
    SHADOW_LIST_MAWILE,
    ...
    SHADOW_LIST_GRIMER,
    SHADOW_LIST_SEEL,
    SHADOW_LIST_LUNATONE,
    SHADOW_LIST_TOGEPI,
    SHADOW_LIST_NOSEPASS,
    SHADOW_LIST_ZANGOOSE,
    SHADOW_LIST_PARAS,
    SHADOW_LIST_GROWLITHE,
    SHADOW_LIST_SHELLDER,
    SHADOW_LIST_BAYLEEF,
    SHADOW_LIST_QUILAVA,
    SHADOW_LIST_CROCONAW,
    SHADOW_LIST_SLUGMA,
    SHADOW_LIST_NOCTOWL,
    SHADOW_LIST_FLAAFFY,
    SHADOW_LIST_SKIPLOOM,
    SHADOW_LIST_QUAGSIRE,
    SHADOW_LIST_MISDREAVUS,
    SHADOW_LIST_BEEDRILL,
    SHADOW_LIST_PIDGEOTTO,
    SHADOW_LIST_TANGELA,
    SHADOW_LIST_BUTTERFREE,
    SHADOW_LIST_MAGNETON,
    SHADOW_LIST_VENOMOTH,
    SHADOW_LIST_WEEPINBELL,
    SHADOW_LIST_FURRET,
    SHADOW_LIST_YANMA,
    SHADOW_LIST_MANTINE,
    SHADOW_LIST_QWILFISH,
    SHADOW_LIST_MEDITITE,
    SHADOW_LIST_DUNSPARCE,
    SHADOW_LIST_SWABLU,
    SHADOW_LIST_ARBOK,
    SHADOW_LIST_GOLDUCK,
    SHADOW_LIST_SABLEYE,
    SHADOW_LIST_PRIMEAPE,
    SHADOW_LIST_HYPNO,
    SHADOW_LIST_DODRIO,
    SHADOW_LIST_RATICATE,
    SHADOW_LIST_SUDOWOODO,
    SHADOW_LIST_KANGASKHAN,
    SHADOW_LIST_PINSIR,
    SHADOW_LIST_FARFETCHD,
    SHADOW_LIST_ALTARIA,
    SHADOW_LIST_MAGMAR,
    SHADOW_LIST_MAREEP,
    SHADOW_LIST_BANETTE,
    SHADOW_LIST_HITMONTOP,
    SHADOW_LIST_MAGCARGO,
    SHADOW_LIST_HITMONCHAN,
    SHADOW_LIST_HITMONLEE,
    SHADOW_LIST_LICKITUNG,
    SHADOW_LIST_CHANSEY,
    SHADOW_LIST_LEDIAN,
    SHADOW_LIST_RAPIDASH,
    SHADOW_LIST_SCYTHER,
    SHADOW_LIST_DUGTRIO,
    SHADOW_LIST_SOLROCK,
    SHADOW_LIST_STARMIE,
    SHADOW_LIST_POLIWRATH,
    SHADOW_LIST_MR_MIME,
    SHADOW_LIST_GLIGAR,
    SHADOW_LIST_STANTLER,
    SHADOW_LIST_PILOSWINE,*/
    SHADOW_LIST_SNEASEL,
    /*SHADOW_LIST_AIPOM,
    SHADOW_LIST_MURKROW,
    SHADOW_LIST_FORRETRESS,
    SHADOW_LIST_ARIADOS,
    SHADOW_LIST_GRANBULL,
    SHADOW_LIST_VIBRAVA,
    SHADOW_LIST_SWELLOW,
    SHADOW_LIST_ELECTABUZZ,
    SHADOW_LIST_SNORLAX,
    SHADOW_LIST_MANECTRIC,
    SHADOW_LIST_MAROWAK,
    SHADOW_LIST_LAPRAS,
    SHADOW_LIST_SUNFLORA,
    SHADOW_LIST_DELIBIRD,
    SHADOW_LIST_HERACROSS,
    SHADOW_LIST_SMEARGLE,
    SHADOW_LIST_URSARING,
    SHADOW_LIST_SHUCKLE,
    SHADOW_LIST_RHYDON,
    SHADOW_LIST_EXEGGUTOR,
    SHADOW_LIST_TAUROS,
    SHADOW_LIST_SKARMORY,
    SHADOW_LIST_MILTANK,
    SHADOW_LIST_ABSOL,
    SHADOW_LIST_HOUNDOOM,
    SHADOW_LIST_TROPIUS,
    SHADOW_LIST_SCIZOR,
    SHADOW_LIST_METAGROSS,
    SHADOW_LIST_SALAMENCE,
    SHADOW_LIST_TYRANITAR,
