...
#define STRINGID_EXPANSION_END                        STRINGID_FICKLEBEAMDOUBLED

#define STRINGID_SENDCAUGHTMONPARTYORBOX              (STRINGID_EXPANSION_END + 1)
#define STRINGID_PKMNSENTTOPCAFTERCATCH               (STRINGID_EXPANSION_END + 2)
