...
#define FLAG_SYS_FORCE_SHINY                        (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_FORCE_NO_SHINY                         (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_PAUSE_TIME                             (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_NO_ENCOUNTER                           (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_NO_TRAINER_SEE                         (SYSTEM_FLAGS + 0x89) // Unused Flag
...
#define FLAG_NO_BAG_USE                             (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_NO_CATCHING                            (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_NO_RUNNING                             (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_AI_VS_AI_BATTLE                        (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_DYNAMAX_BATTLE                         (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_TERA_ORB_CHARGED                       (SYSTEM_FLAGS + 0x98) // Unused Flag
