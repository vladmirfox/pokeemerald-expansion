...
#define FLAG_SYS_POKENAV_FLY                         (SYSTEM_FLAGS + 0x3) // Used to tell the game when the user is flying from their Pokenav, so the "Show Mon" animation doesn't play. Should be cleared by the time the player lands.
