...
#define FLAG_DEBUG_NO_COLLISION              0x54  // debug flag
#define FLAG_DEBUG_TRAINER_NO_SEE            0x55  // debug flag
...
// Item Ball Flags
#define FLAG_ITEM_ROUTE_101_ORANBERRY                               0x3E8
#define FLAG_ITEM_ROUTE_102_BERRIES                                 0x3E9
...
#define FLAG_SYS_REMOTE_POKEMON_STORAGE              (SYSTEM_FLAGS + 0x3) // Turns on (set) or off (clear) remote storage in start menu
...
#define FLAG_REMOTE_STORAGE                         (SYSTEM_FLAGS + 0x85) // Unused Flag
