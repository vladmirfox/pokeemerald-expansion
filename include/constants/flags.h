...
#define FLAG_UNUSED_0x020    0x20 // Unown
#define FLAG_STATER_GET    0x21 // Unused Flag
#define FLAG_APPEL_FOREST_ITEM_1   0x22 // RUNNING SHOES
#define FLAG_APPEL_FOREST_ITEM_2     0x23 // Unused Flag
