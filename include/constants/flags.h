...
#define FLAG_PT_STARTER                             (SYSTEM_FLAGS + 0x21) // Tracts if PLAYER has done PT Starter Event.
...
#define FLAG_SYS_PT_MODE                            (SYSTEM_FLAGS + 0x2E) // Used to denote PT mode state
