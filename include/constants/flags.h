...
#define FLAG_PT_RESULT                       0xE9 // Set if PC catches a Dragon in Proving Trial.
...
#define FLAG_PROVINGTRIAL                    0x1AA // Used to check if you have done Starter event.
...
#define FLAG_SKIP_INTRO                                             0x493 // Unused Flag
