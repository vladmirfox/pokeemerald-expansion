...
#define MAPSEC_WYRMSHIRE                    0xD5
#define MAPSEC_GREENSFIELD                  0xD6
#define MAPSEC_HANAKA_VILLAGE               0xD7
#define MAPSEC_MARINA_PORT                  0xD8
#define MAPSEC_HYDROELEC_DAM                0xD9
#define MAPSEC_IRONFORGE_CITY               0xDA
#define MAPSEC_VALORITE_WOODS               0xDB
#define MAPSEC_FORT_VALORITE                0xDC
#define MAPSEC_REMNANT_OF_CONFLICT          0xDD
#define MAPSEC_MYSTERIA                     0xDE
#define MAPSEC_FORTUNA_CITY                 0xDF
#define MAPSEC_DESERT_GATEWAY               0xE0
#define MAPSEC_GREAT_DESERT                 0xE1
#define MAPSEC_AE_RUINS                     0xE2
#define MAPSEC_DESERT_OASIS                 0xE3
#define MAPSEC_CYNDERHAIL_SECT              0xE4
#define MAPSEC_NEXIUM_CAVERNS               0xE5
#define MAPSEC_WYRMSPIRE_KEEP               0xE6
#define MAPSEC_DRAGONS_GATE                 0xE7
#define MAPSEC_SHINRYU_PATH                 0xE8
#define MAPSEC_SHINRYU_PAGODA               0xE9
//#define MAPSEC_                             0x
//#define MAPSEC_                             0x
//#define MAPSEC_                             0x
//#define MAPSEC_                             0x
