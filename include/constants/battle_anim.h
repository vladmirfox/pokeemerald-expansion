...
#define ANIM_TAG_SYRUP_BLOB_RED             (ANIM_SPRITES_START + 387)
#define ANIM_TAG_SYRUP_SHELL_RED            (ANIM_SPRITES_START + 388)
#define ANIM_TAG_SYRUP_BLOB_YELLOW          (ANIM_SPRITES_START + 389)
#define ANIM_TAG_SYRUP_SHELL_YELLOW         (ANIM_SPRITES_START + 390)
#define ANIM_TAG_SYRUP_SPLAT_RED            (ANIM_SPRITES_START + 391)
#define ANIM_TAG_SYRUP_SPLAT_YELLOW         (ANIM_SPRITES_START + 392)
...
#define B_ANIM_SYRUP_BOMB_SPEED_DROP    39
