...
#define ANIM_TAG_SHADOW_PARTICLES           (ANIM_SPRITES_START + 394)
#define ANIM_TAG_REVERSE_PARTICLES          (ANIM_SPRITES_START + 395)
...
#define B_ANIM_SHADOW_SKY_CONTINUES     50
#define B_ANIM_CALL_REVERSE_MODE        51
