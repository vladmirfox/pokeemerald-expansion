...
#define ANIM_TAG_STONE_PILLAR               (ANIM_SPRITES_START + 371)
#define ANIM_TAG_MUSHROOM                   (ANIM_SPRITES_START + 372)
#define ANIM_TAG_GOLDEN_APPLE               (ANIM_SPRITES_START + 373)
#define ANIM_TAG_ICE_ROCK                   (ANIM_SPRITES_START + 374)
#define ANIM_TAG_TORNADO                    (ANIM_SPRITES_START + 375)
#define ANIM_TAG_STRAIGHT_BEAM              (ANIM_SPRITES_START + 376)
#define ANIM_TAG_DREEPY                     (ANIM_SPRITES_START + 377)
#define ANIM_TAG_ICE_ROCK_SINGLE            (ANIM_SPRITES_START + 378)
#define ANIM_TAG_STONE_PILLAR_MULTI         (ANIM_SPRITES_START + 379)
#define ANIM_TAG_ALPHA_SYMBOL               (ANIM_SPRITES_START + 380)
#define ANIM_TAG_OMEGA_SYMBOL               (ANIM_SPRITES_START + 381)
#define ANIM_TAG_PRIMAL_PARTICLES           (ANIM_SPRITES_START + 382)
