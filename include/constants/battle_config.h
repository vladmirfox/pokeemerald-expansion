...
#define B_LAST_USED_BTN_CANCEL_CYC  B_BUTTON   // If last used ball cycling is implemented and the B_LAST_USED_BALL_BUTTON is held, but not yet let go, this button (or button combo) will cause no ball to be thrown when letting go of the button.
