...
#define SPECIES_VENUSAUR_MEGA_REGIONAL                  SPECIES_MIMIKYU_TOTEM_BUSTED + 4
#define SPECIES_CHARMANDER_REGIONAL                     SPECIES_MIMIKYU_TOTEM_BUSTED + 5
#define SPECIES_CHARMELEON_REGIONAL                     SPECIES_MIMIKYU_TOTEM_BUSTED + 6
#define SPECIES_CHARIZARD_REGIONAL                      SPECIES_MIMIKYU_TOTEM_BUSTED + 7
#define SPECIES_CHARIZARD_MEGA_REGIONAL                 SPECIES_MIMIKYU_TOTEM_BUSTED + 8
#define SPECIES_SQUIRTLE_REGIONAL                       SPECIES_MIMIKYU_TOTEM_BUSTED + 9
#define SPECIES_WARTORTLE_REGIONAL                      SPECIES_MIMIKYU_TOTEM_BUSTED + 10
