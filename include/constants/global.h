...
#define BAG_BERRIES_COUNT 42
#define BAG_MEDICINE_COUNT 27
#define BAG_BATTLEITEMS_COUNT 234
#define BAG_POWERUP_COUNT 79
#define OBJECT_EVENT_TEMPLATES_COUNT 64
#define DECOR_MAX_SECRET_BASE 1
#define DECOR_MAX_PLAYERS_HOUSE 1
#define APPRENTICE_COUNT 2
#define APPRENTICE_MAX_QUESTIONS 9
#define MAX_REMATCH_ENTRIES 79 // only REMATCH_TABLE_ENTRIES (78) are used
...
#define OPTIONS_LEVEL_CAPS_NONE   0
#define OPTIONS_LEVEL_CAPS_NORMAL 1
