...
#define TAG_REVERSE_INDICATOR_TILE      0xD77C

#define TAG_MEGA_TRIGGER_PAL            0xD777
#define TAG_MEGA_INDICATOR_PAL          0xD778
#define TAG_ALPHA_OMEGA_INDICATOR_PAL   0xD779 // Alpha, Omega, and Reverse indicators use the same palette as each of them only uses 4 different colors.
