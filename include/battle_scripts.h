...
extern const u8 BattleScript_SelectingNotAllowedMoveAssaultCoat[];
extern const u8 BattleScript_SelectingNotAllowedMoveAssaultCoatInPalace[];
...
extern const u8 BattleScript_PocketSandActivates[];
extern const u8 BattleScript_PocketSandActivatesStat[];
extern const u8 BattleScript_PocketSandEnd[];
extern const u8 BattleScript_TryPocketSandActivatesStat[];
