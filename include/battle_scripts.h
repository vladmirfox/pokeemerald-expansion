...
extern const u8 BattleScript_HealerLeftiesActivates[];
...
extern const u8 BattleScript_TanglingHairTraps[];
...
extern const u8 BattleScript_SchoolingRestoreActivates[];
