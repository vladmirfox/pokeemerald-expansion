...
//void HandleAction_PTWatchesCarefully(void);
void HandleAction_SafariZoneBallThrow(void);
void HandleAction_PTBallThrow(void);
//void HandleAction_PTThrowPokeblock(void);
//void HandleAction_PTGoNear(void);
//void HandleAction_PTRun(void);
