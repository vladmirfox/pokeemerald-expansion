...
s32 CalculateMoveDamage();
s32 CalculateMoveDamageVars();
// s32 CalculateMoveDamageVars(struct DamageCalculationData *dmgCalcData, uq4_12_t typeEffectivenessModifier, u32 weather,
