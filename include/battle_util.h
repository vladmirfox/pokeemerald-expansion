...
#define ABILITYEFFECT_TRACE1                     11
#define ABILITYEFFECT_TRACE2                     12
#define ABILITYEFFECT_MOVE_END_OTHER             13
#define ABILITYEFFECT_NEUTRALIZINGGAS            14
#define ABILITYEFFECT_FIELD_SPORT                15 // Only used if B_SPORT_TURNS < GEN_6
#define ABILITYEFFECT_ON_WEATHER                 16
#define ABILITYEFFECT_ON_TERRAIN                 17
