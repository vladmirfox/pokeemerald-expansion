...
struct AiLogicData
{
    ...
    bool8 shouldSwitchIfBadMoves; // Because all available moves have no/little effect. Each bit per battler.
    ...
    u8 shouldSwitch[MAX_BATTLERS_COUNT]; // Stores result of ShouldSwitch, which decides whether a mon should be switched out
};
